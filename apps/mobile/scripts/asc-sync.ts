...
const METADATA = {
  ...
  tr: {
    ...
    description: [
      ...
      `🎬 ${SCENE_COUNT_DISPLAY} gerçek sahne — A1 başlangıçtan C2 ileri seviyeye CEFR haritası`,
      ...
      "🤔 BU UYGULAMA NEDİR?",
      "",
      `Lafla, "İngilizceyi bilmek" ile "İngilizce konuşmak" arasındaki uçurumu kapatır. Sınav notun yüksek ama kafedeki Amerikalıyla 30 saniye sonra terliyorsun. Match'te mesaj geldi, 5 dakika düşünüyorsun. Lafla bu boşluğu kapatmak için var — ${SCENE_COUNT_DISPLAY} gerçek senaryo, hepsi ön-üretilmiş, hiçbiri AI hallüsinasyonu değil. Cevapların Lafla sunucularına gönderilmez; sesli giriş iOS konuşma tanıma sistemi tarafından işlenebilir.`,
      "",
      "🚀 NEDEN LAFLA?",
      "",
      ...
      "💎 LAFLA PRO ÜYELİK",
      "",
      `Tüm ${SCENE_COUNT_DISPLAY} sahneye erişim, sınırsız tekrar, yönlendirmeli telaffuz pratiği, IELTS Band tahmini, kişisel zayıflık raporu ve gelişmiş ilerleme paneli.`,
      "",
    ...
    whatsNew: [
      ...
      `🎬 ${SCENE_COUNT_DISPLAY} oynanabilir sahne — A1'den C2'ye CEFR ile haritalı`,
  ...
  en: {
    ...
    description: [
      ...
      `🎬 ${SCENE_COUNT_DISPLAY} real scenarios — CEFR-mapped from A1 to C2`,
      ...
      "",
      `All ${SCENE_COUNT_DISPLAY} scenes unlocked, unlimited replays, guided pronunciation practice, IELTS Band estimate, personal weakness report, advanced progress dashboard.`,
      "",
    ...
    whatsNew: [
      ...
      `🎬 ${SCENE_COUNT_DISPLAY} scenarios playable at launch — CEFR-mapped A1 to C2`,
