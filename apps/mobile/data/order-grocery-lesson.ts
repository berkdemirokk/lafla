...
export const orderGroceryLesson_46_1: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "produce section",
      tr_translation: "Sebze-meyve reyonu",
      example: "The avocados are in the produce section.",
      example_tr: "Avokadolar sebze-meyve reyonunda.",
    },
    {
      id: "ex.og46.1.v21",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "frozen aisle",
      tr_translation: "Donmuş ürünler reyonu",
      example: "The frozen aisle is in the back of the store.",
      example_tr: "Donmuş ürünler reyonu mağazanın arkasında.",
    },
    {
      id: "ex.og46.1.v22",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "international aisle",
      tr_translation: "International (etnik yiyecek) reyonu",
      example: "Tahini's usually in the international aisle.",
      example_tr: "Tahin genelde international reyonda olur.",
    },
    {
      id: "ex.og46.1.v23",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "out of stock",
      tr_translation: "Stokta kalmadı",
      example: "Sorry, we're out of stock on tahini today.",
      example_tr: "Üzgünüm, bugün tahin stokta kalmadı.",
    },
    {
      id: "ex.og46.1.v24",
      type: "vocab_tile",
      ...
      tr_translation: "Stokta var",
      example: "Is the oat milk still in stock?",
      example_tr: "Yulaf sütü hala stokta var mı?",
    },
    {
      id: "ex.og46.1.rq1",
      type: "recall_quiz",
...
export const orderGroceryLesson_46_2: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "ground beef",
      tr_translation: "Kıyma (sığır)",
      example: "I'll take two pounds of ground beef, 80/20.",
      example_tr: "İki pound kıyma alacağım, 80/20.",
    },
    {
      id: "ex.og46.2.v21",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "boneless skinless",
      tr_translation: "Kemiksiz ve derisiz",
      example: "Two pounds of boneless skinless chicken breast, please.",
      example_tr: "İki pound kemiksiz derisiz tavuk göğsü, lütfen.",
    },
    {
      id: "ex.og46.2.v22",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "farm-raised",
      tr_translation: "Çiftlikte yetiştirilmiş",
      example: "Is this salmon farm-raised or wild-caught?",
      example_tr: "Bu somon çiftlik mi yoksa doğal mı?",
    },
    {
      id: "ex.og46.2.v23",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "fresh catch",
      tr_translation: "Bugünkü taze balık",
      example: "What's the fresh catch today?",
      example_tr: "Bugünkü taze balık nedir?",
    },
    {
      id: "ex.og46.2.v24",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "vacuum sealed",
      tr_translation: "Vakumlu paket",
      example: "Could you have it vacuum sealed, please?",
      example_tr: "Vakumlu paketleyebilir misiniz, lütfen?",
    },
    {
      id: "ex.og46.2.rq1",
      type: "recall_quiz",
...
export const orderGroceryLesson_46_3: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "round up for charity",
      tr_translation: "Hayır için yuvarla (üst rakama)",
      example: "Would you like to round up for charity?",
      example_tr: "Hayır için yuvarlamak ister misiniz?",
    },
    {
      id: "ex.og46.3.v21",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "double-bag",
      tr_translation: "İki torbaya koy (sağlamlık için)",
      example: "Could you double-bag the milk, please?",
      example_tr: "Sütü iki torbaya koyabilir misiniz, lütfen?",
    },
    {
      id: "ex.og46.3.v22",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "comes to",
      tr_translation: "Toplam (tutuyor)",
      example: "Your total comes to $42.85.",
      example_tr: "Toplamınız 42.85 dolar tutuyor.",
    },
    {
      id: "ex.og46.3.v23",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "loyalty number",
      tr_translation: "Sadakat numarası (telefon ile)",
      example: "I'll just use my phone number as the loyalty number.",
      example_tr: "Sadakat numarası olarak telefonumu kullanacağım.",
    },
    {
      id: "ex.og46.3.v24",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "scan my coupon",
      tr_translation: "Kuponumu okut",
      example: "Could you scan my coupon before the total?",
      example_tr: "Toplamadan önce kuponumu okutur musunuz?",
    },
    {
      id: "ex.og46.3.rq1",
      type: "recall_quiz",
...
export const orderGroceryLesson_46_4: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "PLU code",
      tr_translation: "Sebze/meyve kodu (4 haneli)",
      example: "You need to enter the PLU code for the avocados.",
      example_tr: "Avokadolar için PLU kodu girmen gerekiyor.",
    },
    {
      id: "ex.og46.4.v21",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "skip bagging",
      tr_translation: "Poşetlemeyi atla",
      example: "Could I skip the bagging step?",
      example_tr: "Poşetleme adımını atlayabilir miyim?",
    },
    {
      id: "ex.og46.4.v22",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "place in bagging area",
      tr_translation: "Poşetleme alanına koy",
      example: "Please place item in bagging area.",
      example_tr: "Lütfen ürünü poşetleme alanına koyun.",
    },
    {
      id: "ex.og46.4.v23",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "needs an override",
      tr_translation: "Yetkili onayı gerekiyor",
      example: "This item needs an override — alcohol verification.",
      example_tr: "Bu ürün yetkili onayı istiyor — alkol doğrulama.",
    },
    {
      id: "ex.og46.4.v24",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "tap your card",
      tr_translation: "Kartı dokundur (temassız)",
      example: "Tap your card or insert chip.",
      example_tr: "Kartı dokundurun veya çipi yerleştirin.",
    },
    {
      id: "ex.og46.4.rq1",
      type: "recall_quiz",
...
export const orderGroceryLesson_46_5: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "happen to carry",
      tr_translation: "Tesadüfen satıyor olabilir misiniz (kibar tereddüt)",
      example: "Do you happen to carry pomegranate molasses?",
      example_tr: "Tesadüfen nar ekşisi satıyor musunuz?",
    },
    {
      id: "ex.og46.5.v21",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "where do you keep",
      tr_translation: "Nerede bulundurursunuz",
      example: "Where do you keep the spices?",
      example_tr: "Baharatları nerede bulundurursunuz?",
    },
    {
      id: "ex.og46.5.v22",
      type: "vocab_tile",
      ...
      tr_translation: "Yerine geçen (ürün)",
      example: "Is there a good substitute for buttermilk?",
      example_tr: "Ayran (buttermilk) için iyi bir alternatif var mı?",
    },
    {
      id: "ex.og46.5.v23",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "specialty store",
      tr_translation: "Özel mağaza (etnik, gurme)",
      example: "You might need a specialty store for that ingredient.",
      example_tr: "O malzeme için özel mağazaya gitmen gerekebilir.",
    },
    {
      id: "ex.og46.5.v24",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Mediterranean section",
      tr_translation: "Akdeniz ürünleri reyonu",
      example: "Halloumi is usually in the Mediterranean section.",
      example_tr: "Halloumi genelde Akdeniz reyonunda olur.",
    },
    {
      id: "ex.og46.5.rq1",
      type: "recall_quiz",
...
export const orderGroceryLesson_46_6: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "an ounce",
      tr_translation: "Bir ons (~28 gram)",
      example: "Just an ounce or two of those olives, please.",
      example_tr: "O zeytinlerden bir-iki ons, lütfen.",
    },
    {
      id: "ex.og46.6.v21",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "by the pound",
      tr_translation: "Pound (kilo) bazında",
      example: "These olives are sold by the pound.",
      example_tr: "Bu zeytinler pound bazında satılıyor.",
    },
    {
      id: "ex.og46.6.v22",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "fat content",
      tr_translation: "Yağ oranı (kıyma için)",
      example: "What fat content do you want — 80/20 or 90/10?",
      example_tr: "Hangi yağ oranı istersin — 80/20 mi 90/10 mu?",
    },
    {
      id: "ex.og46.6.v23",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "shaved",
      tr_translation: "Çok ince dilimli",
      example: "Could you shave the ham nice and thin?",
      example_tr: "Pastırmayı güzel ince dilimleyebilir misiniz?",
    },
    {
      id: "ex.og46.6.v24",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "give it a sample",
      tr_translation: "(Müşteriye) tadımlık ver",
      example: "Want me to give you a sample first?",
      example_tr: "İlk önce tadımlık vereyim mi?",
    },
    {
      id: "ex.og46.6.rq1",
      type: "recall_quiz",
...
export const orderGroceryLesson_46_7: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "manual entry",
      tr_translation: "Manuel giriş (barkod okumazsa)",
      example: "I can do a manual entry for the code.",
      example_tr: "Kod için manuel giriş yapabilirim.",
    },
    {
      id: "ex.og46.7.v21",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "scuffed barcode",
      tr_translation: "Çizik / aşınmış barkod",
      example: "This barcode looks scuffed — let me enter it.",
      example_tr: "Barkod çizik görünüyor — ben elle gireceğim.",
    },
    {
      id: "ex.og46.7.v22",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "wave me over",
      tr_translation: "El sallayarak çağır",
      example: "Just wave me over if it acts up again.",
      example_tr: "Yine sorun çıkarırsa el salla, gelirim.",
    },
    {
      id: "ex.og46.7.v23",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "acting up",
      tr_translation: "Sorun çıkarıyor (makine için)",
      example: "The scanner's been acting up all morning.",
      example_tr: "Skener bütün sabah sorun çıkarıyor.",
    },
    {
      id: "ex.og46.7.v24",
      type: "vocab_tile",
      ...
      cefr_band: "B1",
      word_or_phrase: "void this item",
      tr_translation: "Bu ürünü iptal et",
      example: "Could you void this item? I changed my mind.",
      example_tr: "Bu ürünü iptal eder misiniz? Fikrimi değiştirdim.",
    },
    {
      id: "ex.og46.7.rq1",
      type: "recall_quiz",
...
export const orderGroceryLesson_46_8: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      tr_translation: "Fiyat eşleştirme (rakip mağaza fiyatı)",
      example: "Do you guys do price matching with Walmart?",
      example_tr: "Walmart ile fiyat eşleştirme yapıyor musunuz?",
    },
    {
      id: "ex.og46.8.v21",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "buy one get one",
      tr_translation: "Bir al, bir bedava (BOGO)",
      example: "It says buy one get one — should be free.",
      example_tr: "Bir al bir bedava yazıyor — bedava olmalı.",
    },
    {
      id: "ex.og46.8.v22",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "didn't go through",
      tr_translation: "İşlemedi / geçmedi (kupon, ödeme)",
      example: "The coupon didn't go through — could you try again?",
      example_tr: "Kupon işlemedi — tekrar dener misiniz?",
    },
    {
      id: "ex.og46.8.v23",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "price check",
      tr_translation: "Fiyat kontrolü",
      example: "Could I get a price check on the cereal?",
      example_tr: "Gevrek için fiyat kontrolü yapabilir misiniz?",
    },
    {
      id: "ex.og46.8.v24",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "adjust the total",
      tr_translation: "Toplamı düzelt (yeniden hesapla)",
      example: "Let me adjust the total for you.",
      example_tr: "Toplamı sizin için düzelteyim.",
    },
    {
      id: "ex.og46.8.rq1",
      type: "recall_quiz",
