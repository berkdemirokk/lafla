...
export const dailyHotelLesson_20_1: BundledLesson = {
  ...
  exercises: [
{
  id: "ex.daily_hotel_20_1.p5v1",
  type: "vocab_tile",
  difficulty: 1,
  cefr_band: "A1",
  word_or_phrase: "room",
  tr_translation: "Oda",
  example: "I have a room.",
  example_tr: "Bir odam var.",
},
{
  id: "ex.daily_hotel_20_1.p5v2",
  type: "vocab_tile",
  difficulty: 1,
  cefr_band: "A1",
  word_or_phrase: "key",
  tr_translation: "Anahtar",
  example: "Here is the key.",
  example_tr: "İşte anahtar.",
},
{
  id: "ex.daily_hotel_20_1.p5v3",
  type: "vocab_tile",
  difficulty: 2,
  cefr_band: "A2",
  ...
  example_tr: "İki kişilik bir oda istiyorum, lütfen.",
},
{
  id: "ex.daily_hotel_20_1.p5v4",
  type: "vocab_tile",
  difficulty: 2,
  cefr_band: "A2",
  word_or_phrase: "is it included",
  tr_translation: "Dahil mi",
  example: "Is breakfast included?",
  example_tr: "Kahvaltı dahil mi?",
},
{
  id: "ex.daily_hotel_20_1.p5v5",
  type: "vocab_tile",
  difficulty: 2,
  cefr_band: "A2",
  word_or_phrase: "do you have",
  tr_translation: "Var mı",
  example: "Do you have any rooms available tonight?",
  example_tr: "Bu gece için müsait odanız var mı?",
},
{
  id: "ex.daily_hotel_20_1.p5v6",
  type: "vocab_tile",
  difficulty: 3,
  cefr_band: "B1",
  word_or_phrase: "I was wondering",
  tr_translation: "Merak ediyordum",
  example: "I was wondering about a late check-out.",
  example_tr: "Geç çıkış olur mu diye merak ediyordum.",
},
{
  id: "ex.daily_hotel_20_1.p5v7",
  type: "vocab_tile",
  difficulty: 3,
  cefr_band: "B1",
  word_or_phrase: "could you help me",
  tr_translation: "Yardım eder misiniz",
  example: "Could you help me with my luggage?",
  example_tr: "Bavullarıma yardım eder misiniz?",
},
{
  id: "ex.daily_hotel_20_1.p5v8",
  type: "vocab_tile",
  difficulty: 3,
  cefr_band: "B1",
  word_or_phrase: "by any chance",
  tr_translation: "Acaba",
  example: "Is there a quieter room, by any chance?",
  example_tr: "Acaba daha sessiz bir oda var mı?",
},
{
  id: "ex.daily_hotel_20_1.p5v9",
  type: "vocab_tile",
  difficulty: 3,
  cefr_band: "B1",
  word_or_phrase: "any recommendations",
  tr_translation: "Tavsiyeniz var mı",
  example: "Any recommendations for dinner nearby?",
  example_tr: "Yakında akşam yemeği için tavsiyeniz var mı?",
},
{
  id: "ex.daily_hotel_20_1.p5v10",
  type: "vocab_tile",
  difficulty: 4,
  cefr_band: "B2",
  word_or_phrase: "would you mind if I",
  tr_translation: "Sakıncası olur mu",
  example: "Would you mind if I checked in early?",
  example_tr: "Erken check-in yapsam sakıncası olur mu?",
},
{
  id: "ex.daily_hotel_20_1.p5v11",
  type: "vocab_tile",
  difficulty: 4,
  cefr_band: "B2",
  word_or_phrase: "I'd appreciate if you could",
  tr_translation: "Yapabilirseniz minnettar olurum",
  example: "I'd appreciate if you could upgrade us.",
  example_tr: "Bizi üst sınıfa alabilirseniz minnettar olurum.",
},
{
  id: "ex.daily_hotel_20_1.p5v12",
  type: "vocab_tile",
  difficulty: 4,
  cefr_band: "C1",
  word_or_phrase: "I don't suppose",
  tr_translation: "Acaba",
  example: "I don't suppose you have a sea view available?",
  example_tr: "Acaba deniz manzaralı oda var mı?",
},
{
  id: "ex.daily_hotel_20_1.p5v13",
  type: "vocab_tile",
  difficulty: 5,
  cefr_band: "C2",
  word_or_phrase: "for what it's worth",
  tr_translation: "Belki işine yarar",
  example: "For what it's worth, the top floor is the quietest.",
  example_tr: "Belki işine yarar, en üst kat en sessiz olanı.",
},
    {
      id: "ex.dh20.1.1",
      type: "vocab_tile",
