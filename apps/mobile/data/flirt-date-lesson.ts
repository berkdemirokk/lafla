      ...
      turns: [
        {
          ...
          model_answers: ["Want to grab coffee sometime this week?"],
          hint_tr:
        ...
        },
        {
          ...
          model_answers: ["Thursday around 7?"],
          hint_tr:
        ...
        },
        {
          ...
          model_answers: ["I know a great spot near downtown — text it to you?"],
          hint_tr:
        ...
        },
        {
          ...
          model_answers: ["Honestly, I'm a clock person — five minutes early"],
          hint_tr:
        ...
        },
        {
          ...
          model_answers: ["Fair warning, I ask too many questions"],
          hint_tr:
        ...
        },
        {
          ...
          model_answers: ["Can't wait — see you Thursday!"],
          hint_tr:
...
export const flirtDateLesson_4_2: BundledLesson = {
  ...
  exercises: [
      ...
      turns: [
        {
          ...
          model_answers: ["Want to grab dinner Friday? Round 2 sounds nice."],
          hint_tr:
        ...
        },
        {
          ...
          model_answers: ["Yes — I know this little Italian place near downtown."],
          hint_tr:
        ...
        },
        {
          ...
          model_answers: ["I'm pescatarian too, no worries"],
          hint_tr:
        ...
        },
        {
          ...
          model_answers: ["Drinks first sounds great — that wine bar by the river?"],
          hint_tr:
        ...
        },
        {
          ...
          model_answers: ["Fair warning — I talk with my hands when food is good"],
          hint_tr:
    ...
    },
    {
      ...
      tr_translation: "İkinci raunt (ikinci randevu)",
      example: "Round two — dinner Friday? My pick this time.",
      example_tr: "İkinci raunt — Cuma yemek? Bu sefer ben seçiyorum.",
    },
    {
      id: "ex.fd4.2.vt3",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Happy to grab the reservation",
      tr_translation: "Rezervasyonu yapmaktan memnun olurum",
      example: "Happy to grab the reservation — what time works?",
      example_tr: "Rezervasyonu yapmaktan memnun olurum — hangi saat uygun?",
    },
    {
      id: "ex.fd4.2.vt4",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Drinks first",
      tr_translation: "Önce bir şeyler içelim",
      example: "Drinks first, then dinner? That little wine bar on 5th?",
      example_tr: "Önce içki, sonra yemek? 5. caddedeki o küçük şarap bar?",
    },
    {
      id: "ex.fd4.2.vt5",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Your pick",
      tr_translation: "Senin seçimin",
      example: "I picked last time — your pick this round.",
      example_tr: "Geçen sefer ben seçtim — bu raunt senin seçimin.",
    },
    {
      id: "ex.fd4.2.vt6",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "Easy to get to",
      tr_translation: "Ulaşımı kolay",
      example: "Easy to get to from your place — straight on the metro.",
      example_tr: "Senin oradan ulaşımı kolay — metroyla direkt.",
    },
  ],
};
...
export const flirtDateLesson_4_3: BundledLesson = {
  ...
  exercises: [
      ...
      turns: [
        {
          ...
          model_answers: ["Down for something different? There's a farmers market downtown Saturday."],
          hint_tr:
        ...
        },
        {
          ...
          model_answers: ["Saturday morning around 11? We can grab coffee after."],
          hint_tr:
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Got tickets",
      tr_translation: "Biletler alındı",
      example: "Got tickets for that show Friday — interested?",
      example_tr: "Cuma o şov için bilet aldım — ilgilenir misin?",
    },
    {
      id: "ex.fd4.3.vt3",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Low-key fun",
      tr_translation: "Sessiz sedasız eğlenceli",
      example: "Low-key fun thing — open mic at that bar near the river.",
      example_tr: "Sessiz sedasız eğlenceli bir şey — nehrin yanındaki barda açık mikrofon.",
    },
    {
      id: "ex.fd4.3.vt4",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "If it's not your scene",
      tr_translation: "Sana göre değilse",
      example: "Totally chill if it's not your scene — just thought I'd ask.",
      example_tr: "Sana göre değilse hiç sorun değil — sadece sormak istedim.",
    },
    {
      id: "ex.fd4.3.vt5",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Wear something comfy",
      tr_translation: "Rahat bir şey giy",
      example: "Wear something comfy — lots of walking involved.",
      example_tr: "Rahat bir şey giy — bayağı yürüyüş var.",
    },
    {
      id: "ex.fd4.3.vt6",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "Free Saturday morning?",
      tr_translation: "Cumartesi sabah müsait misin?",
      example: "Free Saturday morning? Brunch spot opened up I want to try.",
      example_tr: "Cumartesi sabah müsait misin? Denemek istediğim bir brunch yeri açıldı.",
    },
  ],
};
...
export const flirtDateLesson_4_4: BundledLesson = {
  ...
  exercises: [
      ...
      turns: [
        {
          ...
          model_answers: ["We've been chatting a while — should we just meet?"],
          hint_tr:
        ...
        },
        {
          ...
          model_answers: ["Pick a day this week — I'm pretty open."],
          hint_tr:
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Skip the text marathon",
      tr_translation: "Yazışma maratonunu atla",
      example: "Let's skip the text marathon — coffee Thursday?",
      example_tr: "Yazışma maratonunu atlayalım — Perşembe kahve?",
    },
    {
      id: "ex.fd4.4.vt3",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Was thinking the same",
      tr_translation: "Ben de aynı şeyi düşünüyordum",
      example: "Honestly was thinking the same — when works for you?",
      example_tr: "Açıkçası ben de aynı şeyi düşünüyordum — sana ne zaman uyar?",
    },
    {
      id: "ex.fd4.4.vt4",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Pick a day",
      tr_translation: "Bir gün seç",
      example: "Pick a day this week — I'm pretty open.",
      example_tr: "Bu haftadan bir gün seç — bayağı müsaitim.",
    },
    {
      id: "ex.fd4.4.vt5",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Cards on the table",
      tr_translation: "Açık konuşayım",
      example: "Cards on the table — I'd rather meet than text forever.",
      example_tr: "Açık konuşayım — sonsuza dek yazışmaktansa buluşmayı tercih ederim.",
    },
    {
      id: "ex.fd4.4.vt6",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "Even thirty minutes",
      tr_translation: "Otuz dakika bile (düşük baskı teklif)",
      example: "Even thirty minutes — quick coffee, see what happens.",
      example_tr: "Otuz dakika bile — kısa kahve, bakalım ne olacak.",
    },
  ],
};
...
export const flirtDateLesson_4_5: BundledLesson = {
  ...
  exercises: [
      ...
      turns: [
        {
          ...
          model_answers: ["Random question — what's the last thing that genuinely made you laugh?"],
          hint_tr:
        ...
        },
        {
          ...
          model_answers: ["Honestly mine was a meme my friend sent."],
          hint_tr:
        ...
        },
        {
          ...
          model_answers: ["Got a list actually — okay, next one..."],
          hint_tr:
    ...
    },
    {
      ...
      tr_translation: "Provokatif görüş",
      example: "Hot take — winter is actually the best season.",
      example_tr: "Provokatif görüş — kış aslında en iyi mevsim.",
    },
    {
      id: "ex.fd4.5.vt3",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Plot twist",
      tr_translation: "Sürpriz bir konu",
      example: "Plot twist — let's argue about something fun.",
      example_tr: "Sürpriz bir konu — eğlenceli bir şey tartışalım.",
    },
    {
      id: "ex.fd4.5.vt4",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Spaced out for a sec",
      tr_translation: "Bir saniyeliğine daldım",
      example: "Sorry — spaced out for a sec. What were you saying?",
      example_tr: "Pardon — bir saniyeliğine daldım. Ne diyordun?",
    },
    {
      id: "ex.fd4.5.vt5",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Got more in the chamber",
      tr_translation: "Hazırda dahası var",
      example: "Got more random questions in the chamber if you want.",
      example_tr: "İstersen hazırda daha rastgele sorular var.",
    },
    {
      id: "ex.fd4.5.vt6",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "What's been on your mind?",
      tr_translation: "Aklında ne var?",
      example: "Random — what's been on your mind this week?",
      example_tr: "Rastgele — bu hafta aklında ne var?",
    },
  ],
};
...
export const flirtDateLesson_4_6: BundledLesson = {
  ...
  exercises: [
      ...
      turns: [
        {
          ...
          model_answers: ["Happy to split — whichever you prefer."],
          hint_tr:
        ...
        },
        {
          ...
          model_answers: ["Works for me — next round's on me though."],
          hint_tr:
        ...
        },
        {
          ...
          model_answers: ["Likewise — being upfront makes everything easier."],
          hint_tr:
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Let me grab this one",
      tr_translation: "Bu seferki benden olsun",
      example: "Let me grab this one — you can get the next round.",
      example_tr: "Bu seferki benden olsun — bir dahaki sefere sen alırsın.",
    },
    {
      id: "ex.fd4.6.vt3",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "I'll venmo you",
      tr_translation: "Sana Venmo'dan göndereyim (ABD ödeme app'i)",
      example: "I'll venmo you my half — what's your handle?",
      example_tr: "Yarımı sana Venmo'dan göndereyim — kullanıcı adın ne?",
    },
    {
      id: "ex.fd4.6.vt4",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Keep things even",
      tr_translation: "Eşit tutalım",
      example: "Honestly let's split — I like keeping things even.",
      example_tr: "Açıkçası paylaşalım — eşit tutmayı seviyorum.",
    },
    {
      id: "ex.fd4.6.vt5",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Next one's on me",
      tr_translation: "Bir dahakine ben alırım",
      example: "You got tonight — next one's on me, deal?",
      example_tr: "Bu akşamı sen aldın — bir dahakine ben alırım, anlaştık mı?",
    },
    {
      id: "ex.fd4.6.vt6",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "Whichever you prefer",
      tr_translation: "Hangisini tercih edersen",
      example: "Split or I get it — whichever you prefer, honestly.",
      example_tr: "Paylaşalım ya da ben alayım — açıkçası hangisini tercih edersen.",
    },
  ],
};
...
export const flirtDateLesson_4_7: BundledLesson = {
  ...
  exercises: [
      ...
      turns: [
        {
          ...
          model_answers: ["Hey, just making sure you got home safe — tonight was honestly great. No rush on replying."],
          hint_tr:
        ...
        },
        {
          ...
          model_answers: ["Likewise — genuinely the best in ages. Sleep well, we'll talk tomorrow."],
          hint_tr:
        ...
        },
        {
          ...
          model_answers: ["Noted — round two is happening. I'll text tomorrow. Now go to sleep."],
          hint_tr:
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Sleep well",
      tr_translation: "İyi uyu",
      example: "Sleep well — talk tomorrow.",
      example_tr: "İyi uyu — yarın konuşuruz.",
    },
    {
      id: "ex.fd4.7.vt3",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Talk tomorrow",
      tr_translation: "Yarın konuşuruz",
      example: "Glad you're home — talk tomorrow, get some rest.",
      example_tr: "Eve vardığına sevindim — yarın konuşuruz, biraz dinlen.",
    },
    {
      id: "ex.fd4.7.vt4",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Best night in a while",
      tr_translation: "Uzun zamandır en iyi gece",
      example: "Honestly the best night in a while — thanks for tonight.",
      example_tr: "Açıkçası uzun zamandır en iyi gece — bu akşam için teşekkürler.",
    },
    {
      id: "ex.fd4.7.vt5",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Made it home",
      tr_translation: "Eve ulaştım",
      example: "Made it home — thanks for walking me to the cab.",
      example_tr: "Eve ulaştım — beni taksiye kadar geçirdiğin için sağ ol.",
    },
    {
      id: "ex.fd4.7.vt6",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "Reach out tomorrow",
      tr_translation: "Yarın yazarım",
      example: "I'll reach out tomorrow — sleep first.",
      example_tr: "Yarın yazarım — önce uyu.",
    },
  ],
};
...
export const flirtDateLesson_4_8: BundledLesson = {
  ...
  exercises: [
      ...
      turns: [
        {
          ...
          model_answers: ["Already thinking about round two — there's this Thai place I've been meaning to try. Free next week?"],
          hint_tr:
        ...
        },
        {
          ...
          model_answers: ["The one on Bond Street — I'll book a table for Friday at 7?"],
          hint_tr:
        ...
        },
        {
          ...
          model_answers: ["Only when it's worth it. See you Friday."],
          hint_tr:
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Already thinking about round two",
      tr_translation: "Şimdiden ikinci raunt'u düşünüyorum",
      example: "Already thinking about round two — Saturday?",
      example_tr: "Şimdiden ikinci raunt'u düşünüyorum — Cumartesi?",
    },
    {
      id: "ex.fd4.8.vt3",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Been meaning to try",
      tr_translation: "Denemeyi planlıyordum",
      example: "Been meaning to try that ramen place — want to be my excuse?",
      example_tr: "O ramen yerini denemeyi planlıyordum — benim bahanem olur musun?",
    },
    {
      id: "ex.fd4.8.vt4",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Way too short",
      tr_translation: "Çok kısaydı",
      example: "Coffee was way too short — let's do dinner next.",
      example_tr: "Kahve çok kısaydı — bir dahaki sefere yemek yiyelim.",
    },
    {
      id: "ex.fd4.8.vt5",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Where to take you next",
      tr_translation: "Seni bir dahaki sefere nereye götüreceğimi",
      example: "Already planning where to take you next — got ideas?",
      example_tr: "Şimdiden seni bir dahaki sefere nereye götüreceğimi planlıyorum — fikrin var mı?",
    },
    {
      id: "ex.fd4.8.vt6",
      type: "vocab_tile",
      ...
      cefr_band: "B1",
      word_or_phrase: "Got a spot in mind",
      tr_translation: "Aklımda bir yer var",
      example: "Got a spot in mind for round two — trust me on it?",
      example_tr: "İkinci raunt için aklımda bir yer var — bana güveniyor musun?",
    },
  ],
};
