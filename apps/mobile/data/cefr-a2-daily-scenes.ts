...
export const cefrA2DailyScenes: Scene[] = [
  ...
  },
  {
    ...
    mode: "daily",
    cefrLevel: "A2",
    skillId: "daily.a2.weatherlikes",
    lessonId: "daily.a2.weatherlikes.1",
    isNew: true,
    progressLabel: "A2 · 11/14",
  },
  {
    id: "scene-a2-daily-12",
    emoji: "🏃",
    title: "Hobiler —\npresent\nsimple",
    description:
      "'I usually go to the gym', 'On weekends I cook', 'I play tennis twice a week' — düzenli aktiviteler.",
    durationMin: 6,
    mode: "daily",
    cefrLevel: "A2",
    skillId: "daily.a2.hobbies",
    lessonId: "daily.a2.hobbies.1",
    isNew: true,
    progressLabel: "A2 · 12/14",
  },
  {
    id: "scene-a2-daily-13",
    emoji: "👨‍👩‍👧",
    title: "Aile —\nbasit\nanlatım",
    description:
      "'My sister is older than me', 'We live in Istanbul', 'I have two brothers' — aileni kısaca tanıt.",
    durationMin: 6,
    mode: "daily",
    cefrLevel: "A2",
    skillId: "daily.a2.family",
    lessonId: "daily.a2.family.1",
    isNew: true,
    progressLabel: "A2 · 13/14",
  },
  {
    id: "scene-a2-daily-14",
    emoji: "☕",
    ...
    mode: "daily",
    cefrLevel: "A2",
    skillId: "daily.a2.morningroutine",
    lessonId: "daily.a2.morningroutine.1",
    isNew: true,
    progressLabel: "A2 · 14/14 ✓",
  },
];
