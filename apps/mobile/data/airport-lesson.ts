...
export const airportLesson_44_1: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      example: "I have my ticket on my phone.",
      example_tr: "Biletim telefonumda.",
    },
    {
      id: "ex.da44.1.v03",
      type: "vocab_tile",
      ...
      cefr_band: "A1",
      word_or_phrase: "bag",
      tr_translation: "Çanta / valiz",
      example: "This is my bag.",
      example_tr: "Bu benim valizim.",
    },
    {
      id: "ex.da44.1.v04",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "boarding pass please",
      tr_translation: "Biniş kartı, lütfen",
      example: "Boarding pass please — I'd like a window seat.",
      example_tr: "Biniş kartı, lütfen — cam kenarı koltuk istiyorum.",
    },
    {
      id: "ex.da44.1.v05",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "I'd like a window seat",
      tr_translation: "Cam kenarı koltuk istiyorum",
      example: "I'd like a window seat if there's one available.",
      example_tr: "Müsait varsa cam kenarı koltuk istiyorum.",
    },
    {
      id: "ex.da44.1.v06",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "I'm going to",
      tr_translation: "...'ya gidiyorum",
      example: "I'm going to Istanbul for two weeks.",
      example_tr: "İki haftalığına İstanbul'a gidiyorum.",
    },
    {
      id: "ex.da44.1.v07",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "check one bag",
      tr_translation: "Bir valiz vermek (bagaja)",
      example: "I'll check one bag and keep this carry-on with me.",
      example_tr: "Bir valiz vereceğim, bu kabin çantasını yanımda tutacağım.",
    },
    {
      id: "ex.da44.1.v08",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "extra legroom",
      tr_translation: "Geniş bacak mesafesi",
      example: "Is there a seat with extra legroom on this flight?",
      example_tr: "Bu uçuşta geniş bacak mesafeli koltuk var mı?",
    },
    {
      id: "ex.da44.1.v09",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "frequent flyer number",
      tr_translation: "Sık uçan yolcu numarası",
      example: "Could you add my frequent flyer number to the booking?",
      example_tr: "Sık uçan yolcu numaramı rezervasyona ekler misiniz?",
    },
    {
      id: "ex.da44.1.v10",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "I'd appreciate if you could expedite",
      tr_translation: "Hızlandırabilirseniz çok sevinirim",
      example: "I'd appreciate if you could expedite this — my connection is tight.",
      example_tr: "Hızlandırabilirseniz çok sevinirim — aktarmam çok kısa.",
    },
    {
      id: "ex.da44.1.v11",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "could I be reseated",
      tr_translation: "Koltuğumu değiştirebilir miyim?",
      example: "Could I be reseated near the front of the cabin?",
      example_tr: "Kabin önüne yakın bir koltuğa geçebilir miyim?",
    },
    {
      id: "ex.da44.1.v12",
      type: "vocab_tile",
      ...
      tr_translation: "Hızlandırılmış güvenlik kontrolü",
      example: "I'm enrolled in expedited screening, so I can keep my shoes on.",
      example_tr: "Hızlandırılmış güvenlik kontrolüne kayıtlıyım, ayakkabılarımı çıkarmama gerek yok.",
    },
    {
      id: "ex.da44.1.v13",
      type: "vocab_tile",
      difficulty: 5,
      cefr_band: "C2",
      word_or_phrase: "bumped to standby",
      tr_translation: "Yedek listeye düşürüldüm",
      example: "I got bumped to standby on the earlier flight — any chance of confirmation?",
      example_tr: "Önceki uçuşta yedek listeye düşürüldüm — onaylanma şansı var mı?",
    },
    {
      id: "ex.da44.1.rq1",
      type: "recall_quiz",
...
export const airportLesson_44_2: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      cefr_band: "A1",
      word_or_phrase: "tray",
      tr_translation: "Tepsi (X-ray için plastik)",
      example: "Put your phone in the tray.",
      example_tr: "Telefonunu tepsiye koy.",
    },
    {
      id: "ex.da44.2.v02",
      type: "vocab_tile",
      ...
      cefr_band: "A1",
      word_or_phrase: "belt",
      tr_translation: "Kemer",
      example: "Take your belt off, please.",
      example_tr: "Kemerinizi çıkarın, lütfen.",
    },
    {
      id: "ex.da44.2.v03",
      type: "vocab_tile",
      difficulty: 1,
      cefr_band: "A1",
      word_or_phrase: "laptop",
      tr_translation: "Dizüstü bilgisayar",
      example: "My laptop is in the tray.",
      example_tr: "Dizüstü bilgisayarım tepside.",
    },
    {
      id: "ex.da44.2.v04",
      type: "vocab_tile",
      ...
      tr_translation: "Öne adım at",
      example: "Step forward and put your arms up.",
      example_tr: "Öne adım at ve kollarını kaldır.",
    },
    {
      id: "ex.da44.2.v05",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "arms up",
      tr_translation: "Kollar yukarı",
      example: "Arms up — hold still for the scanner.",
      example_tr: "Kollar yukarı — tarayıcı için hareketsiz dur.",
    },
    {
      id: "ex.da44.2.v06",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "everything's in the tray",
      tr_translation: "Her şey tepside",
      example: "Pockets empty — everything's in the tray.",
      example_tr: "Cepler boş — her şey tepside.",
    },
    {
      id: "ex.da44.2.v07",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "set off the alarm",
      tr_translation: "Alarmı tetiklemek",
      example: "My belt buckle might set off the alarm.",
      example_tr: "Kemer tokam alarmı tetikleyebilir.",
    },
    {
      id: "ex.da44.2.v08",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "body scanner",
      tr_translation: "Vücut tarayıcısı",
      example: "Please step into the body scanner.",
      example_tr: "Lütfen vücut tarayıcısına geçin.",
    },
    {
      id: "ex.da44.2.v09",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "metal implant",
      tr_translation: "Metal implant",
      example: "I have a metal implant in my knee.",
      example_tr: "Dizimde metal bir implant var.",
    },
    {
      id: "ex.da44.2.v10",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "pat-down",
      tr_translation: "Üst arama (el ile)",
      example: "I'd prefer a pat-down over the body scanner.",
      example_tr: "Vücut tarayıcısı yerine üst aramayı tercih ederim.",
    },
    {
      id: "ex.da44.2.v11",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "I'm pre-cleared",
      tr_translation: "Ön onaylıyım (hızlı geçiş)",
      example: "I'm pre-cleared, so I keep my shoes on.",
      example_tr: "Ön onaylıyım, ayakkabılarımı çıkarmama gerek yok.",
    },
    {
      id: "ex.da44.2.v12",
      type: "vocab_tile",
      difficulty: 5,
      cefr_band: "C1",
      word_or_phrase: "global entry",
      tr_translation: "Global Entry (ABD hızlı giriş programı)",
      example: "With Global Entry, immigration takes about two minutes.",
      example_tr: "Global Entry ile pasaport kontrolü iki dakika sürüyor.",
    },
    {
      id: "ex.da44.2.v13",
      type: "vocab_tile",
      difficulty: 5,
      cefr_band: "C1",
      word_or_phrase: "secondary screening",
      tr_translation: "İkincil tarama (daha kapsamlı kontrol)",
      example: "They pulled me aside for secondary screening — random check.",
      example_tr: "Beni ikincil taramaya çektiler — rastgele kontrolmüş.",
    },
    {
      id: "ex.da44.2.rq1",
      type: "recall_quiz",
...
export const airportLesson_44_3: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 1,
      cefr_band: "A1",
      word_or_phrase: "help me",
      tr_translation: "Bana yardım et",
      example: "Can you help me, please?",
      example_tr: "Bana yardım edebilir misiniz, lütfen?",
    },
    {
      id: "ex.da44.3.v03",
      type: "vocab_tile",
      difficulty: 1,
      cefr_band: "A1",
      word_or_phrase: "address",
      tr_translation: "Adres",
      example: "Here is my hotel address.",
      example_tr: "İşte otel adresim.",
    },
    {
      id: "ex.da44.3.v04",
      type: "vocab_tile",
    ...
    },
    {
      ...
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "baggage claim",
      tr_translation: "Bagaj alma alanı",
      example: "I'm waiting at baggage claim three.",
      example_tr: "Üç numaralı bagaj alma alanında bekliyorum.",
    },
    {
      id: "ex.da44.3.v06",
      type: "vocab_tile",
      ...
      example: "I'm sorry, my bag is damaged — the handle is broken.",
      example_tr: "Üzgünüm, valizim hasarlı — sap kırılmış.",
    },
    {
      id: "ex.da44.3.v07",
      type: "vocab_tile",
      ...
      tr_translation: "Rapor / form doldurmak",
      example: "I'd like to file a delayed-baggage report.",
      example_tr: "Gecikmiş bagaj raporu doldurmak istiyorum.",
    },
    {
      id: "ex.da44.3.v08",
      type: "vocab_tile",
      ...
      example: "Could you give me a reference number for tracking?",
      example_tr: "Takip için bana referans numarası verir misiniz?",
    },
    {
      id: "ex.da44.3.v09",
      type: "vocab_tile",
      ...
      example: "Please deliver it to my hotel when it arrives.",
    ...
    },
    {
      ...
      tr_translation: "Zorunlu eşya için tazminat",
      example: "Am I entitled to compensation for essentials while I wait?",
      example_tr: "Beklerken zorunlu eşya için tazminat hakkım var mı?",
    },
    {
      id: "ex.da44.3.v11",
      type: "vocab_tile",
      ...
      example: "There are fragile items in the side pocket.",
      example_tr: "Yan cepte kırılır eşyalar var.",
    },
    {
      id: "ex.da44.3.v12",
      type: "vocab_tile",
      ...
      tr_translation: "PIR — havayolu kayıp bagaj raporu",
      example: "I need to fill out a property irregularity report.",
      example_tr: "Bir bagaj kayıp raporu (PIR) doldurmam gerekiyor.",
    },
    {
      id: "ex.da44.3.v13",
      type: "vocab_tile",
      ...
      tr_translation: "Beyhude seyahat (boşuna yapılmış)",
      example: "If the bag never arrives, this whole trip in vain claim could apply.",
      example_tr: "Valiz hiç gelmezse, beyhude seyahat tazminatı talebi geçerli olabilir.",
    },
    {
      id: "ex.da44.3.rq1",
      type: "recall_quiz",
...
export const airportLesson_44_4: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      word_or_phrase: "yes",
      tr_translation: "Evet",
      example: "Yes, please rebook me.",
      example_tr: "Evet, lütfen beni yeniden yerleştirin.",
    },
    {
      id: "ex.da44.4.v02",
      type: "vocab_tile",
      ...
      example: "No, I'd prefer a refund.",
      example_tr: "Hayır, para iadesini tercih ederim.",
    },
    {
      id: "ex.da44.4.v03",
      type: "vocab_tile",
      ...
      example: "Can I fly tomorrow?",
      example_tr: "Yarın uçabilir miyim?",
    },
    {
      id: "ex.da44.4.v04",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "where is the gate",
      tr_translation: "Gate (kapı) nerede?",
      example: "Where is the gate for the rebooked flight?",
      example_tr: "Yeniden ayrılan uçuş için gate nerede?",
    },
    {
      id: "ex.da44.4.v05",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "I'd like a refund",
      tr_translation: "Para iadesi istiyorum",
      example: "I'd like a refund, please.",
      example_tr: "Para iadesi istiyorum, lütfen.",
    },
    {
      id: "ex.da44.4.v06",
      type: "vocab_tile",
    ...
    },
    {
      ...
      tr_translation: "Beni ... uçuşa aktar",
      example: "Could you rebook me on the morning flight?",
      example_tr: "Beni sabah uçuşuna aktarabilir misiniz?",
    },
    {
      id: "ex.da44.4.v08",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "hotel voucher",
      tr_translation: "Otel kuponu (havayolu sponsorlu)",
      example: "Will I get a hotel voucher tonight?",
      example_tr: "Bu gece otel kuponu alacak mıyım?",
    },
    {
      id: "ex.da44.4.v09",
      type: "vocab_tile",
      ...
      example: "Two meal vouchers should cover dinner and breakfast.",
      example_tr: "İki yemek kuponu akşam ve sabah için yeterli olmalı.",
    },
    {
      id: "ex.da44.4.v10",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "entitled to",
      tr_translation: "... hakkım var",
      example: "Am I entitled to compensation under EC261?",
      example_tr: "EC261 kapsamında tazminat hakkım var mı?",
    },
    {
      id: "ex.da44.4.v11",
      type: "vocab_tile",
      ...
      tr_translation: "Hangi seçeneklerim var?",
      example: "My flight's canceled — what are my options from here?",
      example_tr: "Uçuşum iptal — buradan sonra ne seçeneklerim var?",
    },
    {
      id: "ex.da44.4.v12",
      type: "vocab_tile",
      difficulty: 5,
      cefr_band: "C1",
      word_or_phrase: "denied boarding",
      tr_translation: "Uçağa alınmama (overbooking sonucu)",
      example: "I was denied boarding due to overbooking — what's my compensation?",
      example_tr: "Fazla rezervasyon nedeniyle uçağa alınmadım — tazminatım ne?",
    },
    {
      id: "ex.da44.4.v13",
      type: "vocab_tile",
      ...
      example: "I've been rerouted via Frankfurt — landing two hours later.",
      example_tr: "Frankfurt üzerinden yeniden yönlendirildim — iki saat geç ineceğim.",
    },
    {
      id: "ex.da44.4.rq1",
      type: "recall_quiz",
...
export const airportLesson_44_5: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 1,
      cefr_band: "A1",
      word_or_phrase: "heavy",
      tr_translation: "Ağır",
      example: "This bag is heavy.",
      example_tr: "Bu valiz ağır.",
    },
    {
      id: "ex.da44.5.v02",
      type: "vocab_tile",
    ...
    },
    {
      ...
      example: "Wait, let me check my bag.",
      example_tr: "Bekle, valizimi kontrol edeyim.",
    },
    {
      id: "ex.da44.5.v04",
      type: "vocab_tile",
      ...
      example: "How much is it per extra kilo?",
      example_tr: "Fazladan kilo başına ne kadar?",
    },
    {
      id: "ex.da44.5.v05",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "open my bag",
      tr_translation: "Valizimi aç",
      example: "Let me open my bag and move some things.",
      example_tr: "Valizimi açayım, biraz şey aktarayım.",
    },
    {
      id: "ex.da44.5.v06",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "extra weight",
      tr_translation: "Fazla kilo",
      example: "I can pay for the extra weight.",
      example_tr: "Fazla kilo için ödeme yapabilirim.",
    },
    {
      id: "ex.da44.5.v07",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "weight limit",
      tr_translation: "Kilo sınırı",
      example: "What's the weight limit for checked bags?",
      example_tr: "Verilen bagajın kilo sınırı nedir?",
    },
    {
      id: "ex.da44.5.v08",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "redistribute",
      tr_translation: "Yeniden dağıtmak (eşyaları)",
      example: "Let me redistribute some items into my carry-on.",
      example_tr: "Bazı eşyaları kabin çantasına aktarayım.",
    },
    {
      id: "ex.da44.5.v09",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "reweigh",
      tr_translation: "Yeniden tartmak",
      example: "Could you reweigh the bag after I move things?",
      example_tr: "Eşyaları aktardıktan sonra valizi yeniden tartar mısınız?",
    },
    {
      id: "ex.da44.5.v10",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "excess baggage fee",
      tr_translation: "Aşırı bagaj ücreti",
      example: "Could you waive the excess baggage fee just this once?",
      example_tr: "Bu seferlik aşırı bagaj ücretinden vazgeçebilir misiniz?",
    },
    {
      id: "ex.da44.5.v11",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "my layover is short",
      tr_translation: "Aktarmam çok kısa",
      example: "My layover is short — could I get priority bag tagging?",
      example_tr: "Aktarmam çok kısa — öncelikli bagaj etiketi alabilir miyim?",
    },
    {
      id: "ex.da44.5.v12",
      type: "vocab_tile",
      difficulty: 5,
      cefr_band: "C1",
      word_or_phrase: "checked baggage allowance",
      tr_translation: "Verilen bagaj hakkı",
      example: "My fare includes a 32-kilo checked baggage allowance.",
      example_tr: "Tarifeme 32 kg verilen bagaj hakkı dahil.",
    },
    {
      id: "ex.da44.5.v13",
      type: "vocab_tile",
      ...
      word_or_phrase: "rerouted via",
      tr_translation: "... üzerinden yeniden yönlendirildi",
      example: "Since the bag is rerouted via Frankfurt, the weight rules differ.",
      example_tr: "Valiz Frankfurt üzerinden yönlendirildiği için kilo kuralları farklı.",
    },
    {
      id: "ex.da44.5.rq1",
      type: "recall_quiz",
...
export const airportLesson_44_6: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      cefr_band: "A1",
      word_or_phrase: "gate",
      tr_translation: "Gate (kapı)",
      example: "Gate B23, please.",
      example_tr: "B23 numaralı kapı, lütfen.",
    },
    {
      id: "ex.da44.6.v02",
      type: "vocab_tile",
    ...
    },
    {
      ...
      example: "Excuse me, where is my gate for TK0001?",
      example_tr: "Affedersiniz, TK0001 için gate'im nerede?",
    },
    {
      id: "ex.da44.6.v05",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "this way",
      tr_translation: "Bu taraftan",
      example: "Is gate B23 this way?",
      example_tr: "B23 gate'i bu taraftan mı?",
    },
    {
      id: "ex.da44.6.v06",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "boarding",
      tr_translation: "Biniş",
      example: "Boarding starts at 10:40.",
      example_tr: "Biniş 10:40'ta başlar.",
    },
    {
      id: "ex.da44.6.v07",
      type: "vocab_tile",
      ...
      tr_translation: "Terminaller arası shuttle",
      example: "Where do I catch the terminal shuttle to T2?",
      example_tr: "T2'ye giden terminal shuttle'ı nereden alırım?",
    },
    {
      id: "ex.da44.6.v08",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "final call",
      tr_translation: "Son çağrı",
      example: "Final call for flight TK0001 — passengers should head to the gate.",
      example_tr: "TK0001 uçuşu için son çağrı — yolcular gate'e yönelmeli.",
    },
    {
      id: "ex.da44.6.v09",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "now boarding",
      tr_translation: "Şu an biniyor",
      example: "Now boarding zone 3 — please have your boarding pass ready.",
      example_tr: "Şu an 3. bölge biniyor — biniş kartınızı hazır tutun.",
    },
    {
      id: "ex.da44.6.v10",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "I'm about to board",
      tr_translation: "Binmek üzereyim",
      example: "I'm about to board — let me text you when I land.",
      example_tr: "Binmek üzereyim — indiğimde sana yazarım.",
    },
    {
      id: "ex.da44.6.v11",
      type: "vocab_tile",
      ...
      example: "Could you point me in the right direction for D12?",
      example_tr: "D12 için beni doğru yöne yönlendirir misiniz?",
    },
    {
      id: "ex.da44.6.v12",
      type: "vocab_tile",
      ...
      example: "I'm in transit to Istanbul — I don't need to clear customs here.",
      example_tr: "İstanbul'a transit yolcuyum — burada gümrükten geçmem gerekmez.",
    },
    {
      id: "ex.da44.6.v13",
      type: "vocab_tile",
      difficulty: 5,
      cefr_band: "C1",
      word_or_phrase: "gate hold",
      tr_translation: "Gate'te bekletme",
      example: "There's a gate hold due to weather at the destination.",
      example_tr: "Varış noktasındaki hava nedeniyle gate'te bekletme var.",
    },
    {
      id: "ex.da44.6.rq1",
      type: "recall_quiz",
...
export const airportLesson_44_7: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      word_or_phrase: "late",
      tr_translation: "Geç",
      example: "My flight is late.",
      example_tr: "Uçuşum geç.",
    },
    {
      id: "ex.da44.7.v02",
      type: "vocab_tile",
      difficulty: 1,
      cefr_band: "A1",
      word_or_phrase: "next flight",
      tr_translation: "Sonraki uçuş",
      example: "When is the next flight?",
      example_tr: "Sonraki uçuş ne zaman?",
    },
    {
      id: "ex.da44.7.v03",
      type: "vocab_tile",
      ...
      tr_translation: "Otel",
      example: "I need a hotel.",
      example_tr: "Otele ihtiyacım var.",
    },
    {
      id: "ex.da44.7.v04",
      type: "vocab_tile",
      ...
      example: "I missed my flight — what should I do?",
      example_tr: "Uçuşumu kaçırdım — ne yapmalıyım?",
    },
    {
      id: "ex.da44.7.v05",
      type: "vocab_tile",
      ...
      example: "The first flight was delayed.",
      example_tr: "İlk uçuş geç kaldı.",
    },
    {
      id: "ex.da44.7.v06",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "where do I go now",
      tr_translation: "Şimdi nereye gideyim?",
      example: "Where do I go now to get a new boarding pass?",
      example_tr: "Yeni biniş kartı almak için şimdi nereye gideyim?",
    },
    {
      id: "ex.da44.7.v07",
      type: "vocab_tile",
      ...
      example: "I have a tight connection — could we expedite this?",
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "layover",
      tr_translation: "Aktarma süresi (bekleme)",
      example: "I have a six-hour layover in Frankfurt.",
      example_tr: "Frankfurt'ta altı saatlik aktarma süresi var.",
    },
    {
      id: "ex.da44.7.v09",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "rebooked on",
      tr_translation: "... uçuşa yeniden ayrıldım",
      example: "I've been rebooked on the morning flight.",
      example_tr: "Sabah uçuşuna yeniden ayrıldım.",
    },
    {
      id: "ex.da44.7.v10",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "tagged through to",
      tr_translation: "... varış noktasına etiketli (bagaj)",
      example: "My bag is tagged through to Istanbul — I don't need to recheck.",
      example_tr: "Valizim İstanbul'a kadar etiketli — yeniden teslim etmeme gerek yok.",
    },
    {
      id: "ex.da44.7.v11",
      type: "vocab_tile",
      ...
      example: "Am I entitled to a transit hotel since the delay is on you?",
      example_tr: "Gecikme sizden olduğu için aktarma oteli hakkım var mı?",
    },
    {
      id: "ex.da44.7.v12",
      type: "vocab_tile",
      difficulty: 5,
      cefr_band: "C1",
      word_or_phrase: "inbound leg",
      tr_translation: "Geliş bacağı (ilk uçuş)",
      example: "The inbound leg landed 40 minutes late, so I missed my connection.",
      example_tr: "Geliş bacağı 40 dakika geç indi, aktarmamı kaçırdım.",
    },
    {
      id: "ex.da44.7.v13",
      type: "vocab_tile",
      ...
      word_or_phrase: "bumped to standby",
      tr_translation: "Yedek listeye düşürüldüm",
      example: "I was bumped to standby on the next flight — they overbooked.",
      example_tr: "Sonraki uçuşta yedek listeye düşürüldüm — fazla rezervasyon yapmışlar.",
    },
    {
      id: "ex.da44.7.rq1",
      type: "recall_quiz",
...
export const airportLesson_44_8: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 1,
      cefr_band: "A1",
      word_or_phrase: "10 days",
      tr_translation: "10 gün",
      example: "10 days, please.",
      example_tr: "10 gün, lütfen.",
    },
    {
      id: "ex.da44.8.v03",
      type: "vocab_tile",
    ...
    },
    {
      ...
      example: "I'm from Turkey — first time in the US.",
      example_tr: "Türkiye'denim — ilk kez ABD'deyim.",
    },
    {
      id: "ex.da44.8.v05",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "staying at a hotel",
      tr_translation: "Otelde kalıyorum",
      example: "I'm staying at a hotel in Manhattan.",
      example_tr: "Manhattan'da bir otelde kalıyorum.",
    },
    {
      id: "ex.da44.8.v06",
      type: "vocab_tile",
      ...
      tr_translation: "Dönüş bileti",
      example: "Here's my return ticket.",
      example_tr: "İşte dönüş biletim.",
    },
    {
      id: "ex.da44.8.v07",
      type: "vocab_tile",
      ...
      example: "I'm here on holiday — staying with a friend.",
      example_tr: "Tatil için buradayım — bir arkadaşımda kalıyorum.",
    },
    {
      id: "ex.da44.8.v08",
      type: "vocab_tile",
      ...
      example: "Anything to declare? — No, nothing.",
      example_tr: "Beyan edilecek bir şey? — Hayır, hiçbir şey.",
    },
    {
      id: "ex.da44.8.v09",
      type: "vocab_tile",
    ...
    },
    {
      ...
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "first time in the country",
      tr_translation: "Ülkeye ilk gelişim",
      example: "It's my first time in the country — any tips?",
      example_tr: "Ülkeye ilk gelişim — önerin var mı?",
    },
    {
      id: "ex.da44.8.v12",
      type: "vocab_tile",
      ...
      word_or_phrase: "I'm in transit",
      tr_translation: "Transit yolcuyum",
      example: "I'm in transit — connecting to Istanbul this afternoon.",
      example_tr: "Transit yolcuyum — bu öğleden sonra İstanbul'a aktarmam var.",
    },
    {
      id: "ex.da44.8.v13",
      type: "vocab_tile",
      ...
      cefr_band: "C2",
      word_or_phrase: "trip in vain",
      tr_translation: "Beyhude seyahat",
      example: "If I'm refused entry, this becomes a trip in vain.",
      example_tr: "Eğer girişim reddedilirse bu beyhude bir seyahate dönüşür.",
    },
    {
      id: "ex.da44.8.rq1",
      type: "recall_quiz",
