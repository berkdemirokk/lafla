...
export const cefrA1SurvivalScenes: Scene[] = [
  ...
  {
    id: "scene-a1-survival-11",
    emoji: "📶",
    title: "İhtiyaç —\nBathroom,\nWifi, Help",
    description:
      "Kafe, otel, havalimanı: 'Where is the bathroom?', 'Wifi password, please?', 'Can you help me?'. Kibar ve net.",
    durationMin: 5,
    mode: "daily",
    cefrLevel: "A1",
    skillId: "daily.survival.a1",
    lessonId: "daily.survival.a1.11",
    isNew: true,
    progressLabel: "11/14 ders",
  },
  {
    id: "scene-a1-survival-12",
    emoji: "❓",
    title: "Anlamadım —\nCould you\nrepeat?",
    description:
      "Karşı taraf hızlı konuştu, donmadan kibarca tekrar iste. 'Sorry, I don't understand', 'Slowly please'.",
    durationMin: 5,
    mode: "daily",
    cefrLevel: "A1",
    skillId: "daily.survival.a1",
    lessonId: "daily.survival.a1.12",
    isNew: true,
    progressLabel: "12/14 ders",
  },
  {
    id: "scene-a1-survival-13",
    emoji: "🙋",
    title: "Yes / No /\nMaybe —\ntemel cevaplar",
    description:
      "Tek kelimelik kibar cevaplar: 'Yes, please', 'No, thank you', 'Maybe later'. Hayır demeyi de öğren.",
    durationMin: 4,
    mode: "daily",
    cefrLevel: "A1",
    skillId: "daily.survival.a1",
    lessonId: "daily.survival.a1.13",
    isNew: true,
    progressLabel: "13/14 ders",
  },
  {
    id: "scene-a1-survival-14",
    emoji: "🆘",
    title: "Acil — Help!\nPolice!\nDoctor!",
    description:
      "Acil durumda: 'Help!', 'Call the police!', 'I need a doctor', 'Call 911'. Kısa, yüksek sesli, hayat kurtarır.",
    durationMin: 5,
    mode: "daily",
    cefrLevel: "A1",
    skillId: "daily.survival.a1",
    lessonId: "daily.survival.a1.14",
    isNew: true,
