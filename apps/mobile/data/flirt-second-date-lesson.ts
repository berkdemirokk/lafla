...
export const flirtSecondDateLesson_42_2: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Hit the exhibit",
      tr_translation: "Sergiye uğramak",
      example: "Want to hit the exhibit before it closes?",
      example_tr: "Sergi kapanmadan önce uğrayalım mı?",
    },
    {
      id: "ex.fsd42.2.vt3",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Rooftop bar",
      tr_translation: "Çatı bar",
      example: "There's a rooftop bar with the best view — Thursday?",
      example_tr: "En güzel manzaralı çatı bar var — Perşembe?",
    },
    {
      id: "ex.fsd42.2.vt4",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Check it out together",
      tr_translation: "Birlikte bakalım",
      example: "New ramen place opened — check it out together?",
      example_tr: "Yeni ramen yeri açıldı — birlikte bakalım mı?",
    },
    {
      id: "ex.fsd42.2.vt5",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Skip dinner this time",
      tr_translation: "Bu sefer yemeği atlayalım",
      example: "Skip dinner this time — let's do a long walk instead.",
      example_tr: "Bu sefer yemeği atlayalım — uzun bir yürüyüş yapalım.",
    },
    {
      id: "ex.fsd42.2.vt6",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "Wear something warm",
      tr_translation: "Sıcak bir şey giy",
      example: "Wear something warm — it's on the rooftop.",
      example_tr: "Sıcak bir şey giy — çatıda.",
    },
  ],
};
...
export const flirtSecondDateLesson_42_3: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      example: "Real one — what's been on your mind lately?",
      example_tr: "Gerçek soru — son zamanlarda aklında ne var?",
    },
    {
      id: "ex.fsd42.3.vt3",
      type: "vocab_tile",
      ...
      word_or_phrase: "What made you choose",
      tr_translation: "Seni seçmeye iten neydi",
      example: "What made you choose this city — was it the people?",
      example_tr: "Bu şehri seçmeye iten neydi — insanlar mıydı?",
    },
    {
      id: "ex.fsd42.3.vt4",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Heavier year",
      tr_translation: "Daha ağır bir yıl",
      example: "Honestly, it's been a heavier year than I expected.",
      example_tr: "Açıkçası beklediğimden daha ağır bir yıl oldu.",
    },
    {
      id: "ex.fsd42.3.vt5",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Still figuring it out",
      tr_translation: "Hala anlamaya çalışıyorum",
      example: "Still figuring it out — but it's been a growth year.",
      example_tr: "Hala anlamaya çalışıyorum — ama büyüme yılı oldu.",
    },
    {
      id: "ex.fsd42.3.vt6",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Doesn't have to be matched",
      tr_translation: "Eşitlemek zorunda değilsin (derinlik daveti)",
      example: "Just sharing — doesn't have to be matched on your end.",
      example_tr: "Sadece paylaşıyorum — senin tarafından eşitlemek zorunda değilsin.",
    },
  ],
};
...
export const flirtSecondDateLesson_42_4: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Is this okay?",
      tr_translation: "Bu uygun mu? (rıza)",
      example: "Is this okay? I really want to kiss you.",
      example_tr: "Bu uygun mu? Seni gerçekten öpmek istiyorum.",
    },
    {
      id: "ex.fsd42.4.vt3",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Let's take it slow",
      tr_translation: "Yavaş ilerleyelim",
      example: "Let's take it slow tonight — no pressure.",
      example_tr: "Bu gece yavaş ilerleyelim — baskı yok.",
    },
    {
      id: "ex.fsd42.4.vt4",
      type: "vocab_tile",
      ...
      cefr_band: "B2",
      word_or_phrase: "Enthusiastic consent",
      tr_translation: "Coşkulu rıza (modern norm)",
      example: "Looking for enthusiastic consent — no maybes.",
      example_tr: "Coşkulu rıza arıyorum — 'belki' kabul yok.",
    },
    {
      id: "ex.fsd42.4.vt5",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Don't want tonight to end",
      tr_translation: "Bu gecenin bitmesini istemiyorum",
      example: "Don't want tonight to end — but only if you're up for more.",
      example_tr: "Bu gecenin bitmesini istemiyorum — ama sadece sen de istiyorsan.",
    },
    {
      id: "ex.fsd42.4.vt6",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Mind if I",
      tr_translation: "... yapsam olur mu (saygılı)",
      example: "Mind if I put my arm around you?",
      example_tr: "Kolumu omzuna atsam olur mu?",
    },
  ],
};
...
export const flirtSecondDateLesson_42_5: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "You in?",
      tr_translation: "Var mısın?",
      example: "Mini golf Saturday — you in?",
      example_tr: "Cumartesi mini golf — var mısın?",
    },
    {
      id: "ex.fsd42.5.vt3",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Or is that too chaotic?",
      tr_translation: "Yoksa bu çok mu kaotik?",
      example: "Bowling Saturday — or is that too chaotic?",
      example_tr: "Cumartesi bovling — yoksa bu çok mu kaotik?",
    },
    {
      id: "ex.fsd42.5.vt4",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Pretty competitive",
      tr_translation: "Bayağı rekabetçi (uyarı)",
      example: "Fair warning — I'm pretty competitive at mini golf.",
      example_tr: "Önceden uyarayım — mini golfta bayağı rekabetçiyimdir.",
    },
    {
      id: "ex.fsd42.5.vt5",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Loser buys drinks",
      tr_translation: "Kaybeden içkileri alır",
      example: "Loser buys drinks — deal?",
      example_tr: "Kaybeden içkileri alır — anlaştık mı?",
    },
    {
      id: "ex.fsd42.5.vt6",
      type: "vocab_tile",
      ...
      example: "Sounds fun — let's lock it in.",
      example_tr: "Eğlenceli görünüyor — kesinleştirelim.",
    },
  ],
};
...
export const flirtSecondDateLesson_42_6: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Set the bar pretty high",
      tr_translation: "Çıtayı epey yükseğe koydun",
      example: "Last time set the bar pretty high — tonight has to top it.",
      example_tr: "Geçen sefer çıtayı epey yükseğe koydun — bu gecenin geçmesi lazım.",
    },
    {
      id: "ex.fsd42.6.vt3",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Glad we did this again",
      tr_translation: "Bunu tekrar yaptığımıza sevindim",
      example: "Honestly glad we did this again — round 2!",
      example_tr: "Açıkçası bunu tekrar yaptığımıza sevindim — ikinci raunt!",
    },
    {
      id: "ex.fsd42.6.vt4",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "You ruined X for me",
      tr_translation: "X'in tadını mahvettin (pozitif teasing)",
      example: "You ruined regular tacos for me — now I want that place every week.",
      example_tr: "Normal taco'ların tadını mahvettin — şimdi her hafta o yeri istiyorum.",
    },
    {
      id: "ex.fsd42.6.vt5",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Wouldn't miss this",
      tr_translation: "Bunu kaçırmam",
      example: "Wouldn't miss this — been looking forward all week.",
      example_tr: "Bunu kaçırmam — tüm hafta bekledim.",
    },
    {
      id: "ex.fsd42.6.vt6",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Counting down to tonight",
      tr_translation: "Bu geceyi sayıyordum",
      example: "Not gonna lie — been counting down to tonight.",
      example_tr: "Yalan söylemeyeceğim — bu geceyi sayıyordum.",
    },
  ],
};
...
export const flirtSecondDateLesson_42_7: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      cefr_band: "B2",
      word_or_phrase: "Ok real talk",
      tr_translation: "Tamam dürüstçe konuşalım",
      example: "Ok real talk — I don't usually open up this fast.",
      example_tr: "Tamam dürüstçe konuşalım — genelde bu kadar çabuk açılmam.",
    },
    {
      id: "ex.fsd42.7.vt3",
      type: "vocab_tile",
      ...
      tr_translation: "Açılmak (duygusal)",
      example: "Don't usually open up this fast — feels different with you.",
      example_tr: "Bu kadar çabuk açılmam — seninle farklı hissettiriyor.",
    },
    {
      id: "ex.fsd42.7.vt4",
      type: "vocab_tile",
      ...
      example: "Not gonna lie — into where this is going.",
      example_tr: "Yalan söylemeyeceğim — bunun gittiği yere bayıldım.",
    },
    {
      id: "ex.fsd42.7.vt5",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Trusting me with that",
      tr_translation: "Bunu benimle paylaşman (güven)",
      example: "Thanks for trusting me with that — means a lot.",
      example_tr: "Bunu benimle paylaşman için sağ ol — çok şey ifade ediyor.",
    },
    {
      id: "ex.fsd42.7.vt6",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "No pressure to match",
      tr_translation: "Eşleme baskısı yok (vulnerability)",
      example: "Just sharing — no pressure to match the energy.",
      example_tr: "Sadece paylaşıyorum — enerjiyi eşleştirme baskısı yok.",
    },
  ],
};
...
export const flirtSecondDateLesson_42_8: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Low-key night in",
      tr_translation: "Sakin bir ev akşamı",
      example: "Low-key night in — I'll cook, you pick the movie.",
      example_tr: "Sakin bir ev akşamı — ben yemek yaparım, sen film seçersin.",
    },
    {
      id: "ex.fsd42.8.vt3",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "I'll cook, you pick",
      tr_translation: "Ben yemek yaparım, sen seçersin",
      example: "I'll cook, you pick the playlist — fair split.",
      example_tr: "Ben yemek yaparım, sen çalma listesini seçersin — adil bölüşüm.",
    },
    {
      id: "ex.fsd42.8.vt4",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Leave whenever you want",
      tr_translation: "İstediğin zaman çık",
      example: "No pressure — leave whenever you want.",
      example_tr: "Baskı yok — istediğin zaman çık.",
    },
    {
      id: "ex.fsd42.8.vt5",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Totally fine if too soon",
      tr_translation: "Erkense tamamen anlarım",
      example: "My place for dinner — totally fine if too soon.",
      example_tr: "Bende yemek — erkense tamamen anlarım.",
    },
    {
      id: "ex.fsd42.8.vt6",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "I actually cook",
      tr_translation: "Aslında yemek yapabiliyorum",
      example: "My place this weekend? I actually cook — promise it's edible.",
      example_tr: "Bu hafta sonu bende? Aslında yemek yapabiliyorum — söz, yenilebilir.",
    },
  ],
};
