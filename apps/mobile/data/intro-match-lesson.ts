...
export const introMatchLesson_0_1: BundledLesson = {
  ...
  exercises: [
    ...
    // ============================================================
    // VOCAB PACK — onboarding sonrası ilk sahne, kolay başlangıç
    // Dağılım: A1:3, A2:5, B1:3, B2:1, C1:1 (toplam 13)
    // ============================================================
    {
      id: "ex.intro.match.1.4",
      type: "vocab_tile",
      difficulty: 1,
      cefr_band: "A1",
      word_or_phrase: "hi",
      ...
      example: "Hi! I'm Berk.",
      example_tr: "Selam! Ben Berk.",
    },
    {
      id: "ex.intro.match.1.5",
      type: "vocab_tile",
      difficulty: 1,
      cefr_band: "A1",
      word_or_phrase: "nice",
      tr_translation: "güzel / hoş",
      example: "Your profile is nice.",
      example_tr: "Profilin güzelmiş.",
    },
    {
      id: "ex.intro.match.1.6",
      type: "vocab_tile",
      difficulty: 1,
      cefr_band: "A1",
      word_or_phrase: "you?",
      tr_translation: "ya sen?",
      example: "I'm good. You?",
      example_tr: "İyiyim. Ya sen?",
    },
    {
      id: "ex.intro.match.1.7",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "how's your week",
      tr_translation: "haftan nasıl gidiyor",
      example: "How's your week going so far?",
      example_tr: "Haftan şimdiye kadar nasıl gidiyor?",
    },
    {
      id: "ex.intro.match.1.8",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "I saw your bio",
      tr_translation: "bio'nu gördüm",
      example: "I saw your bio — climbing, right?",
      example_tr: "Bio'nu gördüm — tırmanış, değil mi?",
    },
    {
      id: "ex.intro.match.1.9",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "are you free this weekend",
      tr_translation: "bu hafta sonu müsait misin",
      example: "Are you free this weekend? Coffee?",
      example_tr: "Bu hafta sonu müsait misin? Kahve?",
    },
    {
      id: "ex.intro.match.1.10",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "sounds good",
      tr_translation: "iyi fikir / kulağa hoş geliyor",
      example: "Saturday at 8? Sounds good.",
      example_tr: "Cumartesi 8'de? İyi fikir.",
    },
    {
      id: "ex.intro.match.1.11",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "A2",
      ...
      example_tr: "Sana ne uygunsa bana haber ver.",
    },
    {
      id: "ex.intro.match.1.12",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "I was just thinking",
      tr_translation: "ben de tam düşünüyordum",
      example: "I was just thinking the same — coffee on Saturday?",
      example_tr: "Ben de tam aynısını düşünüyordum — cumartesi kahve?",
    },
    {
      id: "ex.intro.match.1.13",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "down for",
      tr_translation: "varım / yapmaya razıyım",
      example: "I'm down for Saturday — pick the spot?",
      example_tr: "Cumartesi varım — mekanı sen seç?",
    },
    {
      id: "ex.intro.match.1.14",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "if you're around",
      tr_translation: "eğer civardaysan / müsaitsen",
      example: "If you're around Saturday, wanna grab coffee?",
      example_tr: "Cumartesi civardaysan, kahve içer miyiz?",
    },
    {
      id: "ex.intro.match.1.15",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "no pressure though",
      tr_translation: "ama baskı yok / mecbur değilsin",
      example: "Saturday works for me — no pressure though.",
      example_tr: "Cumartesi bana uyar — ama mecbur değilsin.",
    },
    {
      id: "ex.intro.match.1.16",
      type: "vocab_tile",
      difficulty: 5,
      cefr_band: "C1",
      word_or_phrase: "I'd hate to keep you waiting",
      tr_translation: "seni bekletmek istemem",
      example: "I'd hate to keep you waiting — Saturday 8 then?",
      example_tr: "Seni bekletmek istemem — cumartesi 8 olur mu?",
    },
  ],
};
