...
export const flirtDefineLesson_6_2: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "At my own pace",
      tr_translation: "Kendi temponda",
      example: "I need to take this at my own pace — hope that works.",
      example_tr: "Bunu kendi tempomda almam lazım — umarım sorun olmaz.",
    },
    {
      id: "ex.fd6.2.vt3",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Not ready yet",
      tr_translation: "Henüz hazır değilim",
      example: "Not ready yet for sleepovers — getting there though.",
      example_tr: "Henüz gece kalmaya hazır değilim — ama yaklaşıyorum.",
    },
    {
      id: "ex.fd6.2.vt4",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "When that happens, I feel",
      tr_translation: "Şu olduğunda, ben hissediyorum (I-format sınır)",
      example: "When that happens, I feel overwhelmed — can we adjust?",
      example_tr: "Şu olduğunda boğulmuş hissediyorum — ayarlayabilir miyiz?",
    },
    {
      id: "ex.fd6.2.vt5",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Doesn't work for me",
      tr_translation: "Benim için uygun değil",
      example: "That kind of texting frequency doesn't work for me.",
      example_tr: "Bu sıklıkta mesajlaşma benim için uygun değil.",
    },
    {
      id: "ex.fd6.2.vt6",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Need space to process",
      tr_translation: "Sindirmek için alana ihtiyacım var",
      example: "Need some space to process — can we talk tomorrow?",
      example_tr: "Sindirmek için biraz alana ihtiyacım var — yarın konuşalım mı?",
    },
  ],
};
...
export const flirtDefineLesson_6_3: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      example: "Cards on the table — I want something long-term.",
      example_tr: "Açık konuşayım — uzun dönem bir şey istiyorum.",
    },
    {
      id: "ex.fd6.3.vt3",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Going somewhere real",
      tr_translation: "Gerçek bir yere gidiyor",
      example: "Honestly, I see this going somewhere real.",
      example_tr: "Açıkçası bunun gerçek bir yere gittiğini görüyorum.",
    },
    {
      id: "ex.fd6.3.vt4",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Same wavelength",
      tr_translation: "Aynı dalga boyu",
      example: "Glad we're on the same wavelength about this.",
      example_tr: "Bu konuda aynı dalga boyunda olduğumuza sevindim.",
    },
    {
      id: "ex.fd6.3.vt5",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Day by day",
      tr_translation: "Günbegün (acelesiz ilerlemek)",
      example: "Day by day, but I see us building something.",
      example_tr: "Günbegün, ama bir şey inşa ettiğimizi görüyorum.",
    },
    {
      id: "ex.fd6.3.vt6",
      type: "vocab_tile",
      ...
      cefr_band: "B2",
      word_or_phrase: "What are you looking for?",
      tr_translation: "Sen ne arıyorsun?",
      example: "Real question — what are you looking for in this?",
      example_tr: "Gerçek soru — bu işten ne arıyorsun?",
    },
  ],
};
...
export const flirtDefineLesson_6_4: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Need a breather",
      tr_translation: "Nefes almaya ihtiyacım var",
      example: "Just need a breather — not pulling away, just recharging.",
      example_tr: "Sadece nefes almaya ihtiyacım var — uzaklaşmıyorum, sadece şarj oluyorum.",
    },
    {
      id: "ex.fd6.4.vt3",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "It's not you, it's the pace",
      tr_translation: "Sorun sen değilsin, tempo",
      example: "It's not you, it's the pace — can we slow down a bit?",
      example_tr: "Sorun sen değilsin, tempo — biraz yavaşlasak mı?",
    },
    {
      id: "ex.fd6.4.vt4",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Quieter days",
      tr_translation: "Daha az iletişimli günler",
      example: "Could we have quieter days for a bit? Need to recharge.",
      example_tr: "Bir süre daha az iletişimli günler geçirebilir miyiz? Şarj olmam lazım.",
    },
    {
      id: "ex.fd6.4.vt5",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Still 100% in this",
      tr_translation: "Hala bu işteyim, yüzde yüz",
      example: "Still 100% in this — just need slower texting for a week.",
      example_tr: "Hala bu işteyim, yüzde yüz — sadece bir hafta yavaş mesajlaşmaya ihtiyacım var.",
    },
    {
      id: "ex.fd6.4.vt6",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Catch up emotionally",
      tr_translation: "Duygusal olarak yetişmek",
      example: "Need a few days to catch up emotionally — hope that's okay.",
      example_tr: "Duygusal olarak yetişmek için birkaç güne ihtiyacım var — umarım sorun olmaz.",
    },
  ],
};
...
export const flirtDefineLesson_6_5: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      tr_translation: "Sen bunun nereye gittiğini görüyorsun?",
      example: "No pressure but — where do you see this going?",
      example_tr: "Baskı yok ama — sen bunun nereye gittiğini görüyorsun?",
    },
    {
      id: "ex.fd6.5.vt3",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "No labels yet",
      tr_translation: "Henüz etiket yok",
      example: "No labels yet, just curious how you feel about us.",
      example_tr: "Henüz etiket yok, sadece bizim hakkımızda nasıl hissettiğini merak ediyorum.",
    },
    {
      id: "ex.fd6.5.vt4",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Curious where you're at",
      tr_translation: "Senin nerede olduğunu merak ediyorum",
      example: "Just curious where you're at on the whole thing.",
      example_tr: "Bu konunun bütününde nerede olduğunu merak ediyorum sadece.",
    },
    {
      id: "ex.fd6.5.vt5",
      type: "vocab_tile",
      ...
      tr_translation: "Hazır olduğunda",
      example: "Whenever you're ready to talk about it, I'm here.",
      example_tr: "Bunu konuşmaya hazır olduğunda buradayım.",
    },
    {
      id: "ex.fd6.5.vt6",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Glad we're talking",
      tr_translation: "Konuştuğumuza sevindim",
      example: "Glad we're talking about this — feels important.",
      example_tr: "Bunu konuştuğumuza sevindim — önemli geliyor.",
    },
  ],
};
...
export const flirtDefineLesson_6_6: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Focus on just us",
      tr_translation: "Sadece bize odaklanmak",
      example: "I'd love to focus on just us — how do you feel?",
      example_tr: "Sadece bize odaklanmak istiyorum — sen nasıl hissediyorsun?",
    },
    {
      id: "ex.fd6.6.vt3",
      type: "vocab_tile",
      ...
      tr_translation: "Uygulamaları silmek",
      example: "Want to delete the apps together tonight?",
      example_tr: "Bu gece beraber uygulamaları silelim mi?",
    },
    {
      id: "ex.fd6.6.vt4",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Are you in?",
      tr_translation: "Var mısın?",
      example: "Exclusive — are you in?",
      example_tr: "Sadece birbirimiz — var mısın?",
    },
    {
      id: "ex.fd6.6.vt5",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Same page",
      tr_translation: "Aynı sayfada (mutabık)",
      example: "Want to make sure we're on the same page about exclusivity.",
      example_tr: "Sadece birbirimiz konusunda aynı sayfada olduğumuzdan emin olmak istiyorum.",
    },
    {
      id: "ex.fd6.6.vt6",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Off the apps",
      tr_translation: "Uygulamalardan uzakta (sildim)",
      example: "I'm already off the apps if you are.",
      example_tr: "Sen de istersen ben zaten uygulamalardan uzaktayım.",
    },
  ],
};
...
export const flirtDefineLesson_6_7: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Make it official",
      tr_translation: "Resmileştirelim",
      example: "Want to make it official? I'd love that.",
      example_tr: "Resmileştirelim mi? Çok isterim.",
    },
    {
      id: "ex.fd6.7.vt3",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "How does that sit with you?",
      tr_translation: "Sana nasıl hissettiriyor?",
      example: "Boyfriend title — how does that sit with you?",
      example_tr: "Erkek arkadaş unvanı — sana nasıl hissettiriyor?",
    },
    {
      id: "ex.fd6.7.vt4",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Partner",
      tr_translation: "Partner (cinsiyet-nötr)",
      example: "Some people prefer 'partner' over boyfriend/girlfriend.",
      example_tr: "Bazı insanlar 'partner'ı boyfriend/girlfriend yerine tercih ediyor.",
    },
    {
      id: "ex.fd6.7.vt5",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "If you're comfortable with it",
      tr_translation: "Sen rahatsan",
      example: "Yes if you're comfortable with it — your call.",
      example_tr: "Sen rahatsan evet — sen karar ver.",
    },
    {
      id: "ex.fd6.7.vt6",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Sounds nice actually",
      tr_translation: "Aslında güzel duruyor",
      example: "'Partner' — sounds nice actually, let's go with that.",
      example_tr: "'Partner' — aslında güzel duruyor, bunu seçelim.",
    },
  ],
};
...
export const flirtDefineLesson_6_8: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Keep flowing",
      tr_translation: "Akmaya devam etmek (etiketsiz ilerleme)",
      example: "Can we keep flowing for a bit longer? No labels yet.",
      example_tr: "Biraz daha akmaya devam edebilir miyiz? Henüz etiket yok.",
    },
    {
      id: "ex.fd6.8.vt3",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Love what we have",
      tr_translation: "Sahip olduğumuza bayılıyorum",
      example: "I love what we have — let's keep it like this for a bit.",
      example_tr: "Sahip olduğumuza bayılıyorum — biraz böyle kalalım.",
    },
    {
      id: "ex.fd6.8.vt4",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "My own pace",
      tr_translation: "Kendi tempom",
      example: "It's about my own pace — not about you.",
      example_tr: "Bu kendi tempomla ilgili — seninle değil.",
    },
    {
      id: "ex.fd6.8.vt5",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Coming out of something",
      tr_translation: "Bir şeyden çıkıyorum (geçmiş ilişki)",
      example: "Honestly coming out of something — need a bit more time.",
      example_tr: "Açıkçası bir şeyden çıkıyorum — biraz daha zamana ihtiyacım var.",
    },
    {
      id: "ex.fd6.8.vt6",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Want to do this right",
      tr_translation: "Bunu doğru yapmak istiyorum",
      example: "Want to do this right — labels can wait a bit.",
      example_tr: "Bunu doğru yapmak istiyorum — etiketler biraz bekleyebilir.",
    },
  ],
};
