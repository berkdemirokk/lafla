...
export const airportLesson_44_21: BundledLesson = {
  ...
  exercises: [
    ...
    { id: "ex.44.21.v01", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "passport", tr_translation: "Pasaport", example: "Here is my passport.", example_tr: "İşte pasaportum." },
    { id: "ex.44.21.v02", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "ticket", tr_translation: "Bilet", example: "My ticket is on the phone.", example_tr: "Biletim telefonda." },
    { id: "ex.44.21.v03", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "help me", tr_translation: "Bana yardım et", example: "Could you help me?", example_tr: "Bana yardım eder misiniz?" },
    { id: "ex.44.21.v04", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "machine doesn't work", tr_translation: "Makine çalışmıyor", example: "This machine doesn't work.", example_tr: "Bu makine çalışmıyor." },
    { id: "ex.44.21.v05", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "where do I go", tr_translation: "Nereye gideyim?", example: "Where do I go for manual check-in?", example_tr: "Manuel check-in için nereye gideyim?" },
    { id: "ex.44.21.v06", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "boarding pass please", tr_translation: "Biniş kartı, lütfen", example: "Boarding pass please.", example_tr: "Biniş kartı, lütfen." },
    { id: "ex.44.21.v07", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "manual check-in", tr_translation: "Manuel (elle) check-in", example: "Could I do a manual check-in?", example_tr: "Manuel check-in yapabilir miyim?" },
    { id: "ex.44.21.v08", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "Turkish passport", tr_translation: "Türk pasaportu", example: "I have a Turkish passport — sometimes kiosks struggle.", example_tr: "Türk pasaportum var — bazen kiosk'lar zorlanıyor." },
    { id: "ex.44.21.v09", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "chip side down", tr_translation: "Chip tarafı aşağıda", example: "Try placing it chip side down.", example_tr: "Chip tarafı aşağıda dene." },
    { id: "ex.44.21.v10", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "I'd appreciate manual processing", tr_translation: "Manuel işlem için minnettar olurum", example: "I'd appreciate manual processing — the kiosk keeps erroring.", example_tr: "Manuel işlem için minnettar olurum — kiosk hep hata veriyor." },
    { id: "ex.44.21.v11", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "could you check me in", tr_translation: "Beni check-in eder misiniz?", example: "Could you check me in at the counter?", example_tr: "Kontuvarda beni check-in eder misiniz?" },
    { id: "ex.44.21.v12", type: "vocab_tile", difficulty: 5, cefr_band: "C1", word_or_phrase: "e-passport not recognized", tr_translation: "E-pasaport tanınmıyor", example: "The kiosk says e-passport not recognized.", example_tr: "Kiosk e-pasaport tanınmıyor diyor." },
    { id: "ex.44.21.v13", type: "vocab_tile", difficulty: 5, cefr_band: "C2", word_or_phrase: "biometric authentication failure", tr_translation: "Biyometrik kimlik doğrulama hatası", example: "Looks like a biometric authentication failure on the chip read.", example_tr: "Chip okumada biyometrik kimlik doğrulama hatası gibi görünüyor." },
    {
      id: "ex.44.21.rq1",
      type: "recall_quiz",
      items: [
...
export const airportLesson_44_22: BundledLesson = {
  ...
  exercises: [
    ...
    { id: "ex.44.22.v01", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "fee", tr_translation: "Ücret", example: "What's the fee?", example_tr: "Ücret ne?" },
    { id: "ex.44.22.v02", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "money", tr_translation: "Para", example: "I have money.", example_tr: "Param var." },
    { id: "ex.44.22.v03", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "open", tr_translation: "Aç", example: "I'll open my bag.", example_tr: "Valizimi açacağım." },
    { id: "ex.44.22.v04", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "too heavy", tr_translation: "Çok ağır", example: "My bag is too heavy.", example_tr: "Valizim çok ağır." },
    { id: "ex.44.22.v05", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "move some things", tr_translation: "Biraz eşya aktar", example: "Let me move some things to my carry-on.", example_tr: "Biraz eşyayı kabin çantama aktarayım." },
    { id: "ex.44.22.v06", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "step aside", tr_translation: "Yana çekil", example: "Step aside and reweigh after.", example_tr: "Yana çekil ve sonra yeniden tartılır." },
    { id: "ex.44.22.v07", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "ready to reweigh", tr_translation: "Yeniden tartım için hazırım", example: "Ready to reweigh — could you check?", example_tr: "Yeniden tartım için hazırım — kontrol eder misiniz?" },
    { id: "ex.44.22.v08", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "carry-on limit", tr_translation: "Kabin çantası limiti", example: "What's the carry-on limit?", example_tr: "Kabin çantası limiti ne?" },
    { id: "ex.44.22.v09", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "repack", tr_translation: "Yeniden paketle", example: "I'll just repack quickly.", example_tr: "Sadece hızlıca yeniden paketleyeceğim." },
    { id: "ex.44.22.v10", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "is there any way around it", tr_translation: "Bunu aşmanın bir yolu var mı?", example: "That's steep — is there any way around it?", example_tr: "Pahalı — bunu aşmanın bir yolu var mı?" },
    { id: "ex.44.22.v11", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "a bit steep", tr_translation: "Biraz pahalı (yumuşatıcı)", example: "$50 per kilo feels a bit steep.", example_tr: "Kilo başı 50 dolar biraz pahalı geliyor." },
    { id: "ex.44.22.v12", type: "vocab_tile", difficulty: 5, cefr_band: "C1", word_or_phrase: "excess baggage fee waiver", tr_translation: "Aşırı bagaj ücret muafiyeti", example: "Could I apply for an excess baggage fee waiver?", example_tr: "Aşırı bagaj ücret muafiyetine başvurabilir miyim?" },
    { id: "ex.44.22.v13", type: "vocab_tile", difficulty: 5, cefr_band: "C2", word_or_phrase: "linear dimensions exceeded", tr_translation: "Doğrusal boyut aşıldı (uzunluk+en+derinlik)", example: "The bag's linear dimensions exceeded the limit by 5 cm.", example_tr: "Valizin doğrusal boyutları limiti 5 cm aştı." },
    {
      id: "ex.44.22.rq1",
      type: "recall_quiz",
      items: [
...
export const airportLesson_44_23: BundledLesson = {
  ...
  exercises: [
    ...
    { id: "ex.44.23.v01", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "gold", tr_translation: "Altın (statü)", example: "I am gold.", example_tr: "Ben altınım (gold statüde)." },
    { id: "ex.44.23.v02", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "card", tr_translation: "Kart", example: "Here is my card.", example_tr: "İşte kartım." },
    { id: "ex.44.23.v03", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "number", tr_translation: "Numara", example: "What's my number?", example_tr: "Numaram ne?" },
    { id: "ex.44.23.v04", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "miles", tr_translation: "Miller", example: "I have 50,000 miles.", example_tr: "50.000 milim var." },
    { id: "ex.44.23.v05", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "earn miles", tr_translation: "Mil kazanmak", example: "Will I earn miles on this flight?", example_tr: "Bu uçuştan mil kazanır mıyım?" },
    { id: "ex.44.23.v06", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "free upgrade", tr_translation: "Ücretsiz upgrade", example: "Any chance of a free upgrade?", example_tr: "Ücretsiz upgrade şansı var mı?" },
    { id: "ex.44.23.v07", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "loyalty program", tr_translation: "Sadakat programı", example: "I'm in the loyalty program.", example_tr: "Sadakat programındayım." },
    { id: "ex.44.23.v08", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "elite status", tr_translation: "Elite statü", example: "Could you check if my elite status is current?", example_tr: "Elite statümün güncel olup olmadığını kontrol eder misiniz?" },
    { id: "ex.44.23.v09", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "priority check-in", tr_translation: "Öncelikli check-in", example: "Where is the priority check-in line?", example_tr: "Öncelikli check-in sırası nerede?" },
    { id: "ex.44.23.v10", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "Star Alliance gold", tr_translation: "Star Alliance gold statü", example: "I'm Star Alliance gold — am I entitled to lounge access?", example_tr: "Star Alliance gold'um — lounge erişim hakkım var mı?" },
    { id: "ex.44.23.v11", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "complimentary lounge access", tr_translation: "Ücretsiz lounge erişimi", example: "I get complimentary lounge access as a gold member.", example_tr: "Gold üye olarak ücretsiz lounge erişimim var." },
    { id: "ex.44.23.v12", type: "vocab_tile", difficulty: 5, cefr_band: "C1", word_or_phrase: "tier qualification", tr_translation: "Statü hak edişi", example: "I'm close to tier qualification for next year.", example_tr: "Gelecek yıl için statü hak edişine yakınım." },
    { id: "ex.44.23.v13", type: "vocab_tile", difficulty: 5, cefr_band: "C2", word_or_phrase: "elite-qualifying miles", tr_translation: "Statü hak ettiren miller", example: "How many elite-qualifying miles will this segment earn?", example_tr: "Bu segment kaç statü hak ettiren mil kazandırır?" },
    {
      id: "ex.44.23.rq1",
      type: "recall_quiz",
      items: [
...
export const airportLesson_44_24: BundledLesson = {
  ...
  exercises: [
    ...
    { id: "ex.44.24.v01", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "halal", tr_translation: "Helal", example: "Halal, please.", example_tr: "Helal, lütfen." },
    { id: "ex.44.24.v02", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "no pork", tr_translation: "Domuz yok", example: "No pork, please.", example_tr: "Domuz yok, lütfen." },
    { id: "ex.44.24.v03", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "vegetarian", tr_translation: "Vejetaryen", example: "Vegetarian meal, please.", example_tr: "Vejetaryen yemek, lütfen." },
    { id: "ex.44.24.v04", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "I forgot to request", tr_translation: "İstemeyi unuttum", example: "I forgot to request a special meal.", example_tr: "Özel yemek istemeyi unuttum." },
    { id: "ex.44.24.v05", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "can you add", tr_translation: "Ekler misiniz?", example: "Can you add a halal meal to my booking?", example_tr: "Rezervasyonuma helal yemek ekler misiniz?" },
    { id: "ex.44.24.v06", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "still possible", tr_translation: "Hâlâ mümkün mü?", example: "Is it still possible to add a meal?", example_tr: "Yemek eklemek hâlâ mümkün mü?" },
    { id: "ex.44.24.v07", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "last-minute request", tr_translation: "Son dakika talebi", example: "Sorry for the last-minute request.", example_tr: "Son dakika talebim için özür dilerim." },
    { id: "ex.44.24.v08", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "meal code", tr_translation: "Yemek kodu (MOML, VGML)", example: "The meal code for halal is MOML.", example_tr: "Helal yemek kodu MOML." },
    { id: "ex.44.24.v09", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "dietary requirement", tr_translation: "Diyet gereksinimi", example: "I have a dietary requirement — could you note it?", example_tr: "Diyet gereksinimim var — not eder misiniz?" },
    { id: "ex.44.24.v10", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "would you mind adding", tr_translation: "Eklemenin sakıncası olur mu?", example: "Would you mind adding a halal meal to my booking?", example_tr: "Rezervasyonuma helal yemek eklemenin sakıncası olur mu?" },
    { id: "ex.44.24.v11", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "preorder cutoff", tr_translation: "Ön sipariş son tarihi", example: "Is the preorder cutoff already passed?", example_tr: "Ön sipariş son tarihi geçti mi?" },
    { id: "ex.44.24.v12", type: "vocab_tile", difficulty: 5, cefr_band: "C1", word_or_phrase: "catering galley", tr_translation: "İkram mutfağı (uçak)", example: "It depends on what the catering galley loaded.", example_tr: "İkram mutfağının ne yüklediğine bağlı." },
    { id: "ex.44.24.v13", type: "vocab_tile", difficulty: 5, cefr_band: "C2", word_or_phrase: "non-negotiable dietary need", tr_translation: "Pazarlığa açık olmayan diyet ihtiyacı", example: "It's a non-negotiable dietary need due to allergy.", example_tr: "Alerji nedeniyle pazarlığa açık olmayan bir diyet ihtiyacı." },
    {
      id: "ex.44.24.rq1",
      type: "recall_quiz",
      items: [
...
export const airportLesson_44_25: BundledLesson = {
  ...
  exercises: [
    ...
    { id: "ex.44.25.v01", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "cat", tr_translation: "Kedi", example: "I have a cat.", example_tr: "Bir kedim var." },
    { id: "ex.44.25.v02", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "dog", tr_translation: "Köpek", example: "My dog is with me.", example_tr: "Köpeğim yanımda." },
    { id: "ex.44.25.v03", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "small", tr_translation: "Küçük", example: "She is small.", example_tr: "O küçük." },
    { id: "ex.44.25.v04", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "in the cabin", tr_translation: "Kabinde", example: "Can she travel in the cabin?", example_tr: "Kabinde seyahat edebilir mi?" },
    { id: "ex.44.25.v05", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "under the seat", tr_translation: "Koltuk altında", example: "The carrier goes under the seat.", example_tr: "Taşıyıcı koltuk altına gider." },
    { id: "ex.44.25.v06", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "in cargo hold", tr_translation: "Kargo bölümünde", example: "Larger pets go in cargo hold.", example_tr: "Daha büyük evcil hayvanlar kargo bölümüne gider." },
    { id: "ex.44.25.v07", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "rabies vaccination", tr_translation: "Kuduz aşısı", example: "Her rabies vaccination is up to date.", example_tr: "Kuduz aşısı günceldir." },
    { id: "ex.44.25.v08", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "microchipped", tr_translation: "Çipli", example: "She's microchipped — here's the number.", example_tr: "Çipli — işte numara." },
    { id: "ex.44.25.v09", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "service animal", tr_translation: "Yardımcı hayvan", example: "She's a service animal.", example_tr: "O yardımcı hayvan." },
    { id: "ex.44.25.v10", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "EU pet passport", tr_translation: "AB evcil hayvan pasaportu", example: "Here's the EU pet passport.", example_tr: "İşte AB evcil hayvan pasaportu." },
    { id: "ex.44.25.v11", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "fit to fly", tr_translation: "Uçmaya uygun", example: "The vet says she's fit to fly.", example_tr: "Veteriner uçmaya uygun olduğunu söyledi." },
    { id: "ex.44.25.v12", type: "vocab_tile", difficulty: 5, cefr_band: "C1", word_or_phrase: "quarantine requirements", tr_translation: "Karantina gereksinimleri", example: "What are the quarantine requirements at destination?", example_tr: "Varış noktasında karantina gereksinimleri ne?" },
    { id: "ex.44.25.v13", type: "vocab_tile", difficulty: 5, cefr_band: "C2", word_or_phrase: "IATA Live Animals Regulations", tr_translation: "IATA canlı hayvan yönetmeliği", example: "The carrier meets IATA Live Animals Regulations.", example_tr: "Taşıyıcı IATA canlı hayvan yönetmeliğine uygun." },
    {
      id: "ex.44.25.rq1",
      type: "recall_quiz",
      items: [
...
export const airportLesson_44_26: BundledLesson = {
  ...
  exercises: [
    ...
    { id: "ex.44.26.v01", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "gift", tr_translation: "Hediye", example: "Just a gift.", example_tr: "Sadece bir hediye." },
    { id: "ex.44.26.v02", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "big bag", tr_translation: "Büyük çanta", example: "I have a big bag.", example_tr: "Büyük bir çantam var." },
    { id: "ex.44.26.v03", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "many", tr_translation: "Çok", example: "Many gifts inside.", example_tr: "İçinde çok hediye var." },
    { id: "ex.44.26.v04", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "my host family", tr_translation: "Konak ailem", example: "Gifts for my host family.", example_tr: "Konak ailem için hediyeler." },
    { id: "ex.44.26.v05", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "more than the limit", tr_translation: "Limitten fazla", example: "It's more than the limit, sorry.", example_tr: "Limitten fazla, özür dilerim." },
    { id: "ex.44.26.v06", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "can I pay", tr_translation: "Ödeyebilir miyim?", example: "Can I pay for the extra weight?", example_tr: "Fazla kilo için ödeyebilir miyim?" },
    { id: "ex.44.26.v07", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "student rate", tr_translation: "Öğrenci tarifesi", example: "Is there a student rate for excess baggage?", example_tr: "Aşırı bagaj için öğrenci tarifesi var mı?" },
    { id: "ex.44.26.v08", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "student bag allowance", tr_translation: "Öğrenci bagaj hakkı", example: "Some airlines offer extra student bag allowance.", example_tr: "Bazı havayolları ekstra öğrenci bagaj hakkı sunar." },
    { id: "ex.44.26.v09", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "non-commercial gifts", tr_translation: "Ticari olmayan hediyeler", example: "These are non-commercial gifts only.", example_tr: "Bunlar sadece ticari olmayan hediyeler." },
    { id: "ex.44.26.v10", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "I'd appreciate a waiver", tr_translation: "Muafiyet için minnettar olurum", example: "I'd appreciate a waiver — student first-time abroad.", example_tr: "Muafiyet için minnettar olurum — yurt dışına ilk giden öğrenciyim." },
    { id: "ex.44.26.v11", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "is there any way around it", tr_translation: "Bunu aşmanın bir yolu var mı?", example: "Is there any way around the extra fee?", example_tr: "Ekstra ücreti aşmanın bir yolu var mı?" },
    { id: "ex.44.26.v12", type: "vocab_tile", difficulty: 5, cefr_band: "C1", word_or_phrase: "courtesy waiver", tr_translation: "Hatır muafiyeti", example: "Sometimes agents grant a courtesy waiver for students.", example_tr: "Bazen görevliler öğrenciler için hatır muafiyeti verir." },
    { id: "ex.44.26.v13", type: "vocab_tile", difficulty: 5, cefr_band: "C2", word_or_phrase: "discretionary fee waiver", tr_translation: "İhtiyari ücret muafiyeti", example: "Could you apply a discretionary fee waiver this once?", example_tr: "Bu seferlik ihtiyari ücret muafiyeti uygulayabilir misiniz?" },
    {
      id: "ex.44.26.rq1",
      type: "recall_quiz",
      items: [
...
export const airportLesson_44_27: BundledLesson = {
  ...
  exercises: [
    ...
    { id: "ex.44.27.v01", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "where", tr_translation: "Nerede", example: "Where is gate D12?", example_tr: "D12 gate'i nerede?" },
    { id: "ex.44.27.v02", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "next", tr_translation: "Sonraki", example: "Next flight to Istanbul.", example_tr: "İstanbul'a sonraki uçuş." },
    { id: "ex.44.27.v03", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "time", tr_translation: "Zaman / vakit", example: "I don't have time.", example_tr: "Vaktim yok." },
    { id: "ex.44.27.v04", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "terminal change", tr_translation: "Terminal değişikliği", example: "There's a terminal change for my connection.", example_tr: "Aktarmam için terminal değişikliği var." },
    { id: "ex.44.27.v05", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "how do I get there", tr_translation: "Oraya nasıl giderim?", example: "How do I get there in 60 minutes?", example_tr: "60 dakikada oraya nasıl giderim?" },
    { id: "ex.44.27.v06", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "I have a hurry", tr_translation: "Acelem var", example: "I'm in a hurry.", example_tr: "Acelem var." },
    { id: "ex.44.27.v07", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "tight connection", tr_translation: "Sıkışık aktarma", example: "I have a tight connection — 50 minutes.", example_tr: "Sıkışık bir aktarmam var — 50 dakika." },
    { id: "ex.44.27.v08", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "inter-terminal train", tr_translation: "Terminaller arası tren", example: "The inter-terminal train runs every 4 minutes.", example_tr: "Terminaller arası tren her 4 dakikada bir gelir." },
    { id: "ex.44.27.v09", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "boarding closes at", tr_translation: "Biniş ...da kapanır", example: "Boarding closes at 14:10.", example_tr: "Biniş 14:10'da kapanır." },
    { id: "ex.44.27.v10", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "expedite my connection", tr_translation: "Aktarmamı hızlandır", example: "Could you expedite my connection somehow?", example_tr: "Aktarmamı bir şekilde hızlandırabilir misiniz?" },
    { id: "ex.44.27.v11", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "fast-track lane", tr_translation: "Hızlı geçiş şeridi", example: "Where is the fast-track lane?", example_tr: "Hızlı geçiş şeridi nerede?" },
    { id: "ex.44.27.v12", type: "vocab_tile", difficulty: 5, cefr_band: "C1", word_or_phrase: "intra-terminal transfer", tr_translation: "Terminal içi aktarma", example: "It's just an intra-terminal transfer.", example_tr: "Sadece terminal içi aktarma." },
    { id: "ex.44.27.v13", type: "vocab_tile", difficulty: 5, cefr_band: "C2", word_or_phrase: "minimum connecting time", tr_translation: "Minimum aktarma süresi", example: "I'm below the minimum connecting time.", example_tr: "Minimum aktarma süresinin altındayım." },
    {
      id: "ex.44.27.rq1",
      type: "recall_quiz",
      items: [
...
export const airportLesson_44_28: BundledLesson = {
  ...
  exercises: [
    ...
    { id: "ex.44.28.v01", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "drink", tr_translation: "İçecek", example: "A free drink.", example_tr: "Bir ücretsiz içecek." },
    { id: "ex.44.28.v02", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "food", tr_translation: "Yemek", example: "Is the food free?", example_tr: "Yemek ücretsiz mi?" },
    { id: "ex.44.28.v03", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "yes please", tr_translation: "Evet, lütfen", example: "Yes please, I'd like access.", example_tr: "Evet lütfen, erişim isterim." },
    { id: "ex.44.28.v04", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "day pass", tr_translation: "Günlük geçiş", example: "How much is the day pass?", example_tr: "Günlük geçiş ne kadar?" },
    { id: "ex.44.28.v05", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "lounge entry", tr_translation: "Lounge girişi", example: "Where is lounge entry?", example_tr: "Lounge girişi nerede?" },
    { id: "ex.44.28.v06", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "shower", tr_translation: "Duş", example: "Can I take a shower here?", example_tr: "Burada duş alabilir miyim?" },
    { id: "ex.44.28.v07", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "walk-in fee", tr_translation: "Ön rezervasyonsuz giriş ücreti", example: "What's the walk-in fee?", example_tr: "Ön rezervasyonsuz giriş ücreti ne?" },
    { id: "ex.44.28.v08", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "Priority Pass", tr_translation: "Priority Pass (lounge erişim kartı)", example: "I have Priority Pass through my credit card.", example_tr: "Kredi kartım üzerinden Priority Pass'im var." },
    { id: "ex.44.28.v09", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "complimentary", tr_translation: "Ücretsiz", example: "Complimentary drinks inside.", example_tr: "İçeride ücretsiz içecekler." },
    { id: "ex.44.28.v10", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "credit card lounge benefit", tr_translation: "Kredi kartı lounge avantajı", example: "Does this card include a lounge benefit?", example_tr: "Bu kartta lounge avantajı var mı?" },
    { id: "ex.44.28.v11", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "guest is included", tr_translation: "Misafir dahil", example: "Is one guest included?", example_tr: "Bir misafir dahil mi?" },
    { id: "ex.44.28.v12", type: "vocab_tile", difficulty: 5, cefr_band: "C1", word_or_phrase: "contract lounge", tr_translation: "Anlaşmalı lounge", example: "It's a contract lounge under Star Alliance.", example_tr: "Star Alliance kapsamında anlaşmalı lounge." },
    { id: "ex.44.28.v13", type: "vocab_tile", difficulty: 5, cefr_band: "C2", word_or_phrase: "blackout dates apply", tr_translation: "Kullanılamayan tarihler vardır", example: "Note that blackout dates may apply on holidays.", example_tr: "Tatil günlerinde kullanılamayan tarihler olabilir." },
    {
      id: "ex.44.28.rq1",
      type: "recall_quiz",
      items: [
...
export const airportLesson_44_29: BundledLesson = {
  ...
  exercises: [
    ...
    { id: "ex.44.29.v01", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "line", tr_translation: "Sıra / kuyruk", example: "Where is the line?", example_tr: "Sıra nerede?" },
    { id: "ex.44.29.v02", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "fast", tr_translation: "Hızlı", example: "Is there a fast line?", example_tr: "Hızlı sıra var mı?" },
    { id: "ex.44.29.v03", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "card", tr_translation: "Kart", example: "Show your card.", example_tr: "Kartını göster." },
    { id: "ex.44.29.v04", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "priority line", tr_translation: "Öncelikli sıra", example: "Can I use the priority line?", example_tr: "Öncelikli sırayı kullanabilir miyim?" },
    { id: "ex.44.29.v05", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "no shoes off", tr_translation: "Ayakkabı çıkarma yok", example: "No shoes off in this lane.", example_tr: "Bu şeritte ayakkabı çıkarma yok." },
    { id: "ex.44.29.v06", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "show your ID", tr_translation: "Kimliğini göster", example: "Show your ID at the kiosk.", example_tr: "Kiosk'ta kimliğini göster." },
    { id: "ex.44.29.v07", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "known traveler number", tr_translation: "Bilinen yolcu numarası (KTN)", example: "Add your known traveler number to the booking.", example_tr: "Rezervasyona bilinen yolcu numaranı ekle." },
    { id: "ex.44.29.v08", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "I'm pre-cleared", tr_translation: "Ön onaylıyım", example: "I'm pre-cleared — straight through.", example_tr: "Ön onaylıyım — direkt geçerim." },
    { id: "ex.44.29.v09", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "leave electronics in", tr_translation: "Elektronikleri içeride bırak", example: "Leave electronics in the bag.", example_tr: "Elektronikleri çantanın içinde bırak." },
    { id: "ex.44.29.v10", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "could I be redirected", tr_translation: "Yönlendirilebilir miyim?", example: "Could I be redirected to the Pre-check lane?", example_tr: "Pre-check şeridine yönlendirilebilir miyim?" },
    { id: "ex.44.29.v11", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "expedited screening", tr_translation: "Hızlandırılmış güvenlik kontrolü", example: "I'm enrolled in expedited screening.", example_tr: "Hızlandırılmış güvenlik kontrolüne kayıtlıyım." },
    { id: "ex.44.29.v12", type: "vocab_tile", difficulty: 5, cefr_band: "C1", word_or_phrase: "Global Entry", tr_translation: "Global Entry programı", example: "Global Entry includes TSA Pre-check.", example_tr: "Global Entry, TSA Pre-check'i kapsar." },
    { id: "ex.44.29.v13", type: "vocab_tile", difficulty: 5, cefr_band: "C2", word_or_phrase: "trusted traveler program", tr_translation: "Güvenilir yolcu programı", example: "I'm enrolled in a trusted traveler program.", example_tr: "Bir güvenilir yolcu programına kayıtlıyım." },
    {
      id: "ex.44.29.rq1",
      type: "recall_quiz",
      items: [
...
export const airportLesson_44_30: BundledLesson = {
  ...
  exercises: [
    ...
    { id: "ex.44.30.v01", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "seat", tr_translation: "Koltuk", example: "My seat.", example_tr: "Koltuğum." },
    { id: "ex.44.30.v02", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "together", tr_translation: "Birlikte", example: "We sit together.", example_tr: "Birlikte oturuyoruz." },
    { id: "ex.44.30.v03", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "wife", tr_translation: "Eş (kadın)", example: "My wife is here.", example_tr: "Eşim burada." },
    { id: "ex.44.30.v04", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "next to each other", tr_translation: "Yan yana", example: "Could we sit next to each other?", example_tr: "Yan yana oturabilir miyiz?" },
    { id: "ex.44.30.v05", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "seat assignment", tr_translation: "Koltuk ataması", example: "Could you change our seat assignment?", example_tr: "Koltuk atamamızı değiştirir misiniz?" },
    { id: "ex.44.30.v06", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "same row", tr_translation: "Aynı sıra", example: "Could we be in the same row?", example_tr: "Aynı sırada olabilir miyiz?" },
    { id: "ex.44.30.v07", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "could we be reseated", tr_translation: "Yeniden yerleştirilebilir miyiz?", example: "Could we be reseated together?", example_tr: "Birlikte yeniden yerleştirilebilir miyiz?" },
    { id: "ex.44.30.v08", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "split apart", tr_translation: "Ayrılmak", example: "We were split apart on the booking.", example_tr: "Rezervasyonda ayrılmışız." },
    { id: "ex.44.30.v09", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "would you mind swapping", tr_translation: "Değişmenin sakıncası var mı?", example: "Would you mind swapping seats with me?", example_tr: "Benimle koltuk değişmenin sakıncası var mı?" },
    { id: "ex.44.30.v10", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "any chance of seating us together", tr_translation: "Bizi birlikte oturtma şansı var mı?", example: "Any chance of seating us together?", example_tr: "Bizi birlikte oturtma şansı var mı?" },
    { id: "ex.44.30.v11", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "we're traveling together", tr_translation: "Birlikte seyahat ediyoruz", example: "We're traveling together — could you check seating?", example_tr: "Birlikte seyahat ediyoruz — koltuk düzenini kontrol eder misiniz?" },
    { id: "ex.44.30.v12", type: "vocab_tile", difficulty: 5, cefr_band: "C1", word_or_phrase: "seat block release", tr_translation: "Koltuk bloğu serbest bırakma", example: "Once the seat block is released, can you reseat us?", example_tr: "Koltuk bloğu serbest kalınca bizi yeniden yerleştirir misiniz?" },
    { id: "ex.44.30.v13", type: "vocab_tile", difficulty: 5, cefr_band: "C2", word_or_phrase: "involuntarily separated", tr_translation: "İstem dışı ayrılmış", example: "We were involuntarily separated by the system.", example_tr: "Sistem tarafından istem dışı ayrılmışız." },
    {
      id: "ex.44.30.rq1",
      type: "recall_quiz",
      items: [
...
export const airportLesson_44_31: BundledLesson = {
  ...
  exercises: [
    ...
    { id: "ex.44.31.v01", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "sit", tr_translation: "Otur", example: "Where do I sit?", example_tr: "Nereye oturayım?" },
    { id: "ex.44.31.v02", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "change", tr_translation: "Değiştir", example: "Can I change?", example_tr: "Değişebilir miyim?" },
    { id: "ex.44.31.v03", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "please", tr_translation: "Lütfen", example: "Please swap with me.", example_tr: "Lütfen benimle değiş." },
    { id: "ex.44.31.v04", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "would you mind", tr_translation: "Sakıncası var mı?", example: "Would you mind swapping seats?", example_tr: "Koltuk değişmenin sakıncası var mı?" },
    { id: "ex.44.31.v05", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "if it's not a problem", tr_translation: "Sorun değilse", example: "If it's not a problem for you.", example_tr: "Senin için sorun değilse." },
    { id: "ex.44.31.v06", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "same row", tr_translation: "Aynı sıra", example: "We're in the same row.", example_tr: "Aynı sıradayız." },
    { id: "ex.44.31.v07", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "with my partner", tr_translation: "Eşimle / partnerle", example: "I'd like to sit with my partner.", example_tr: "Eşimle oturmak istiyorum." },
    { id: "ex.44.31.v08", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "any chance you'd swap", tr_translation: "Değişme şansın var mı?", example: "Any chance you'd swap with me?", example_tr: "Benimle değişme şansın var mı?" },
    { id: "ex.44.31.v09", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "happy to thank you", tr_translation: "Teşekkür etmek için minnettarım", example: "Happy to thank you with a drink!", example_tr: "Bir içecekle teşekkür etmekten mutluyum!" },
    { id: "ex.44.31.v10", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "would you be willing to swap", tr_translation: "Değişmeye razı mısın?", example: "Would you be willing to swap to a window seat?", example_tr: "Cam kenarı koltukla değişmeye razı mısın?" },
    { id: "ex.44.31.v11", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "we got split up", tr_translation: "Ayrıldık (rezervasyonda)", example: "We got split up on the booking — could we swap?", example_tr: "Rezervasyonda ayrıldık — değişebilir miyiz?" },
    { id: "ex.44.31.v12", type: "vocab_tile", difficulty: 5, cefr_band: "C1", word_or_phrase: "comparable seat swap", tr_translation: "Eşdeğer koltuk değişimi", example: "It's a comparable seat swap — same row, just one across.", example_tr: "Eşdeğer koltuk değişimi — aynı sıra, sadece bir geçişte." },
    { id: "ex.44.31.v13", type: "vocab_tile", difficulty: 5, cefr_band: "C2", word_or_phrase: "involuntary downgrade", tr_translation: "İstem dışı düşürme (koltuk)", example: "I'd rather not accept an involuntary downgrade just to swap.", example_tr: "Sadece değişmek için istem dışı düşürmeyi kabul etmem." },
    {
      id: "ex.44.31.rq1",
      type: "recall_quiz",
      items: [
...
export const airportLesson_44_32: BundledLesson = {
  ...
  exercises: [
    ...
    { id: "ex.44.32.v01", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "row", tr_translation: "Sıra", example: "My row.", example_tr: "Sıram." },
    { id: "ex.44.32.v02", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "empty", tr_translation: "Boş", example: "Empty seat.", example_tr: "Boş koltuk." },
    { id: "ex.44.32.v03", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "move", tr_translation: "Geç / hareket et", example: "Can I move?", example_tr: "Geçebilir miyim?" },
    { id: "ex.44.32.v04", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "could I move", tr_translation: "Geçebilir miyim?", example: "Could I move to that row?", example_tr: "O sıraya geçebilir miyim?" },
    { id: "ex.44.32.v05", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "after takeoff", tr_translation: "Kalkıştan sonra", example: "After takeoff, please.", example_tr: "Kalkıştan sonra, lütfen." },
    { id: "ex.44.32.v06", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "no one is there", tr_translation: "Kimse orada değil", example: "No one is there in row 32.", example_tr: "32. sırada kimse yok." },
    { id: "ex.44.32.v07", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "stretch out", tr_translation: "Uzanmak (yatay)", example: "I'd like to stretch out a bit.", example_tr: "Biraz uzanmak istiyorum." },
    { id: "ex.44.32.v08", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "if it's allowed", tr_translation: "İzin varsa", example: "If it's allowed, I'd like to move.", example_tr: "İzin varsa geçmek istiyorum." },
    { id: "ex.44.32.v09", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "fasten the seatbelt sign", tr_translation: "Emniyet kemeri işareti yan", example: "Once the seatbelt sign is off.", example_tr: "Emniyet kemeri işareti söndüğünde." },
    { id: "ex.44.32.v10", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "I won't be in the way", tr_translation: "Engel olmayacağım", example: "I won't be in the way of service.", example_tr: "Servis için engel olmayacağım." },
    { id: "ex.44.32.v11", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "even out the cabin", tr_translation: "Kabini dengelemek", example: "We sometimes spread people out to even out the cabin.", example_tr: "Bazen yolcuları kabini dengelemek için dağıtırız." },
    { id: "ex.44.32.v12", type: "vocab_tile", difficulty: 5, cefr_band: "C1", word_or_phrase: "load distribution", tr_translation: "Yük dağılımı", example: "Seat moves depend on load distribution.", example_tr: "Koltuk değişimleri yük dağılımına bağlı." },
    { id: "ex.44.32.v13", type: "vocab_tile", difficulty: 5, cefr_band: "C2", word_or_phrase: "cabin weight and balance", tr_translation: "Kabin ağırlık ve denge", example: "Cabin weight and balance can limit seat changes.", example_tr: "Kabin ağırlık ve denge koltuk değişimini sınırlayabilir." },
    {
      id: "ex.44.32.rq1",
      type: "recall_quiz",
      items: [
...
export const airportLesson_44_33: BundledLesson = {
  ...
  exercises: [
    ...
    { id: "ex.44.33.v01", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "baby", tr_translation: "Bebek", example: "A baby is crying.", example_tr: "Bir bebek ağlıyor." },
    { id: "ex.44.33.v02", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "sorry", tr_translation: "Üzgünüm", example: "Sorry about the noise.", example_tr: "Gürültü için üzgünüm." },
    { id: "ex.44.33.v03", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "okay", tr_translation: "Tamam", example: "It's okay.", example_tr: "Tamam." },
    { id: "ex.44.33.v04", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "don't worry", tr_translation: "Endişelenme", example: "Don't worry about it.", example_tr: "Endişelenme." },
    { id: "ex.44.33.v05", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "it's totally fine", tr_translation: "Tamamen tamam", example: "It's totally fine, really.", example_tr: "Tamamen tamam, gerçekten." },
    { id: "ex.44.33.v06", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "babies cry", tr_translation: "Bebekler ağlar", example: "Babies cry — it happens.", example_tr: "Bebekler ağlar — olur." },
    { id: "ex.44.33.v07", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "I have earplugs", tr_translation: "Kulak tıkacım var", example: "I have earplugs, no worries.", example_tr: "Kulak tıkacım var, sorun değil." },
    { id: "ex.44.33.v08", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "you're doing great", tr_translation: "Çok iyi gidiyorsun", example: "You're doing great, honestly.", example_tr: "Çok iyi gidiyorsun, gerçekten." },
    { id: "ex.44.33.v09", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "want me to help", tr_translation: "Yardım edeyim mi?", example: "Want me to help hold something?", example_tr: "Bir şey tutmana yardım edeyim mi?" },
    { id: "ex.44.33.v10", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "completely understandable", tr_translation: "Tamamen anlaşılır", example: "Completely understandable — long flight.", example_tr: "Tamamen anlaşılır — uzun uçuş." },
    { id: "ex.44.33.v11", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "happy to swap if it helps", tr_translation: "Yardım olursa değişmekten mutlu olurum", example: "Happy to swap seats if it helps.", example_tr: "Yardım olursa koltuk değişmekten mutlu olurum." },
    { id: "ex.44.33.v12", type: "vocab_tile", difficulty: 5, cefr_band: "C1", word_or_phrase: "no need to apologize", tr_translation: "Özür dilemene gerek yok", example: "No need to apologize at all.", example_tr: "Özür dilemene hiç gerek yok." },
    { id: "ex.44.33.v13", type: "vocab_tile", difficulty: 5, cefr_band: "C2", word_or_phrase: "considerate of you to ask", tr_translation: "Sormak hoş bir düşünce", example: "It's very considerate of you to ask.", example_tr: "Sormanız çok hoş bir düşünce." },
    {
      id: "ex.44.33.rq1",
      type: "recall_quiz",
      items: [
...
export const airportLesson_44_34: BundledLesson = {
  ...
  exercises: [
    ...
    { id: "ex.44.34.v01", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "sick", tr_translation: "Hasta / midesi bulanmış", example: "I feel sick.", example_tr: "Hasta hissediyorum." },
    { id: "ex.44.34.v02", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "water", tr_translation: "Su", example: "Water, please.", example_tr: "Su, lütfen." },
    { id: "ex.44.34.v03", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "help", tr_translation: "Yardım", example: "Help, please.", example_tr: "Yardım, lütfen." },
    { id: "ex.44.34.v04", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "I feel sick", tr_translation: "Hasta hissediyorum", example: "I feel sick, sorry.", example_tr: "Hasta hissediyorum, üzgünüm." },
    { id: "ex.44.34.v05", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "dizzy", tr_translation: "Baş dönmesi", example: "I feel a bit dizzy.", example_tr: "Biraz baş dönmesi var." },
    { id: "ex.44.34.v06", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "could you bring", tr_translation: "Getirebilir misiniz?", example: "Could you bring a sick bag?", example_tr: "Bir kusma torbası getirir misiniz?" },
    { id: "ex.44.34.v07", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "feeling nauseous", tr_translation: "Mide bulantısı hissediyorum", example: "I'm feeling nauseous.", example_tr: "Mide bulantısı hissediyorum." },
    { id: "ex.44.34.v08", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "could I have a ginger ale", tr_translation: "Ginger ale alabilir miyim?", example: "Could I have a ginger ale, please?", example_tr: "Bir ginger ale alabilir miyim, lütfen?" },
    { id: "ex.44.34.v09", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "motion sickness", tr_translation: "Hareket hastalığı", example: "I get motion sickness easily.", example_tr: "Hareket hastalığım kolay tutar." },
    { id: "ex.44.34.v10", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "queasy stomach", tr_translation: "Bulantılı mide", example: "I have a queasy stomach from the turbulence.", example_tr: "Türbülanstan bulantılı bir midem var." },
    { id: "ex.44.34.v11", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "I'd appreciate cold water", tr_translation: "Soğuk su için minnettar olurum", example: "I'd appreciate some cold water.", example_tr: "Biraz soğuk su için minnettar olurum." },
    { id: "ex.44.34.v12", type: "vocab_tile", difficulty: 5, cefr_band: "C1", word_or_phrase: "anti-emetic", tr_translation: "Bulantı önleyici (ilaç)", example: "Do you have an anti-emetic in the kit?", example_tr: "Setinizde bulantı önleyici var mı?" },
    { id: "ex.44.34.v13", type: "vocab_tile", difficulty: 5, cefr_band: "C2", word_or_phrase: "pre-syncope", tr_translation: "Bayılma öncesi", example: "I'm experiencing pre-syncope symptoms.", example_tr: "Bayılma öncesi belirtileri yaşıyorum." },
    {
      id: "ex.44.34.rq1",
      type: "recall_quiz",
      items: [
...
export const airportLesson_44_35: BundledLesson = {
  ...
  exercises: [
    ...
    { id: "ex.44.35.v01", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "cold", tr_translation: "Soğuk / üşümüş", example: "I'm cold.", example_tr: "Üşüyorum." },
    { id: "ex.44.35.v02", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "warm", tr_translation: "Sıcak", example: "Keep me warm.", example_tr: "Beni sıcak tut." },
    { id: "ex.44.35.v03", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "pillow", tr_translation: "Yastık", example: "A pillow, please.", example_tr: "Bir yastık, lütfen." },
    { id: "ex.44.35.v04", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "extra pillow", tr_translation: "Ek yastık", example: "Could I get an extra pillow?", example_tr: "Bir ek yastık alabilir miyim?" },
    { id: "ex.44.35.v05", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "I'm freezing", tr_translation: "Donuyorum", example: "I'm freezing — could you turn the air down?", example_tr: "Donuyorum — havayı kısar mısınız?" },
    { id: "ex.44.35.v06", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "AC is too cold", tr_translation: "Klima çok soğuk", example: "The AC is too cold at my seat.", example_tr: "Koltuğumda klima çok soğuk." },
    { id: "ex.44.35.v07", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "try to sleep", tr_translation: "Uyumaya çalışmak", example: "I'll try to sleep for a few hours.", example_tr: "Birkaç saat uyumaya çalışacağım." },
    { id: "ex.44.35.v08", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "sleep mask", tr_translation: "Uyku maskesi", example: "Do you have a spare sleep mask?", example_tr: "Yedek uyku maskesi var mı?" },
    { id: "ex.44.35.v09", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "wake me for meals", tr_translation: "Yemekler için uyandır", example: "Please don't wake me for meals.", example_tr: "Lütfen yemekler için beni uyandırmayın." },
    { id: "ex.44.35.v10", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "would you mind adjusting the temperature", tr_translation: "Sıcaklığı ayarlamanın sakıncası var mı?", example: "Would you mind adjusting the cabin temperature?", example_tr: "Kabin sıcaklığını ayarlamanın sakıncası var mı?" },
    { id: "ex.44.35.v11", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "noise-cancelling headphones", tr_translation: "Gürültü engelleyici kulaklık", example: "I forgot my noise-cancelling headphones.", example_tr: "Gürültü engelleyici kulaklığımı unutmuşum." },
    { id: "ex.44.35.v12", type: "vocab_tile", difficulty: 5, cefr_band: "C1", word_or_phrase: "amenity kit", tr_translation: "Konfor seti", example: "Could I get another amenity kit?", example_tr: "Başka bir konfor seti alabilir miyim?" },
    { id: "ex.44.35.v13", type: "vocab_tile", difficulty: 5, cefr_band: "C2", word_or_phrase: "cabin pressure equalization", tr_translation: "Kabin basıncı dengelemesi", example: "My ears struggle with cabin pressure equalization.", example_tr: "Kulaklarım kabin basıncı dengelemesinde zorlanıyor." },
    {
      id: "ex.44.35.rq1",
      type: "recall_quiz",
      items: [
...
export const airportLesson_44_36: BundledLesson = {
  ...
  exercises: [
    ...
    { id: "ex.44.36.v01", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "screen", tr_translation: "Ekran", example: "My screen is broken.", example_tr: "Ekranım bozuk." },
    { id: "ex.44.36.v02", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "headphones", tr_translation: "Kulaklık", example: "I need headphones.", example_tr: "Kulaklığa ihtiyacım var." },
    { id: "ex.44.36.v03", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "broken", tr_translation: "Bozuk", example: "It's broken.", example_tr: "Bozuk." },
    { id: "ex.44.36.v04", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "doesn't work", tr_translation: "Çalışmıyor", example: "The screen doesn't work.", example_tr: "Ekran çalışmıyor." },
    { id: "ex.44.36.v05", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "no sound", tr_translation: "Ses yok", example: "There's no sound.", example_tr: "Hiç ses yok." },
    { id: "ex.44.36.v06", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "can you fix it", tr_translation: "Düzeltir misin?", example: "Can you fix it, please?", example_tr: "Düzeltir misiniz, lütfen?" },
    { id: "ex.44.36.v07", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "in-flight entertainment", tr_translation: "Uçak içi eğlence", example: "The in-flight entertainment is down.", example_tr: "Uçak içi eğlence çalışmıyor." },
    { id: "ex.44.36.v08", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "could you reset my screen", tr_translation: "Ekranımı sıfırlar mısın?", example: "Could you reset my screen?", example_tr: "Ekranımı sıfırlar mısınız?" },
    { id: "ex.44.36.v09", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "try the other jack", tr_translation: "Diğer girişi dene", example: "Try the other audio jack.", example_tr: "Diğer ses girişini dene." },
    { id: "ex.44.36.v10", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "I'd appreciate a reset", tr_translation: "Sıfırlama için minnettar olurum", example: "I'd appreciate a screen reset.", example_tr: "Ekran sıfırlaması için minnettar olurum." },
    { id: "ex.44.36.v11", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "any compensation if it stays broken", tr_translation: "Bozuk kalırsa tazminat var mı?", example: "Any compensation if it stays broken?", example_tr: "Bozuk kalırsa tazminat var mı?" },
    { id: "ex.44.36.v12", type: "vocab_tile", difficulty: 5, cefr_band: "C1", word_or_phrase: "seatback IFE", tr_translation: "Koltuk arkası eğlence sistemi", example: "The seatback IFE is unresponsive.", example_tr: "Koltuk arkası eğlence sistemi yanıt vermiyor." },
    { id: "ex.44.36.v13", type: "vocab_tile", difficulty: 5, cefr_band: "C2", word_or_phrase: "service request acknowledged", tr_translation: "Hizmet talebi kabul edildi", example: "Could you log a service request? Acknowledged.", example_tr: "Bir hizmet talebi açar mısınız? Kabul edildi." },
    {
      id: "ex.44.36.rq1",
      type: "recall_quiz",
      items: [
...
export const airportLesson_44_37: BundledLesson = {
  ...
  exercises: [
    ...
    { id: "ex.44.37.v01", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "fast", tr_translation: "Hızlı", example: "Walk fast.", example_tr: "Hızlı yürü." },
    { id: "ex.44.37.v02", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "run", tr_translation: "Koş", example: "I need to run.", example_tr: "Koşmam lazım." },
    { id: "ex.44.37.v03", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "miss", tr_translation: "Kaçır", example: "I miss my flight.", example_tr: "Uçuşumu kaçırıyorum." },
    { id: "ex.44.37.v04", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "I'm in a hurry", tr_translation: "Acelem var", example: "I'm in a hurry — please help.", example_tr: "Acelem var — lütfen yardım edin." },
    { id: "ex.44.37.v05", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "could you let me through", tr_translation: "Geçmeme izin verir misin?", example: "Could you let me through? Tight connection.", example_tr: "Geçmeme izin verir misin? Sıkışık aktarma." },
    { id: "ex.44.37.v06", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "boarding closes soon", tr_translation: "Biniş yakında kapanır", example: "Boarding closes soon — I need to hurry.", example_tr: "Biniş yakında kapanır — acele etmem lazım." },
    { id: "ex.44.37.v07", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "expedite my path", tr_translation: "Yolumu hızlandır", example: "Could you expedite my path to the gate?", example_tr: "Gate'e olan yolumu hızlandırabilir misin?" },
    { id: "ex.44.37.v08", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "priority disembarkation", tr_translation: "Öncelikli iniş", example: "Could I get priority disembarkation?", example_tr: "Öncelikli iniş alabilir miyim?" },
    { id: "ex.44.37.v09", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "hold the next flight", tr_translation: "Sonraki uçuşu beklet", example: "Could you hold the next flight for me?", example_tr: "Sonraki uçuşu benim için bekletir misiniz?" },
    { id: "ex.44.37.v10", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "I'd appreciate a runner escort", tr_translation: "Eskort için minnettar olurum", example: "I'd appreciate a runner escort if possible.", example_tr: "Mümkünse eskort için minnettar olurum." },
    { id: "ex.44.37.v11", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "in danger of misconnecting", tr_translation: "Aktarmayı kaçırma tehlikesi", example: "I'm in danger of misconnecting in Frankfurt.", example_tr: "Frankfurt'ta aktarmayı kaçırma tehlikem var." },
    { id: "ex.44.37.v12", type: "vocab_tile", difficulty: 5, cefr_band: "C1", word_or_phrase: "irregular operations", tr_translation: "Düzensiz operasyonlar (havayolu)", example: "Irregular operations are affecting my connection.", example_tr: "Düzensiz operasyonlar aktarmamı etkiliyor." },
    { id: "ex.44.37.v13", type: "vocab_tile", difficulty: 5, cefr_band: "C2", word_or_phrase: "rebooking protection", tr_translation: "Yeniden ayırma koruması", example: "Do I have rebooking protection on this fare?", example_tr: "Bu tarifede yeniden ayırma korumam var mı?" },
    {
      id: "ex.44.37.rq1",
      type: "recall_quiz",
      items: [
...
export const airportLesson_44_38: BundledLesson = {
  ...
  exercises: [
    ...
    { id: "ex.44.38.v01", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "name", tr_translation: "İsim", example: "My name.", example_tr: "İsmim." },
    { id: "ex.44.38.v02", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "country", tr_translation: "Ülke", example: "My country is Turkey.", example_tr: "Ülkem Türkiye." },
    { id: "ex.44.38.v03", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "no", tr_translation: "Hayır", example: "No, nothing.", example_tr: "Hayır, hiçbir şey." },
    { id: "ex.44.38.v04", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "address in the US", tr_translation: "ABD'deki adres", example: "Address in the US: hotel name.", example_tr: "ABD'deki adres: otel adı." },
    { id: "ex.44.38.v05", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "any food", tr_translation: "Yiyecek var mı?", example: "Any food in your bag?", example_tr: "Çantanızda yiyecek var mı?" },
    { id: "ex.44.38.v06", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "only personal items", tr_translation: "Sadece kişisel eşya", example: "Only personal items, no commercial goods.", example_tr: "Sadece kişisel eşya, ticari mal yok." },
    { id: "ex.44.38.v07", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "occupation field", tr_translation: "Meslek alanı", example: "What goes in the occupation field?", example_tr: "Meslek alanına ne yazılır?" },
    { id: "ex.44.38.v08", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "items to declare", tr_translation: "Beyan edilecek eşya", example: "I have no items to declare.", example_tr: "Beyan edilecek eşyam yok." },
    { id: "ex.44.38.v09", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "agricultural products", tr_translation: "Tarım ürünleri", example: "I have no agricultural products.", example_tr: "Tarım ürünüm yok." },
    { id: "ex.44.38.v10", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "duly completed", tr_translation: "Düzgün doldurulmuş", example: "Here's the duly completed form.", example_tr: "İşte düzgün doldurulmuş form." },
    { id: "ex.44.38.v11", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "to the best of my knowledge", tr_translation: "Bildiğim kadarıyla", example: "Accurate to the best of my knowledge.", example_tr: "Bildiğim kadarıyla doğru." },
    { id: "ex.44.38.v12", type: "vocab_tile", difficulty: 5, cefr_band: "C1", word_or_phrase: "non-resident alien", tr_translation: "Yerleşik olmayan yabancı", example: "I'm a non-resident alien — tourist visa.", example_tr: "Yerleşik olmayan yabancıyım — turist vizesi." },
    { id: "ex.44.38.v13", type: "vocab_tile", difficulty: 5, cefr_band: "C2", word_or_phrase: "false declaration is an offense", tr_translation: "Yanlış beyan bir suçtur", example: "I understand that false declaration is an offense.", example_tr: "Yanlış beyanın bir suç olduğunu anlıyorum." },
    {
      id: "ex.44.38.rq1",
      type: "recall_quiz",
      items: [
...
export const airportLesson_44_39: BundledLesson = {
  ...
  exercises: [
    ...
    { id: "ex.44.39.v01", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "scared", tr_translation: "Korkmuş", example: "I'm scared.", example_tr: "Korkmuşum." },
    { id: "ex.44.39.v02", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "okay", tr_translation: "Tamam / iyi", example: "Are we okay?", example_tr: "İyiyiz değil mi?" },
    { id: "ex.44.39.v03", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "stop", tr_translation: "Dur", example: "Will it stop?", example_tr: "Duracak mı?" },
    { id: "ex.44.39.v04", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "I'm a nervous flyer", tr_translation: "Korkulu uçucuyum", example: "I'm a nervous flyer — sorry.", example_tr: "Korkulu uçucuyum — özür dilerim." },
    { id: "ex.44.39.v05", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "is this normal", tr_translation: "Bu normal mi?", example: "Is this normal?", example_tr: "Bu normal mi?" },
    { id: "ex.44.39.v06", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "how long until it ends", tr_translation: "Ne kadar sürer?", example: "How long until it ends?", example_tr: "Bitmesine ne kadar var?" },
    { id: "ex.44.39.v07", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "rough air", tr_translation: "Sert hava (yumuşak terim)", example: "Just a bit of rough air — completely normal.", example_tr: "Sadece biraz sert hava — tamamen normal." },
    { id: "ex.44.39.v08", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "fasten your seatbelt", tr_translation: "Emniyet kemerini bağla", example: "Please fasten your seatbelt.", example_tr: "Lütfen emniyet kemerini bağla." },
    { id: "ex.44.39.v09", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "should subside soon", tr_translation: "Yakında geçer", example: "It should subside soon.", example_tr: "Yakında geçecek." },
    { id: "ex.44.39.v10", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "could you reassure me", tr_translation: "Beni rahatlatır mısın?", example: "Could you reassure me a bit?", example_tr: "Beni biraz rahatlatır mısın?" },
    { id: "ex.44.39.v11", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "white-knuckle moment", tr_translation: "Çok gergin an", example: "That was a white-knuckle moment.", example_tr: "Çok gergin bir andı." },
    { id: "ex.44.39.v12", type: "vocab_tile", difficulty: 5, cefr_band: "C1", word_or_phrase: "clear-air turbulence", tr_translation: "Hava netliği türbülansı", example: "That was clear-air turbulence — unpredictable.", example_tr: "O hava netliği türbülansıydı — öngörülemez." },
    { id: "ex.44.39.v13", type: "vocab_tile", difficulty: 5, cefr_band: "C2", word_or_phrase: "aircraft is built to withstand", tr_translation: "Uçak dayanacak şekilde tasarlandı", example: "The aircraft is built to withstand much more.", example_tr: "Uçak çok daha fazlasına dayanacak şekilde tasarlandı." },
    {
      id: "ex.44.39.rq1",
      type: "recall_quiz",
      items: [
...
export const airportLesson_44_40: BundledLesson = {
  ...
  exercises: [
    ...
    { id: "ex.44.40.v01", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "coffee", tr_translation: "Kahve", example: "A coffee, please.", example_tr: "Bir kahve, lütfen." },
    { id: "ex.44.40.v02", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "tea", tr_translation: "Çay", example: "Tea, please.", example_tr: "Çay, lütfen." },
    { id: "ex.44.40.v03", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "no sugar", tr_translation: "Şekersiz", example: "No sugar.", example_tr: "Şekersiz." },
    { id: "ex.44.40.v04", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "could I get", tr_translation: "Alabilir miyim?", example: "Could I get a juice?", example_tr: "Bir meyve suyu alabilir miyim?" },
    { id: "ex.44.40.v05", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "one more", tr_translation: "Bir tane daha", example: "One more water, please.", example_tr: "Bir su daha, lütfen." },
    { id: "ex.44.40.v06", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "before service ends", tr_translation: "Servis bitmeden önce", example: "Before service ends, could I get tea?", example_tr: "Servis bitmeden önce çay alabilir miyim?" },
    { id: "ex.44.40.v07", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "any chance of a snack", tr_translation: "Atıştırmalık şansı var mı?", example: "Any chance of a snack later?", example_tr: "Daha sonra atıştırmalık şansı var mı?" },
    { id: "ex.44.40.v08", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "still serving", tr_translation: "Hâlâ servis ediyor musunuz?", example: "Are you still serving drinks?", example_tr: "Hâlâ içecek servis ediyor musunuz?" },
    { id: "ex.44.40.v09", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "no ice", tr_translation: "Buz yok", example: "No ice, please.", example_tr: "Buz yok, lütfen." },
    { id: "ex.44.40.v10", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "if it's not too much trouble", tr_translation: "Çok zahmet olmazsa", example: "If it's not too much trouble, could I get coffee?", example_tr: "Çok zahmet olmazsa kahve alabilir miyim?" },
    { id: "ex.44.40.v11", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "could I have a refill", tr_translation: "Tekrar doldurabilir misin?", example: "Could I have a refill on the water?", example_tr: "Suyu tekrar doldurabilir misin?" },
    { id: "ex.44.40.v12", type: "vocab_tile", difficulty: 5, cefr_band: "C1", word_or_phrase: "galley closed", tr_translation: "Mutfak kapalı", example: "The galley is closed for landing.", example_tr: "Mutfak iniş için kapatıldı." },
    { id: "ex.44.40.v13", type: "vocab_tile", difficulty: 5, cefr_band: "C2", word_or_phrase: "complimentary bar service", tr_translation: "Ücretsiz bar servisi", example: "Is there a complimentary bar service on this fare?", example_tr: "Bu tarifede ücretsiz bar servisi var mı?" },
    {
      id: "ex.44.40.rq1",
      type: "recall_quiz",
      items: [
...
export const airportLesson_44_41: BundledLesson = {
  ...
  exercises: [
    ...
    { id: "ex.44.41.v01", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "broken", tr_translation: "Kırık / bozuk", example: "It's broken.", example_tr: "Kırık." },
    { id: "ex.44.41.v02", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "wheel", tr_translation: "Tekerlek", example: "The wheel is broken.", example_tr: "Tekerlek kırık." },
    { id: "ex.44.41.v03", type: "vocab_tile", difficulty: 1, cefr_band: "A1", word_or_phrase: "money", tr_translation: "Para (tazminat)", example: "I want money back.", example_tr: "Para iadesi istiyorum." },
    { id: "ex.44.41.v04", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "handle is broken", tr_translation: "Sap kırık", example: "The handle is broken on my bag.", example_tr: "Valizimin sapı kırık." },
    { id: "ex.44.41.v05", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "a big crack", tr_translation: "Büyük bir çatlak", example: "There's a big crack on the side.", example_tr: "Yan tarafta büyük bir çatlak var." },
    { id: "ex.44.41.v06", type: "vocab_tile", difficulty: 2, cefr_band: "A2", word_or_phrase: "what can you do", tr_translation: "Ne yapabilirsin?", example: "What can you do for me?", example_tr: "Benim için ne yapabilirsin?" },
    { id: "ex.44.41.v07", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "damage report", tr_translation: "Hasar raporu", example: "I need to file a damage report.", example_tr: "Hasar raporu doldurmam gerek." },
    { id: "ex.44.41.v08", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "reimbursement", tr_translation: "Geri ödeme", example: "Am I eligible for reimbursement?", example_tr: "Geri ödemeye uygun muyum?" },
    { id: "ex.44.41.v09", type: "vocab_tile", difficulty: 3, cefr_band: "B1", word_or_phrase: "receipt of purchase", tr_translation: "Satın alma fişi", example: "I have the receipt of purchase.", example_tr: "Satın alma fişim var." },
    { id: "ex.44.41.v10", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "irreparable damage", tr_translation: "Onarılamaz hasar", example: "This looks like irreparable damage.", example_tr: "Bu onarılamaz hasara benziyor." },
    { id: "ex.44.41.v11", type: "vocab_tile", difficulty: 4, cefr_band: "B2", word_or_phrase: "I'd appreciate a quick resolution", tr_translation: "Hızlı çözüm için minnettar olurum", example: "I'd appreciate a quick resolution.", example_tr: "Hızlı çözüm için minnettar olurum." },
    { id: "ex.44.41.v12", type: "vocab_tile", difficulty: 5, cefr_band: "C1", word_or_phrase: "depreciation deduction", tr_translation: "Amortisman düşümü", example: "Will there be a depreciation deduction?", example_tr: "Amortisman düşümü olur mu?" },
    { id: "ex.44.41.v13", type: "vocab_tile", difficulty: 5, cefr_band: "C2", word_or_phrase: "Montreal Convention liability", tr_translation: "Montreal Sözleşmesi sorumluluğu", example: "This falls under Montreal Convention liability limits.", example_tr: "Bu Montreal Sözleşmesi sorumluluk limitleri kapsamında." },
    {
      id: "ex.44.41.rq1",
      type: "recall_quiz",
      items: [
