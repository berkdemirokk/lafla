...
export const workCoffeechatLesson_13_1: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      example: "Want to grab a coffee?",
      example_tr: "Kahve içmek ister misin?",
    },
    {
      id: "ex.wcc13.1.14",
      type: "vocab_tile",
      difficulty: 1,
      cefr_band: "A1",
      word_or_phrase: "meeting",
      tr_translation: "Toplantı",
      example: "We have a meeting at 3pm.",
      example_tr: "Saat 3'te toplantımız var.",
    },
    {
      id: "ex.wcc13.1.15",
      type: "vocab_tile",
      ...
      tr_translation: "Bana bildir",
      example: "Let me know if Thursday works.",
      example_tr: "Perşembe uygun mu bana bildir.",
    },
    {
      id: "ex.wcc13.1.16",
      type: "vocab_tile",
      ...
      example: "Quick heads up — I'm running late by 5 min.",
    ...
    },
    {
      ...
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "thanks for your time",
      tr_translation: "Vakit ayırdığın için teşekkürler",
      example: "Thanks for your time today — really enjoyed the chat.",
      example_tr: "Bugün vakit ayırdığın için teşekkürler — sohbet için minnettarım.",
    },
    {
      id: "ex.wcc13.1.18",
      type: "vocab_tile",
      ...
      example: "Happy to help — drop me a Slack any time.",
      example_tr: "Yardım etmekten memnuniyet duyarım — istediğin zaman Slack at.",
    },
    {
      id: "ex.wcc13.1.19",
      type: "vocab_tile",
      ...
      example: "I'd like to follow up on the intro you mentioned.",
      example_tr: "Bahsettiğin tanıştırmayı takip etmek istiyorum.",
    },
    {
      id: "ex.wcc13.1.20",
      type: "vocab_tile",
      ...
      example: "I'll send a recap by end of day.",
      example_tr: "Gün sonuna kadar bir özet göndereceğim.",
    },
    {
      id: "ex.wcc13.1.21",
      type: "vocab_tile",
      ...
      example: "Given the timeline, would 20 minutes next Tuesday work?",
      example_tr: "Zaman çizelgesi göz önüne alındığında, gelecek Salı 20 dakika uygun mu?",
    },
    {
      id: "ex.wcc13.1.22",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "on a related note",
      tr_translation: "İlgili bir konuda",
      example: "On a related note — have you ever made a similar pivot?",
      example_tr: "İlgili bir konuda — benzer bir kariyer pivot'u yaptın mı hiç?",
    },
    {
      id: "ex.wcc13.1.23",
      type: "vocab_tile",
      ...
      example: "I tend to push back when scope creeps mid-sprint.",
      example_tr: "Sprint ortasında kapsam genişlediğinde karşı çıkma eğilimindeyim.",
    },
    {
      id: "ex.wcc13.1.24",
      type: "vocab_tile",
      ...
      example: "To that end, I'd love a 30-minute intro to Sarah.",
      example_tr: "Bu doğrultuda, Sarah ile 30 dakikalık bir tanışma çok iyi olur.",
    },
    {
      id: "ex.wcc13.1.25",
      type: "vocab_tile",
      difficulty: 6,
      cefr_band: "C2",
      word_or_phrase: "circle back offline",
      tr_translation: "Toplantı dışında dönelim",
      example: "Happy to circle back offline if you'd rather not get into it here.",
      example_tr: "Burada konuşmak istemezsen toplantı dışında dönmekten memnuniyet duyarım.",
    },
  ],
};
...
export const workCoffeechatLesson_13_2: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "What surprised you most",
      tr_translation: "En çok ne şaşırttı seni?",
      example: "What surprised you most about the move into management?",
      example_tr: "Yöneticiliğe geçişte seni en çok ne şaşırttı?",
    },
    {
      id: "ex.wcc13.2.v3",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "If you could rewind",
      tr_translation: "Geri sarabilseydin",
      example: "If you could rewind to year one, what would you do differently?",
      example_tr: "İlk yıla geri sarabilseydin neyi farklı yapardın?",
    },
    {
      id: "ex.wcc13.2.v4",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "What separates great from good",
      tr_translation: "Çok iyiyi iyiden ayıran ne?",
      example: "What separates great PMs from good ones in your view?",
      example_tr: "Sence çok iyi PM'leri iyilerden ne ayırır?",
    },
    {
      id: "ex.wcc13.2.v5",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Walk me through your thinking on",
      tr_translation: "Şu konudaki düşünceni anlat",
      example: "Walk me through your thinking on hiring senior vs junior.",
      example_tr: "Senior mu junior mu işe alma konusundaki düşünceni anlat.",
    },
  ],
};
...
export const workCoffeechatLesson_13_3: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Warm intro",
      tr_translation: "Sıcak tanıştırma (ortak tanıdık üzerinden)",
      example: "A warm intro from you would carry way more weight than a cold email.",
      example_tr: "Senden bir sıcak tanıştırma, soğuk mailden çok daha etkili olur.",
    },
    {
      id: "ex.wcc13.3.v3",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Loop you in",
      tr_translation: "Seni de dahil edeyim",
      example: "I'll loop you in on the thread once Maya replies.",
      example_tr: "Maya cevap verince seni de mail thread'ine dahil ederim.",
    },
    {
      id: "ex.wcc13.3.v4",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Forwardable email",
      tr_translation: "Yönlendirilebilir mail (intro için kısa özet)",
      example: "I'll send you a forwardable email so you can just hit forward.",
      example_tr: "Sadece 'forward' tuşuna basman için sana yönlendirilebilir bir mail göndereceğim.",
    },
    {
      id: "ex.wcc13.3.v5",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Pay it forward",
      tr_translation: "İyiliği başkasına aktarmak",
      example: "I can't repay you directly — but I'll pay it forward to someone earlier in their career.",
      example_tr: "Sana doğrudan ödeyemem — ama kariyerinin başındaki birine aktarırım.",
    },
  ],
};
...
export const workCoffeechatLesson_13_5: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Saw your post on",
      tr_translation: "Yazını gördüm (spesifik referans)",
      example: "Saw your post on staff promo — really resonated with where I'm at.",
      example_tr: "Staff promo yazını gördüm — şu an bulunduğum yere çok denk geldi.",
    },
    {
      id: "ex.wcc13.5.v3",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Zero pressure either way",
      tr_translation: "Her iki türlü de hiç baskı yok",
      example: "Open to 20 min on Zoom? Zero pressure either way.",
      example_tr: "Zoom'da 20 dakikaya açık mısın? Her iki türlü de hiç baskı yok.",
    },
    {
      id: "ex.wcc13.5.v4",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "If you're slammed",
      tr_translation: "Çok yoğunsan",
      example: "Happy to skip if you're slammed — no offense taken.",
      example_tr: "Çok yoğunsan atlayabiliriz — alınmam.",
    },
    {
      id: "ex.wcc13.5.v5",
      type: "vocab_tile",
      ...
      tr_translation: "Birdenbire / aniden",
      example: "Sorry for reaching out out of the blue — your talk just stuck with me.",
      example_tr: "Birdenbire ulaştığım için kusura bakma — sunuşun aklıma takıldı.",
    },
  ],
};
...
export const workCoffeechatLesson_13_6: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      tr_translation: "Kısacası / özetle",
      example: "In a nutshell: backend engineer, payments, eyeing a DX move.",
      example_tr: "Özetle: backend mühendisi, ödemelerdeyim, DX geçişine bakıyorum.",
    },
    {
      id: "ex.wcc13.6.v3",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Background-wise",
      tr_translation: "Geçmiş açısından",
      example: "Background-wise — 5 years in startups, last 2 at a fintech.",
      example_tr: "Geçmiş açısından — 5 yıl startup'larda, son 2 yıl bir fintech'te.",
    },
    {
      id: "ex.wcc13.6.v4",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Why this chat",
      tr_translation: "Bu sohbetin sebebi (niçin seninle konuşuyorum)",
      example: "Why this chat: your path is exactly the move I'm weighing right now.",
      example_tr: "Bu sohbetin sebebi: senin yolun tam da şu an düşündüğüm geçiş.",
    },
    {
      id: "ex.wcc13.6.v5",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Looking to move into",
      tr_translation: "Şuraya geçmek istiyorum",
      example: "Looking to move into developer experience next.",
      example_tr: "Sırada developer experience'a geçmek istiyorum.",
    },
  ],
};
...
export const workCoffeechatLesson_13_7: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "I'm at a fork",
      tr_translation: "Bir yol ayrımındayım",
      example: "I'm at a fork — startup CTO offer vs. staff at FAANG.",
      example_tr: "Bir yol ayrımındayım — startup CTO teklifi mi yoksa FAANG'de staff mı.",
    },
    {
      id: "ex.wcc13.7.v3",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Chew on that",
      tr_translation: "Bunu sindireyim / düşüneyim",
      example: "That's a helpful frame — gonna chew on that for a few days.",
      example_tr: "Bu çok faydalı bir bakış açısı — birkaç gün üzerinde düşüneceğim.",
    },
    {
      id: "ex.wcc13.7.v4",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "How did you navigate that",
      tr_translation: "O durumu nasıl yönettin?",
      example: "How did you navigate the conversation with your manager?",
      example_tr: "Yöneticinle o konuşmayı nasıl yönettin?",
    },
    {
      id: "ex.wcc13.7.v5",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "What signal told you",
      tr_translation: "Hangi işaret sana söyledi?",
      example: "What signal told you it was time to leave?",
      example_tr: "Ayrılma vaktinin geldiğini hangi işaret sana söyledi?",
    },
  ],
};
...
export const workCoffeechatLesson_13_8: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "Stuck with me",
      tr_translation: "Aklımda kaldı / etkiledi",
      example: "The 'protect your focus' line really stuck with me.",
      example_tr: "'Focus'unu koru' cümlesi aklımda kaldı.",
    },
    {
      id: "ex.wcc13.8.v3",
      type: "vocab_tile",
      ...
      example: "Let me know how I can return the favor — happy to help any time.",
      example_tr: "İyiliğini nasıl geri ödeyebilirim haber ver — her zaman yardım etmekten memnuniyet duyarım.",
    },
    {
      id: "ex.wcc13.8.v4",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Talk soon",
      tr_translation: "Yakında konuşuruz (samimi kapanış)",
      example: "Thanks again — talk soon.",
      example_tr: "Tekrar teşekkürler — yakında konuşuruz.",
    },
    {
      id: "ex.wcc13.8.v5",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Send me a Slack any time",
      tr_translation: "İstediğin zaman Slack at",
      example: "Door's open — send me a Slack any time.",
      example_tr: "Kapı açık — istediğin zaman Slack at.",
    },
  ],
};
