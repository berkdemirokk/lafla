...
export const workEmailLesson_11_1: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 1,
      cefr_band: "A1",
      word_or_phrase: "email",
      tr_translation: "E-posta",
      example: "I'll write you an email.",
      example_tr: "Sana bir e-posta yazacağım.",
    },
    {
      id: "ex.we11.1.14",
      type: "vocab_tile",
      ...
      example: "Thanks for the quick reply.",
      example_tr: "Hızlı cevap için teşekkürler.",
    },
    {
      id: "ex.we11.1.15",
      type: "vocab_tile",
      ...
      example: "I'll send it over by Friday.",
      example_tr: "Cuma'ya kadar göndereceğim.",
    },
    {
      id: "ex.we11.1.16",
      type: "vocab_tile",
      ...
      example_tr: "Başka bir şeye ihtiyacın olursa bana bildir.",
    },
    {
      id: "ex.we11.1.17",
      type: "vocab_tile",
    ...
    },
    {
      ...
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "please find attached",
      tr_translation: "Ekte bulabilirsin",
      example: "Please find attached the latest draft.",
      example_tr: "En son taslağı ekte bulabilirsin.",
    },
    {
      id: "ex.we11.1.19",
      type: "vocab_tile",
      ...
      example: "I'd like to follow up on the proposal I sent last week.",
      example_tr: "Geçen hafta gönderdiğim teklifi takip etmek istiyorum.",
    },
    {
      id: "ex.we11.1.20",
      type: "vocab_tile",
      ...
      example: "Hoping to wrap this by end of day.",
      example_tr: "Bunu gün sonuna kadar bitirmeyi umuyorum.",
    },
    {
      id: "ex.we11.1.21",
      type: "vocab_tile",
      ...
      example: "Given the timeline, could we sync this week?",
      example_tr: "Zaman çizelgesi göz önüne alındığında, bu hafta sync olabilir miyiz?",
    },
    {
      id: "ex.we11.1.22",
      type: "vocab_tile",
      ...
      example: "On a related note — the Q3 plan is also pending.",
      example_tr: "İlgili bir konuda — Q3 planı da bekliyor.",
    },
    {
      id: "ex.we11.1.23",
      type: "vocab_tile",
      ...
      example: "For what it's worth, the data supports option B.",
      example_tr: "Fikrim sorulursa, veri B seçeneğini destekliyor.",
    },
    {
      id: "ex.we11.1.24",
      type: "vocab_tile",
      ...
      example: "To that end, I've attached a one-pager.",
      example_tr: "Bu doğrultuda, tek sayfalık bir özet ekledim.",
    },
    {
      id: "ex.we11.1.25",
      type: "vocab_tile",
      ...
      example: "Happy to circle back offline on the budget specifics.",
      example_tr: "Bütçe detayları için toplantı dışında dönmekten memnuniyet duyarım.",
    },
  ],
};
...
export const workEmailLesson_11_2: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "In case it got buried",
      tr_translation: "Gömüldüyse diye / kayboldu mu diye",
      example: "Resharing this in case it got buried in your inbox.",
      example_tr: "Inbox'ta gömüldü mü diye tekrar paylaşıyorum.",
    },
    {
      id: "ex.we11.2.1b",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "Gentle nudge",
      tr_translation: "Nazik hatırlatma",
      example: "Just a gentle nudge — any thoughts on my last email?",
      example_tr: "Nazik bir hatırlatma — önceki maile bir görüşün var mı?",
    },
    {
      id: "ex.we11.2.1c",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "Following up on",
      tr_translation: "...takibini yapıyorum",
      example: "Following up on my note from last Tuesday.",
      example_tr: "Geçen salı yolladığım maili takip ediyorum.",
    },
    {
      id: "ex.we11.2.1d",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "Land it by Friday",
      tr_translation: "Cumaya bağlayalım / cumaya çözelim",
      example: "Hoping we can land this by Friday — anything I can help with?",
      example_tr: "Bunu cumaya bağlayabilir miyiz — yardım edebileceğim bir şey var mı?",
    },
    {
      id: "ex.we11.2.2",
      type: "translate",
...
export const workEmailLesson_11_3: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "Owning that",
      tr_translation: "Bunu üstüme alıyorum",
      example: "That was my miss — owning that, here's the plan.",
      example_tr: "Bu benim hatamdı — üstüme alıyorum, plan şu.",
    },
    {
      id: "ex.we11.3.1b",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "Apologies for the slip",
      tr_translation: "Sapmadan ötürü özür dilerim",
      example: "Apologies for the slip on yesterday's report.",
      example_tr: "Dünkü raporda yaşanan sapma için özür dilerim.",
    },
    {
      id: "ex.we11.3.1c",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "Here's the plan",
      tr_translation: "Plan şu",
      example: "Here's the plan: Thursday EOD, daily updates until done.",
      example_tr: "Plan şu: perşembe mesai sonu, bitene kadar günlük güncelleme.",
    },
    {
      id: "ex.we11.3.1d",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "Won't happen again",
      tr_translation: "Bir daha olmayacak",
      example: "Adding a review step so this won't happen again.",
      example_tr: "Bir inceleme adımı ekliyorum, bir daha olmayacak.",
    },
    {
      id: "ex.we11.3.2",
      type: "translate",
...
export const workEmailLesson_11_4: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      tr_translation: "Selamlar / iyi dilekler (casual signoff)",
      example: "Talk soon — Cheers, Berk",
      example_tr: "Yakında konuşuruz — Selamlar, Berk",
    },
    {
      id: "ex.we11.4.1b",
      type: "vocab_tile",
      ...
      example: "Happy to jump on a call if easier than email.",
      example_tr: "Mail yerine konuşmak daha kolaysa aramaya açığım.",
    },
    {
      id: "ex.we11.4.1c",
      type: "vocab_tile",
      ...
      tr_translation: "Yakında konuşuruz",
      example: "Talk soon — let me know how it lands.",
      example_tr: "Yakında konuşuruz — nasıl gittiğini bana bildir.",
    },
    {
      id: "ex.we11.4.1d",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "Looking forward to your thoughts",
      tr_translation: "Görüşlerini bekliyorum",
      example: "Looking forward to your thoughts — no rush.",
      example_tr: "Görüşlerini bekliyorum — acelesi yok.",
    },
    {
      id: "ex.we11.4.2",
      type: "translate",
...
export const workEmailLesson_11_5: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "Came across your work",
      tr_translation: "Çalışmana denk geldim",
      example: "Came across your work on payments — wanted to say hi.",
      example_tr: "Ödemeler üzerine çalışmana denk geldim — merhaba demek istedim.",
    },
    {
      id: "ex.we11.5.1b",
      type: "vocab_tile",
      ...
      tr_translation: "Fikrini almak / tecrübenden öğrenmek",
      example: "Would love to pick your brain on scaling Postgres.",
      example_tr: "Postgres ölçeklendirme konusunda fikrini almak isterim.",
    },
    {
      id: "ex.we11.5.1c",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "Open to a quick chat",
      tr_translation: "Kısa bir görüşmeye açık mısın",
      example: "Open to a quick chat next week?",
      example_tr: "Önümüzdeki hafta kısa bir görüşmeye açık mısın?",
    },
    {
      id: "ex.we11.5.1d",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "Trade notes",
      tr_translation: "Tecrübe alışverişi yapmak",
      example: "Would love to trade notes — we're tackling similar problems.",
      example_tr: "Tecrübe alışverişi yapmak isterim — benzer sorunlarla uğraşıyoruz.",
    },
    {
      id: "ex.we11.5.2",
      type: "translate",
...
export const workEmailLesson_11_6: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      tr_translation: "Baskı yok / serbestsin",
      example: "No pressure — happy to drop this if not a fit.",
      example_tr: "Baskı yok — uygun değilse bırakmaya hazırım.",
    },
    {
      id: "ex.we11.6.1b",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "Totally get it",
      tr_translation: "Tamamen anlıyorum",
      example: "Totally get it if timing isn't right.",
      example_tr: "Zaman uygun değilse tamamen anlıyorum.",
    },
    {
      id: "ex.we11.6.1c",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "Close the loop",
      tr_translation: "Konuyu kapatmak / sonuçlandırmak",
      example: "Just want to close the loop — should I keep this open or drop it?",
      example_tr: "Konuyu kapatmak istiyorum — açık tutayım mı bırakayım mı?",
    },
    {
      id: "ex.we11.6.1d",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "One-liner is all I need",
      tr_translation: "Tek satır cevap bana yeter",
      example: "Yes or no — a one-liner is all I need.",
      example_tr: "Evet ya da hayır — tek satır cevap bana yeter.",
    },
    {
      id: "ex.we11.6.2",
      type: "translate",
...
export const workEmailLesson_11_7: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "Limited email access",
      tr_translation: "Sınırlı email erişimi",
      example: "Will have limited email access until Monday.",
      example_tr: "Pazartesiye kadar sınırlı email erişimim olacak.",
    },
    {
      id: "ex.we11.7.1b",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "On PTO",
      tr_translation: "Yıllık izindeyim",
      example: "I'm on PTO this week — back next Monday.",
      example_tr: "Bu hafta yıllık izindeyim — pazartesi dönüyorum.",
    },
    {
      id: "ex.we11.7.1c",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "Reach out to Sarah",
      tr_translation: "Sarah'a ulaşın",
      example: "For urgent matters, please reach out to Sarah.",
      example_tr: "Acil konular için lütfen Sarah'a ulaşın.",
    },
    {
      id: "ex.we11.7.1d",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "Back on Monday",
      tr_translation: "Pazartesi döneceğim",
      example: "Back on Monday — will reply in order.",
      example_tr: "Pazartesi döneceğim — sırayla cevap vereceğim.",
    },
    {
      id: "ex.we11.7.2",
      type: "translate",
...
export const workEmailLesson_11_8: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "Going to have to pass",
      tr_translation: "Maalesef pas geçeceğim",
      example: "Going to have to pass on this one — too much on my plate.",
      example_tr: "Bu sefer maalesef pas geçeceğim — işim çok yoğun.",
    },
    {
      id: "ex.we11.8.1b",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "Not in my wheelhouse",
      tr_translation: "Benim uzmanlık alanım değil",
      example: "Honest answer — billing isn't really in my wheelhouse.",
      example_tr: "Dürüst cevap — faturalama benim uzmanlık alanım değil.",
    },
    {
      id: "ex.we11.8.1c",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "My plate is full",
      tr_translation: "Tabağım dolu (işim yoğun)",
      example: "My plate is full this sprint — can we revisit next month?",
      example_tr: "Bu sprint tabağım dolu — gelecek ay tekrar bakabilir miyiz?",
    },
    {
      id: "ex.we11.8.1d",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "Loop in someone else",
      tr_translation: "Başkasını dahil et / yönlendir",
      example: "Better to loop in Sarah — she owns this area.",
      example_tr: "Sarah'ı dahil etmen daha iyi — bu alan onun.",
    },
    {
      id: "ex.we11.8.2",
      type: "translate",
