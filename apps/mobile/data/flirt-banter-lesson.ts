...
export const flirtBanterLesson_2_2: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Easy there, killer",
      tr_translation: "Sakin ol bakalım (playful banter)",
      example: "Easy there, killer — let me defend myself first.",
      example_tr: "Sakin ol bakalım — kendimi savunmama izin ver önce.",
    },
    {
      id: "ex.fb2.2.14",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Putting that on the record",
      tr_translation: "Bunu tutanağa geçiriyorum (playful)",
      example: "Putting that on the record — you said pineapple belongs on pizza.",
      example_tr: "Bunu tutanağa geçiriyorum — pizzada ananas olur dedin.",
    },
    {
      id: "ex.fb2.2.15",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "I'll let it slide",
      tr_translation: "Bu seferlik geçiyorum (playful)",
      example: "I'll let it slide — but next time, no mercy.",
      example_tr: "Bu seferlik geçiyorum — ama bir dahaki sefere acımam.",
    },
    {
      id: "ex.fb2.2.16",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "Touché",
      tr_translation: "Eyvallah (haklı vuruş kabul)",
      example: "Okay, touché — you got me with that one.",
      example_tr: "Tamam, eyvallah — bu sefer beni yakaladın.",
    },
    {
      id: "ex.fb2.2.17",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Stop attacking me",
      tr_translation: "Bana saldırmayı bırak (sahte şikayet)",
      example: "Three roasts in a row — stop attacking me, I'm fragile.",
      example_tr: "Arka arkaya üç laf — bana saldırmayı bırak, hassasım.",
    },
...
export const flirtBanterLesson_2_3: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      tr_translation: "Acelen olmasın",
      example: "Take your time — no rush on the answer.",
      example_tr: "Acelen olmasın — cevap için aceleye gerek yok.",
    },
    {
      id: "ex.fb2.3.14",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Okay that one made me think",
      tr_translation: "Bu beni düşündürdü",
      example: "Okay that one made me think — give me a minute.",
      example_tr: "Bu beni düşündürdü — bir dakika ver.",
    },
    {
      id: "ex.fb2.3.15",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "What's the last thing that surprised you?",
      tr_translation: "Seni en son ne şaşırttı?",
      example: "Random question — what's the last thing that surprised you?",
      example_tr: "Rastgele bir soru — seni en son ne şaşırttı?",
    },
    {
      id: "ex.fb2.3.16",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "Skip if you want",
      tr_translation: "İstersen geç (saygılı çıkış)",
      example: "Heavy question — skip if you want, no pressure.",
      example_tr: "Ağır soru — istersen geç, baskı yok.",
    },
    {
      id: "ex.fb2.3.17",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Now you go",
      tr_translation: "Şimdi sıra sende",
      example: "Okay I answered — now you go, same question.",
      example_tr: "Tamam ben cevapladım — şimdi sıra sende, aynı soru.",
    },
...
export const flirtBanterLesson_2_4: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "It's not that deep",
      tr_translation: "O kadar büyük bir şey değil",
      example: "Don't worry, it's not that deep — just an old hobby.",
      example_tr: "Merak etme, o kadar büyük bir şey değil — eski bir hobi.",
    },
    {
      id: "ex.fb2.4.14",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Working on it",
      tr_translation: "Üzerinde çalışıyorum",
      example: "Still working on it — therapy helps.",
      example_tr: "Hala üzerinde çalışıyorum — terapi yardımcı oluyor.",
    },
    {
      id: "ex.fb2.4.15",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Heavy for a first chat",
      tr_translation: "İlk sohbet için ağır (öz-farkındalık)",
      example: "Sorry, heavy for a first chat — let me switch gears.",
      example_tr: "Pardon, ilk sohbet için ağır oldu — konuyu değiştireyim.",
    },
    {
      id: "ex.fb2.4.16",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "Genuinely curious",
      tr_translation: "Gerçekten merak ediyorum",
      example: "Genuinely curious — what made you switch careers?",
      example_tr: "Gerçekten merak ediyorum — neden iş değiştirdin?",
    },
    {
      id: "ex.fb2.4.17",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Glad we're past small talk",
      tr_translation: "Small talk'ı geçtiğimize memnunum",
      example: "Glad we're past small talk — this is way more interesting.",
      example_tr: "Small talk'ı geçtiğimize memnunum — bu çok daha ilginç.",
    },
...
export const flirtBanterLesson_2_5: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Receipts or it didn't happen",
      tr_translation: "Kanıt yoksa olmamıştır (Gen-Z slang)",
      example: "You ran a marathon last year? Receipts or it didn't happen.",
      example_tr: "Geçen sene maraton mu koştun? Kanıt yoksa olmamıştır.",
    },
    {
      id: "ex.fb2.5.14",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Prove me wrong",
      tr_translation: "Yanıldığımı kanıtla (playful)",
      example: "I doubt anyone can beat my Spotify wrapped — prove me wrong.",
      example_tr: "Spotify wrapped'ımı geçeni şüpheliyim — yanıldığımı kanıtla.",
    },
    {
      id: "ex.fb2.5.15",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Show me what you've got",
      tr_translation: "Göster bakalım ne becerin var",
      example: "Coffee expert, huh? Show me what you've got.",
      example_tr: "Kahve uzmanıymışsın? Göster bakalım ne becerin var.",
    },
    {
      id: "ex.fb2.5.16",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Big talk",
      tr_translation: "İddialı laf",
      example: "Big talk — can you actually back it up?",
      example_tr: "İddialı laf — gerçekten arkasında durabilir misin?",
    },
    {
      id: "ex.fb2.5.17",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "Color me impressed",
      tr_translation: "Etkilendim (sıcak kabul)",
      example: "Okay, color me impressed — you actually did it.",
      example_tr: "Tamam, etkilendim — gerçekten yaptın.",
    },
...
export const flirtBanterLesson_2_6: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Iconic behavior",
      tr_translation: "İkonik davranış (sıcak onay)",
      example: "Texting your mom about a first date — iconic behavior.",
      example_tr: "Annene ilk randevu hakkında mesaj atmak — ikonik davranış.",
    },
    {
      id: "ex.fb2.6.14",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Filing that under noted",
      tr_translation: "Bunu 'kayıt altında' diye dosyalıyorum",
      example: "Three cats and a sourdough starter? Filing that under noted.",
      example_tr: "Üç kedi ve bir ekşi mayalı starter? Bunu kayıt altında diye dosyalıyorum.",
    },
    {
      id: "ex.fb2.6.15",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Niche but okay",
      tr_translation: "Çok özel bir alan ama tamam (sıcak)",
      example: "Collecting vintage stamps? Niche but okay, I'm into it.",
      example_tr: "Vintage pul koleksiyonu mu? Çok özel bir alan ama tamam, sevdim.",
    },
    {
      id: "ex.fb2.6.16",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "I see you",
      tr_translation: "Seni gördüm (onaylayıcı, anlayan)",
      example: "Reading philosophy on a Friday night — I see you.",
      example_tr: "Cuma gecesi felsefe okumak — seni gördüm.",
    },
    {
      id: "ex.fb2.6.17",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "Respect though",
      tr_translation: "Yine de saygım var",
      example: "Five-hour pottery class on a weekend? Respect though.",
      example_tr: "Hafta sonu beş saatlik çömlek dersi mi? Yine de saygım var.",
    },
...
export const flirtBanterLesson_2_7: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Wow, no warm-up",
      tr_translation: "Vay, hiç ısınma yok (sahte şikayet)",
      example: "Wow, no warm-up — we're already roasting?",
      example_tr: "Vay, hiç ısınma yok — direkt yakmaya mı geçtik?",
    },
    {
      id: "ex.fb2.7.14",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "I'm still standing",
      tr_translation: "Hala ayaktayım (banter zaferi)",
      example: "Three jokes deep and I'm still standing.",
      example_tr: "Üç espri geçti ve hala ayaktayım.",
    },
    {
      id: "ex.fb2.7.15",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Okay relax",
      tr_translation: "Tamam sakin ol (playful)",
      example: "Okay relax — let me have one win.",
      example_tr: "Tamam sakin ol — bir galibiyet alayım.",
    },
    {
      id: "ex.fb2.7.16",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "I'll allow it",
      tr_translation: "Bu seferlik geçiyor (sıcak hakem)",
      example: "Bad pun but I'll allow it — funny enough.",
      example_tr: "Kötü bir kelime oyunu ama bu seferlik geçiyor — yeterince komik.",
    },
    {
      id: "ex.fb2.7.17",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "Easy there",
      tr_translation: "Sakin ol bakalım",
      example: "Easy there — let me catch my breath first.",
      example_tr: "Sakin ol bakalım — önce nefes alayım.",
    },
...
export const flirtBanterLesson_2_8: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Building lore",
      tr_translation: "Hikaye/efsane biriktiriyoruz (in-joke için)",
      example: "Three callbacks deep — we're building lore here.",
      example_tr: "Üç callback oldu — burada hikaye biriktiriyoruz.",
    },
    {
      id: "ex.fb2.8.14",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "It's on the record now",
      tr_translation: "Artık kayıt altında (in-joke kalıcılaştırma)",
      example: "You said you hate cilantro — it's on the record now.",
      example_tr: "Kişnişten nefret ettiğini söyledin — artık kayıt altında.",
    },
    {
      id: "ex.fb2.8.15",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Adding it to the list",
      tr_translation: "Listeye ekliyorum (playful katalog)",
      example: "'Fluorescent lights are an attack' — adding it to the list.",
      example_tr: "'Floresan ışık bir saldırıdır' — listeye ekliyorum.",
    },
    {
      id: "ex.fb2.8.16",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Going back to what you said",
      tr_translation: "Söylediğin şeye geri dönüyorum",
      example: "Going back to what you said about Sundays — I agree now.",
      example_tr: "Pazar günleri hakkında söylediğin şeye geri dönüyorum — şimdi katılıyorum.",
    },
    {
      id: "ex.fb2.8.17",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "Our bit",
      tr_translation: "Bizim şakamız (in-joke)",
      example: "The ferret racing thing is our bit now — official.",
      example_tr: "Gelincik yarışı meselesi artık bizim şakamız — resmi.",
    },
