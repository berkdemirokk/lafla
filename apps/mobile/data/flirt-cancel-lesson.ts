...
export const flirtCancelLesson_5_2: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "Let's pin it down",
      tr_translation: "Hadi sabitleyelim (plan)",
      example: "Let's pin it down — Friday or Saturday?",
      example_tr: "Hadi sabitleyelim — Cuma mı Cumartesi mi?",
    },
    {
      id: "ex.fc5.2.vt3",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Take two",
      tr_translation: "İkinci deneme",
      example: "Take two — what day actually works for you this week?",
      example_tr: "İkinci deneme — bu hafta hangi gün uygun?",
    },
    {
      id: "ex.fc5.2.vt4",
      type: "vocab_tile",
      ...
      tr_translation: "Sana telafi edeceğim",
      example: "Want to make it up to you — drinks on me this time.",
      example_tr: "Sana telafi etmek istiyorum — bu sefer içkiler benden.",
    },
    {
      id: "ex.fc5.2.vt5",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Still on the table?",
      tr_translation: "Hala masada mı? (plan geçerli mi)",
      example: "Hey — is dinner this week still on the table?",
      example_tr: "Selam — bu hafta yemek planı hala masada mı?",
    },
    {
      id: "ex.fc5.2.vt6",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "I'll come to you",
      tr_translation: "Senin tarafına geleyim (esneklik)",
      example: "Whatever's easier — I'll come to your neighborhood.",
      example_tr: "Senin için ne kolaysa — senin mahallene geleyim.",
    },
  ],
};
...
export const flirtCancelLesson_5_3: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Worst possible timing",
      tr_translation: "En kötü zamanlama",
      example: "Worst possible timing — emergency right before we meet.",
      example_tr: "En kötü zamanlama — buluşmadan hemen önce acil bir durum.",
    },
    {
      id: "ex.fc5.3.vt3",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Family thing",
      tr_translation: "Aile meselesi (detaysız + saygılı)",
      example: "Family thing — can't get into it but I have to bail.",
      example_tr: "Aile meselesi — detayına giremem ama iptal etmem lazım.",
    },
    {
      id: "ex.fc5.3.vt4",
      type: "vocab_tile",
      ...
      tr_translation: "Sana borçluyum",
      example: "Seriously, I owe you one — coffee on me next time.",
      example_tr: "Cidden, sana borçluyum — bir dahaki sefere kahve benden.",
    },
    {
      id: "ex.fc5.3.vt5",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Just got the call",
      tr_translation: "Az önce arandım",
      example: "Just got the call — have to head out, so sorry.",
      example_tr: "Az önce arandım — çıkmam lazım, çok özür dilerim.",
    },
    {
      id: "ex.fc5.3.vt6",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "Promise this isn't a pattern",
      tr_translation: "Söz veriyorum bu bir alışkanlık değil",
      example: "Promise this isn't a pattern — first time bailing on you.",
      example_tr: "Söz veriyorum bu bir alışkanlık değil — sana ilk iptalim.",
    },
  ],
};
...
export const flirtCancelLesson_5_4: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Meeting ran long",
      tr_translation: "Toplantı uzadı",
      example: "Meeting ran long — won't be out for another hour.",
      example_tr: "Toplantı uzadı — bir saat daha çıkamam.",
    },
    {
      id: "ex.fc5.4.vt3",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Stuck at the office",
      tr_translation: "Ofiste kaldım",
      example: "Stuck at the office — any chance we bump to tomorrow?",
      example_tr: "Ofiste kaldım — yarına ertelesek olur mu?",
    },
    {
      id: "ex.fc5.4.vt4",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Deadline got moved up",
      tr_translation: "Teslim tarihi öne alındı",
      example: "Deadline got moved up — can we push our dinner to Friday?",
      example_tr: "Teslim tarihi öne alındı — yemeği Cuma'ya itelim mi?",
    },
    {
      id: "ex.fc5.4.vt5",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Friday's wide open",
      tr_translation: "Cuma günüm bomboş",
      example: "Friday's wide open for me — any time after 6.",
      example_tr: "Cuma günüm bomboş — 6'dan sonra her zaman.",
    },
    {
      id: "ex.fc5.4.vt6",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "I'll be done by 8",
      tr_translation: "8'de biterim",
      example: "I'll be done by 8 — late dinner still good for you?",
      example_tr: "8'de biterim — geç yemek hala uygun mu?",
    },
  ],
};
...
export const flirtCancelLesson_5_5: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Caught a bug",
      tr_translation: "Bir mikrop kaptım",
      example: "Caught a bug overnight — Saturday instead?",
      example_tr: "Gece bir mikrop kaptım — Cumartesi'ye atalım mı?",
    },
    {
      id: "ex.fc5.5.vt3",
      type: "vocab_tile",
      ...
      tr_translation: "Yıkıldım (hastalıktan)",
      example: "Totally knocked out today — need to sleep this off.",
      example_tr: "Bugün tamamen yıkıldım — uyuyup atlatmam lazım.",
    },
    {
      id: "ex.fc5.5.vt4",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "Back to normal",
      tr_translation: "Eski halime döndüm",
      example: "I'll be back to normal by Saturday, promise.",
      example_tr: "Cumartesi'ye eski halime dönerim, söz.",
    },
    {
      id: "ex.fc5.5.vt5",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Won't be much fun",
      tr_translation: "Eğlenceli olmam (sağlık)",
      example: "Honestly I won't be much fun tonight — let's reschedule.",
      example_tr: "Açıkçası bu akşam pek eğlenceli olmam — başka güne atalım.",
    },
    {
      id: "ex.fc5.5.vt6",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Need to sleep this off",
      tr_translation: "Uyuyup geçirmem lazım",
      example: "Just need to sleep this off — Saturday works better.",
      example_tr: "Sadece uyuyup geçirmem lazım — Cumartesi daha iyi olur.",
    },
  ],
};
...
export const flirtCancelLesson_5_6: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      tr_translation: "Bitkinim, enerjim sıfır",
      example: "Running on empty today — would Sunday work instead?",
      example_tr: "Bugün bitkinim — Pazar günü uygun olur mu?",
    },
    {
      id: "ex.fc5.6.vt3",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Mentally fried",
      tr_translation: "Zihinsel olarak yandım",
      example: "Mentally fried — can we move it to the weekend?",
      example_tr: "Zihinsel olarak yandım — hafta sonuna alabilir miyiz?",
    },
    {
      id: "ex.fc5.6.vt4",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Need a quiet night",
      tr_translation: "Sessiz bir geceye ihtiyacım var",
      example: "Honestly need a quiet night — rain check?",
      example_tr: "Açıkçası sessiz bir geceye ihtiyacım var — başka güne mi atalım?",
    },
    {
      id: "ex.fc5.6.vt5",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Recharge",
      tr_translation: "Şarj ol, kendine gel",
      example: "Just need to recharge tonight — promise I'll be better company Saturday.",
      example_tr: "Bu akşam şarj olmam lazım — söz, Cumartesi daha iyi arkadaş olurum.",
    },
    {
      id: "ex.fc5.6.vt6",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Not myself today",
      tr_translation: "Bugün kendim değilim",
      example: "Honestly not myself today — would rather see you when I'm fully here.",
      example_tr: "Açıkçası bugün kendim değilim — tam burada olduğumda görmeyi tercih ederim.",
    },
  ],
};
...
export const flirtCancelLesson_5_7: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 2,
      cefr_band: "B1",
      word_or_phrase: "Hope you're okay",
      tr_translation: "Umarım iyisindir",
      example: "Hope you're okay — text me when you can.",
      example_tr: "Umarım iyisindir — uygun olduğunda yaz.",
    },
    {
      id: "ex.fc5.7.vt3",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "We'll catch up soon",
      tr_translation: "Yakında görüşürüz",
      example: "Stuff happens — we'll catch up soon, no rush.",
      example_tr: "Hayat işte — yakında görüşürüz, acelesi yok.",
    },
    {
      id: "ex.fc5.7.vt4",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Hit me up whenever",
      tr_translation: "Ne zaman istersen yaz",
      example: "Take your time — hit me up whenever you're free.",
      example_tr: "Acelene bakma — ne zaman uygunsan yaz.",
    },
    {
      id: "ex.fc5.7.vt5",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Life happens",
      tr_translation: "Hayatta her şey oluyor (kabul)",
      example: "No worries at all — life happens, take care of you.",
      example_tr: "Hiç dert etme — hayatta her şey oluyor, kendine bak.",
    },
    {
      id: "ex.fc5.7.vt6",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Whenever it works",
      tr_translation: "Ne zaman uygunsa",
      example: "Whenever it works for you — I'm easy.",
      example_tr: "Ne zaman uygunsa — benim için fark etmez.",
    },
  ],
};
