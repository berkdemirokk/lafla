...
export const flirtVoiceLesson_3_2: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Back to you",
      tr_translation: "Sıra sende (karşılıklılık daveti)",
      example: "Quick thought — then back to you.",
      example_tr: "Hızlı bir düşünce — sonra sıra sende.",
    },
    {
      id: "ex.fv3.2.vt3",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Sounds groggy",
      tr_translation: "Uykulu ses",
      example: "Sorry if I sound groggy — just woke up.",
      example_tr: "Uykulu sesim için pardon — yeni uyandım.",
    },
    {
      id: "ex.fv3.2.vt4",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Couldn't type this part",
      tr_translation: "Bu kısmı yazamadım",
      example: "Couldn't type this part — easier as voice.",
      example_tr: "Bu kısmı yazamadım — sesli daha kolay.",
    },
    {
      id: "ex.fv3.2.vt5",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Promise it's short",
      tr_translation: "Söz, kısa olacak",
      example: "Voice incoming — promise it's short.",
      example_tr: "Sesli geliyor — söz, kısa.",
    },
    {
      id: "ex.fv3.2.vt6",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Coming out flat",
      tr_translation: "Kuru/tatsız gözükmek (yazıda)",
      example: "Didn't want this coming out flat — voicing it.",
      example_tr: "Kuru gözüksün istemedim — sesli atıyorum.",
    },
  ],
};
...
export const flirtVoiceLesson_3_3: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Listened twice",
      tr_translation: "İki kere dinledim (yatırım)",
      example: "Listened twice — your laugh got me.",
      example_tr: "İki kere dinledim — gülüşün beni vurdu.",
    },
    {
      id: "ex.fv3.3.vt3",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Caught me off guard",
      tr_translation: "Beni hazırlıksız yakaladı (pozitif)",
      example: "Your voice caught me off guard — in a good way.",
      example_tr: "Sesin beni hazırlıksız yakaladı — iyi anlamda.",
    },
    {
      id: "ex.fv3.3.vt4",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Way warmer than texts",
      tr_translation: "Mesajlardan çok daha sıcak",
      example: "Your voice is way warmer than your texts — keep them coming.",
      example_tr: "Sesin mesajlardan çok daha sıcak — atmaya devam et.",
    },
    {
      id: "ex.fv3.3.vt5",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Replying with my own",
      tr_translation: "Ben de kendi sesli mesajımla cevaplıyorum",
      example: "Replying with my own voice — fair trade.",
      example_tr: "Ben de kendi sesli mesajımla cevaplıyorum — adil takas.",
    },
    {
      id: "ex.fv3.3.vt6",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "That ending killed me",
      tr_translation: "O finalin beni öldürdü (espri)",
      example: "Listened twice — that ending killed me.",
      example_tr: "İki kere dinledim — o finalin beni öldürdü.",
    },
  ],
};
...
export const flirtVoiceLesson_3_4: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Hop on a call",
      tr_translation: "Hızlı bir görüşmeye geç (casual)",
      example: "Wanna just hop on a call? Faster than typing.",
      example_tr: "Hızlı bir görüşmeye geçelim mi? Yazmaktan hızlı.",
    },
    {
      id: "ex.fv3.4.vt3",
      type: "vocab_tile",
      ...
      cefr_band: "B2",
      word_or_phrase: "Save us both the typing",
      tr_translation: "İkimizi de yazma derdinden kurtaralım",
      example: "Quick FaceTime? Save us both the typing.",
      example_tr: "Hızlı FaceTime? İkimizi de yazma derdinden kurtaralım.",
    },
    {
      id: "ex.fv3.4.vt4",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Read my mind",
      tr_translation: "Aklımı okudun",
      example: "You read my mind — was about to ask the same.",
      example_tr: "Aklımı okudun — aynı şeyi soracaktım.",
    },
    {
      id: "ex.fv3.4.vt5",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Equally nervous",
      tr_translation: "Eşit derecede gergin",
      example: "Equally nervous — let's just laugh through it.",
      example_tr: "Eşit derecede gergin — gülerek atlatalım.",
    },
    {
      id: "ex.fv3.4.vt6",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Or is now bad?",
      tr_translation: "Yoksa şu an uygun değil mi? (esnek)",
      example: "Free for a quick FaceTime — or is now bad?",
      example_tr: "Hızlı FaceTime'a müsait misin — yoksa şu an uygun değil mi?",
    },
  ],
};
...
export const flirtVoiceLesson_3_5: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Under a minute",
      tr_translation: "Bir dakikanın altı",
      example: "Keeping this under a minute — promise.",
      example_tr: "Bunu bir dakikanın altında tutuyorum — söz.",
    },
    {
      id: "ex.fv3.5.vt3",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Jumping the gun",
      tr_translation: "Adımı erken atmak",
      example: "Hope this isn't jumping the gun — quick voice memo?",
      example_tr: "Umarım adımı erken atmıyorum — hızlı bir sesli mesaj?",
    },
    {
      id: "ex.fv3.5.vt4",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Felt right to send",
      tr_translation: "Atmak doğru geldi",
      example: "We've been chatting a bit — felt right to send a VM.",
      example_tr: "Bir süredir yazışıyoruz — atmak doğru geldi.",
    },
    {
      id: "ex.fv3.5.vt5",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Mind if I voice memo",
      tr_translation: "Sesli atsam olur mu?",
      example: "Mind if I voice memo this one? Easier than typing.",
      example_tr: "Bunu sesli atsam olur mu? Yazmaktan kolay.",
    },
    {
      id: "ex.fv3.5.vt6",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Twenty seconds max",
      tr_translation: "Maksimum yirmi saniye",
      example: "First VM — twenty seconds max, promise.",
      example_tr: "İlk sesli — maksimum yirmi saniye, söz.",
    },
  ],
};
...
export const flirtVoiceLesson_3_6: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Voice for voice",
      tr_translation: "Sese ses (eşit reciprocity)",
      example: "Voice for voice — incoming in five.",
      example_tr: "Sese ses — beş dakikaya geliyor.",
    },
    {
      id: "ex.fv3.6.vt3",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Won't do this justice",
      tr_translation: "Bunu hakkıyla yansıtamaz",
      example: "Text won't do this justice — voicing back.",
      example_tr: "Yazı bunu hakkıyla yansıtamaz — sesli atıyorum.",
    },
    {
      id: "ex.fv3.6.vt4",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Stand by",
      tr_translation: "Hazır ol (kısaca)",
      example: "Stand by — VM incoming.",
      example_tr: "Hazır ol — sesli geliyor.",
    },
    {
      id: "ex.fv3.6.vt5",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "On the subway right now",
      tr_translation: "Şu an metroda",
      example: "On the subway right now — VM back in an hour.",
      example_tr: "Şu an metroda — bir saate sesli atarım.",
    },
    {
      id: "ex.fv3.6.vt6",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Wouldn't ghost the audio",
      tr_translation: "Sesli mesajı görmezden gelmem",
      example: "Wouldn't ghost the audio — proper VM coming tonight.",
      example_tr: "Sesli mesajı görmezden gelmem — uygun bir sesli bu gece geliyor.",
    },
  ],
};
...
export const flirtVoiceLesson_3_7: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Stuck in my head",
      tr_translation: "Aklımdan çıkmıyor",
      example: "Your laugh's been stuck in my head — that prompt was something.",
      example_tr: "Gülüşün aklımdan çıkmıyor — o prompt bir şeydi.",
    },
    {
      id: "ex.fv3.7.vt3",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Calm energy at the start",
      tr_translation: "Başta sakin enerji (voice prompt iltifatı)",
      example: "Loved the calm energy at the start — rare on this app.",
      example_tr: "Başta sakin enerjini sevdim — bu uygulamada nadir.",
    },
    {
      id: "ex.fv3.7.vt4",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Felt earned",
      tr_translation: "Hak edilmiş hissetti (samimi)",
      example: "Your laugh felt earned — not performed.",
      example_tr: "Gülüşün hak edilmiş hissetti — performans değil.",
    },
    {
      id: "ex.fv3.7.vt5",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Audio bio",
      tr_translation: "Sesli biyografi (dating app özelliği)",
      example: "Your audio bio caught me — voice over text wins.",
      example_tr: "Sesli biyografin beni yakaladı — ses, yazıyı yener.",
    },
    {
      id: "ex.fv3.7.vt6",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Their loss",
      tr_translation: "Onların kaybı (skipping)",
      example: "People skip voice prompts? Their loss.",
      example_tr: "İnsanlar voice prompt'ları geçiyor mu? Onların kaybı.",
    },
  ],
};
...
export const flirtVoiceLesson_3_8: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Lock in plans",
      tr_translation: "Planları kesinleştirmek",
      example: "Want to lock in plans? FaceTime first?",
      example_tr: "Planları kesinleştirelim mi? Önce FaceTime?",
    },
    {
      id: "ex.fv3.8.vt3",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Takes the edge off",
      tr_translation: "Gerginliği azaltır",
      example: "Quick FaceTime takes the edge off Saturday.",
      example_tr: "Hızlı bir FaceTime Cumartesi'nin gerginliğini azaltır.",
    },
    {
      id: "ex.fv3.8.vt4",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "No makeup, no agenda",
      tr_translation: "Makyaj yok, gündem yok (samimi)",
      example: "15 minutes, no makeup, no agenda — just hi.",
      example_tr: "15 dakika, makyaj yok, gündem yok — sadece selam.",
    },
    {
      id: "ex.fv3.8.vt5",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Saving the effort for Saturday",
      tr_translation: "Eforu Cumartesi'ye saklıyorum",
      example: "Saving the effort for Saturday — tonight is just vibe check.",
      example_tr: "Eforu Cumartesi'ye saklıyorum — bu gece sadece vibe check.",
    },
    {
      id: "ex.fv3.8.vt6",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Break the ice over a call",
      tr_translation: "Buzları telefonla kırmak",
      example: "Break the ice over a call before Saturday?",
      example_tr: "Cumartesi'den önce buzları telefonla kıralım mı?",
    },
  ],
};
