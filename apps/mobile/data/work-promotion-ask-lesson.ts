...
export const workPromotionAskLesson_38_2: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Build a case",
      tr_translation: "Kendine vaka çıkar / argüman hazırla",
      example: "Build a case for the raise — past wins + market data.",
      example_tr: "Zam için vaka çıkar — geçmiş kazanımlar + piyasa verisi.",
    },
    {
      id: "ex.wpa38.2.v3",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Operating at senior scope",
      tr_translation: "Senior seviyede çalışıyorum",
      example: "I've been operating at senior scope for two quarters.",
      example_tr: "İki çeyrektir senior seviyede çalışıyorum.",
    },
    {
      id: "ex.wpa38.2.v4",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Led the migration end-to-end",
      tr_translation: "Migration'ı uçtan uca yönettim",
      example: "Led the migration end-to-end — zero downtime.",
      example_tr: "Migration'ı uçtan uca yönettim — kesintisiz.",
    },
    {
      id: "ex.wpa38.2.v5",
      type: "vocab_tile",
      difficulty: 5,
      cefr_band: "C1",
      word_or_phrase: "Drove measurable impact",
      tr_translation: "Ölçülebilir etki yarattım",
      example: "Drove measurable impact: 35% error reduction.",
      example_tr: "Ölçülebilir etki yarattım: %35 hata azalması.",
    },
  ],
};
...
export const workPromotionAskLesson_38_3: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "What's the band",
      tr_translation: "Maaş aralığı nedir? (HR jargon)",
      example: "Market shows 175-195 — what's the band internally?",
      example_tr: "Piyasa 175-195 gösteriyor — şirket içi maaş aralığı nedir?",
    },
    {
      id: "ex.wpa38.3.v3",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Upper end of the range",
      tr_translation: "Aralığın üst tarafı",
      example: "Given my impact, I'm looking at the upper end of the range.",
      example_tr: "Etkim göz önüne alındığında, aralığın üst tarafına bakıyorum.",
    },
    {
      id: "ex.wpa38.3.v4",
      type: "vocab_tile",
      ...
      cefr_band: "C1",
      word_or_phrase: "Where's the flex",
      tr_translation: "Esneklik nerede? (negotiation kalıbı)",
      example: "Where's the flex — equity, sign-on, or base?",
      example_tr: "Esneklik nerede — equity, sign-on, yoksa baz maaş?",
    },
    {
      id: "ex.wpa38.3.v5",
      type: "vocab_tile",
      ...
      tr_translation: "İşe başlama ikramiyesi",
      example: "Could we explore a sign-on bonus if base is tight?",
      example_tr: "Baz maaş sınırlıysa sign-on bonus'a bakabilir miyiz?",
    },
  ],
};
...
export const workPromotionAskLesson_38_4: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      cefr_band: "B2",
      word_or_phrase: "What would I need to demonstrate",
      tr_translation: "Neyi göstermem gerekiyor?",
      example: "What would I need to demonstrate to revisit in Q3?",
      example_tr: "Q3'te tekrar bakmak için neyi göstermem gerekiyor?",
    },
    {
      id: "ex.wpa38.4.v3",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Document the plan",
      tr_translation: "Planı yazılı hale getir",
      example: "Let's document the plan so we're both aligned.",
      example_tr: "Hizalı olalım diye planı yazılı hale getirelim.",
    },
    {
      id: "ex.wpa38.4.v4",
      type: "vocab_tile",
      ...
      word_or_phrase: "Concrete criteria",
      tr_translation: "Somut kriterler",
      example: "Could we agree on concrete criteria so we both know the bar?",
      example_tr: "Çıtayı ikimiz de bilelim diye somut kriterlerde anlaşabilir miyiz?",
    },
    {
      id: "ex.wpa38.4.v5",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Monthly check-ins",
      tr_translation: "Aylık kontrol toplantıları",
      example: "Monthly check-ins to track progress until Q3.",
      example_tr: "Q3'e kadar ilerlemeyi takip etmek için aylık kontroller.",
    },
  ],
};
...
export const workPromotionAskLesson_38_5: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Put it on your radar",
      tr_translation: "Radarına sok / önceden haber ver",
      example: "Just wanted to put it on your radar.",
      example_tr: "Sadece radarına sokmak istedim.",
    },
    {
      id: "ex.wpa38.5.v3",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Talk growth",
      tr_translation: "Gelişim hakkında konuşmak",
      example: "Could we talk growth in the next couple of weeks?",
      example_tr: "Önümüzdeki birkaç hafta içinde gelişim hakkında konuşabilir miyiz?",
    },
    {
      id: "ex.wpa38.5.v4",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "No need to dive in today",
      tr_translation: "Bugün ayrıntıya girmemize gerek yok",
      example: "Putting this on your radar — no need to dive in today.",
      example_tr: "Bunu radarına sokuyorum — bugün ayrıntıya girmemize gerek yok.",
    },
    {
      id: "ex.wpa38.5.v5",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Map out the path",
      tr_translation: "Yolu birlikte çıkarmak",
      example: "Want to map out the path together.",
      example_tr: "Yolu birlikte çıkarmak istiyorum.",
    },
  ],
};
...
export const workPromotionAskLesson_38_6: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Beyond my current scope",
      tr_translation: "Mevcut kapsamımın dışında",
      example: "I've been operating beyond my current scope for 2 quarters.",
      example_tr: "İki çeyrektir mevcut kapsamımın dışında çalışıyorum.",
    },
    {
      id: "ex.wpa38.6.v3",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Stepped into",
      tr_translation: "İçine adım attım / üstlendim",
      example: "Stepped into the tech lead role on the migration.",
      example_tr: "Migration'da tech lead rolüne adım attım.",
    },
    {
      id: "ex.wpa38.6.v4",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Filled a gap",
      tr_translation: "Bir boşluğu doldurdum",
      example: "No one owned on-call — I filled that gap.",
      example_tr: "On-call'ı kimse sahiplenmiyordu — o boşluğu ben doldurdum.",
    },
    {
      id: "ex.wpa38.6.v5",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Drove a 22% lift",
      tr_translation: "%22 artış sağladım",
      example: "Drove a 22% lift in conversion last quarter.",
      example_tr: "Geçen çeyrek dönüşümde %22 artış sağladım.",
    },
  ],
};
...
export const workPromotionAskLesson_38_7: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "My anchor is",
      tr_translation: "Benim çıpam (negotiation anchor)",
      example: "My anchor is 185 — that's where the number sits.",
      example_tr: "Çıpam 185 — rakam oraya oturuyor.",
    },
    {
      id: "ex.wpa38.7.v3",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "That lands fairly",
      tr_translation: "Adilcek oturuyor",
      example: "Given the impact, 185 lands fairly.",
      example_tr: "Etkim göz önüne alındığında, 185 adil bir yere oturuyor.",
    },
    {
      id: "ex.wpa38.7.v4",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Grounded in",
      tr_translation: "Şuna dayalı / temellenmiş",
      example: "My target is grounded in market data and delivered impact.",
      example_tr: "Hedefim piyasa verisi ve teslim ettiğim etkiye dayalı.",
    },
    {
      id: "ex.wpa38.7.v5",
      type: "vocab_tile",
      difficulty: 5,
      cefr_band: "C1",
      word_or_phrase: "Levels.fyi puts senior at",
      tr_translation: "Levels.fyi senior'ı şurada gösteriyor",
      example: "Levels.fyi puts senior at 175-195 for this market.",
      example_tr: "Levels.fyi bu piyasa için senior'ı 175-195 gösteriyor.",
    },
  ],
};
...
export const workPromotionAskLesson_38_8: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Get closer to",
      tr_translation: "Şuna yaklaşmak",
      example: "Could we get closer to 185 given the impact?",
      example_tr: "Etkim göz önüne alındığında 185'e yaklaşabilir miyiz?",
    },
    {
      id: "ex.wpa38.8.v3",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Is there flex",
      tr_translation: "Esneklik var mı?",
      example: "Is there flex on equity if base is locked?",
      example_tr: "Baz maaş kilitliyse equity'de esneklik var mı?",
    },
    {
      id: "ex.wpa38.8.v4",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Comfortable closing at",
      tr_translation: "Şurada anlaşmaya açığım",
      example: "Comfortable closing at 181 plus a sign-on.",
      example_tr: "181 artı sign-on'da anlaşmaya açığım.",
    },
    {
      id: "ex.wpa38.8.v5",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Let me sit with it overnight",
      tr_translation: "Bir gece üzerinde düşüneyim",
      example: "Let me sit with it overnight and come back tomorrow.",
      example_tr: "Bir gece üzerinde düşüneyim, yarın döneyim.",
    },
  ],
};
