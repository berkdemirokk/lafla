...
export const workFeedbackGivingLesson_37_2: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Quality bar",
      tr_translation: "Kalite çıtası",
      example: "The quality bar still needs to hold, even with load.",
      example_tr: "İş yükü olsa bile kalite çıtası tutulmalı.",
    },
    {
      id: "ex.wfg37.2.v3",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Quality dip",
      tr_translation: "Kalite düşüşü",
      example: "Seeing a quality dip in the last few PRs.",
      example_tr: "Son birkaç PR'da bir kalite düşüşü görüyorum.",
    },
    {
      id: "ex.wfg37.2.v4",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Swamped",
      tr_translation: "Aşırı yoğun / boğulmuş",
      example: "I've been swamped — that's why I missed the deadline.",
      example_tr: "Aşırı yoğundum — bu yüzden deadline'ı kaçırdım.",
    },
    {
      id: "ex.wfg37.2.v5",
      type: "vocab_tile",
      difficulty: 5,
      cefr_band: "C1",
      word_or_phrase: "Hedge words",
      tr_translation: "Yumuşatıcı kelimeler (maybe, kind of)",
      example: "Drop the hedge words — say what you mean.",
      example_tr: "Yumuşatıcıları bırak — ne demek istiyorsan onu söyle.",
    },
  ],
};
...
export const workFeedbackGivingLesson_37_3: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "Shoutout to",
      tr_translation: "Şuna açık takdir",
      example: "Shoutout to Maya for catching the bug.",
      example_tr: "Maya'ya bug'ı yakaladığı için açık takdir.",
    },
    {
      id: "ex.wfg37.3.v3",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Saved us a firefight",
      tr_translation: "Bizi yangın söndürmekten kurtardı",
      example: "Saved us a Sunday firefight — above and beyond.",
      example_tr: "Pazar yangın söndürmekten kurtardı bizi — sıradanın çok üstünde.",
    },
    {
      id: "ex.wfg37.3.v4",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Above and beyond",
      tr_translation: "Sıradanın çok üstünde",
      example: "Going above and beyond on the incident response.",
      example_tr: "Olay müdahalesinde sıradanın çok üstünde.",
    },
    {
      id: "ex.wfg37.3.v5",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "High-water mark",
      tr_translation: "Yüksek standart / dorum noktası",
      example: "That RFC is a high-water mark for the team.",
      example_tr: "Bu RFC takım için bir dorum noktası.",
    },
  ],
};
...
export const workFeedbackGivingLesson_37_4: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      cefr_band: "B2",
      word_or_phrase: "What would help here",
      tr_translation: "Burada ne yardımcı olur?",
      example: "What would help here? Pair review? Scope cut?",
      example_tr: "Burada ne yardımcı olur? Pair review mi? Kapsam kısma mı?",
    },
    {
      id: "ex.wfg37.4.v3",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Pick one thing to try",
      tr_translation: "Denenecek bir şey seçelim",
      example: "Let's pick one thing to try this sprint.",
      example_tr: "Bu sprint denenecek bir şey seçelim.",
    },
    {
      id: "ex.wfg37.4.v4",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Revisit in 2 weeks",
      tr_translation: "2 hafta sonra tekrar bakmak",
      example: "Let's revisit in 2 weeks and see how it's tracking.",
      example_tr: "2 hafta sonra tekrar bakıp nasıl gittiğini görelim.",
    },
    {
      id: "ex.wfg37.4.v5",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "See how it's tracking",
      tr_translation: "Nasıl gittiğini görmek",
      example: "Quick sync next Friday to see how it's tracking?",
      example_tr: "Önümüzdeki Cuma nasıl gittiğini görmek için hızlı sync?",
    },
  ],
};
...
export const workFeedbackGivingLesson_37_5: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "On fire",
      tr_translation: "Müthiş / harika (pozitif iş kalıbı)",
      example: "That deck was on fire — couldn't have been sharper.",
      example_tr: "O sunum müthişti — daha keskin olamazdı.",
    },
    {
      id: "ex.wfg37.5.v3",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Won the CFO over",
      tr_translation: "CFO'yu ikna etti",
      example: "Your revenue slide is what won the CFO over.",
      example_tr: "CFO'yu ikna eden senin revenue slide'ındı.",
    },
    {
      id: "ex.wfg37.5.v4",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "That's the bar",
      tr_translation: "Çıta bu",
      example: "Keep doing that — that's the bar for exec decks.",
      example_tr: "Bunu yapmaya devam et — yönetici sunumları için çıta bu.",
    },
    {
      id: "ex.wfg37.5.v5",
      type: "vocab_tile",
      difficulty: 5,
      cefr_band: "C1",
      word_or_phrase: "Rigor showed",
      tr_translation: "Titizlik göründü",
      example: "The rigor showed — that prep paid off.",
      example_tr: "Titizlik göründü — o hazırlık karşılığını verdi.",
    },
  ],
};
...
export const workFeedbackGivingLesson_37_6: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      cefr_band: "B2",
      word_or_phrase: "Level up",
      tr_translation: "Bir üst seviyeye çıkmak",
      example: "One thing to level up: a sharper TL;DR.",
      example_tr: "Bir üst seviyeye çıkmak için: daha keskin bir TL;DR.",
    },
    {
      id: "ex.wfg37.6.v3",
      type: "vocab_tile",
      difficulty: 5,
      cefr_band: "C1",
      word_or_phrase: "Signature work",
      tr_translation: "İmza işi",
      example: "Crack that and these docs become your signature work.",
      example_tr: "Bunu çözersen, bu dokümanlar imza işin olur.",
    },
    {
      id: "ex.wfg37.6.v4",
      type: "vocab_tile",
      difficulty: 5,
      cefr_band: "C1",
      word_or_phrase: "BLUF — bottom line up front",
      tr_translation: "Sonucu önce koy (yazı tekniği)",
      example: "BLUF style — reader gets the take in 30 seconds.",
      example_tr: "BLUF tarzı — okuyucu sonucu 30 saniyede alır.",
    },
    {
      id: "ex.wfg37.6.v5",
      type: "vocab_tile",
      difficulty: 5,
      cefr_band: "C1",
      word_or_phrase: "Conclusion up front",
      tr_translation: "Sonucu başa koymak",
      example: "Lead with the conclusion up front, then the detail.",
      example_tr: "Sonucu başa koy, sonra detay gelsin.",
    },
  ],
};
...
export const workFeedbackGivingLesson_37_7: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "I want to flag something",
      tr_translation: "Bir şeyi belirtmek / dikkatine sunmak istiyorum",
      example: "I want to flag something — PRs have slipped 3 sprints.",
      example_tr: "Bir şey belirtmek istiyorum — PR'lar 3 sprint kaydı.",
    },
    {
      id: "ex.wfg37.7.v3",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "From where you sit",
      tr_translation: "Senin durduğun yerden",
      example: "What's your take on that from where you sit?",
      example_tr: "Senin durduğun yerden buna nasıl bakıyorsun?",
    },
    {
      id: "ex.wfg37.7.v4",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Stuck silently",
      tr_translation: "Sessizce takılıp kalmak",
      example: "Being stuck silently is worse than asking for help.",
      example_tr: "Sessizce takılıp kalmak yardım istemekten daha kötü.",
    },
    {
      id: "ex.wfg37.7.v5",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Raising your hand",
      tr_translation: "Elini kaldırmak / yardım istemek",
      example: "Raising your hand isn't weakness — it's good engineering.",
      example_tr: "Elini kaldırmak zayıflık değil — iyi mühendislik.",
    },
  ],
};
...
export const workFeedbackGivingLesson_37_8: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "Loved how you",
      tr_translation: "Şunu yapma şekline bayıldım",
      example: "Loved how you handled the retry logic.",
      example_tr: "Retry mantığını ele alma şekline bayıldım.",
    },
    {
      id: "ex.wfg37.8.v3",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Pulling this into a hook",
      tr_translation: "Bunu bir hook'a çekmek",
      example: "Have you considered pulling this into a hook for reuse?",
      example_tr: "Tekrar kullanım için bunu bir hook'a çekmeyi düşündün mü?",
    },
    {
      id: "ex.wfg37.8.v4",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Other call sites",
      tr_translation: "Diğer çağırma yerleri",
      example: "Other call sites could reuse it if we extract.",
      example_tr: "Çıkarırsak diğer çağırma yerleri tekrar kullanabilir.",
    },
    {
      id: "ex.wfg37.8.v5",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Don't block the merge",
      tr_translation: "Merge'i engelleme",
      example: "Happy with a follow-up — don't block the merge.",
      example_tr: "Takip PR'ı uygun — merge'i engelleme.",
    },
  ],
};
