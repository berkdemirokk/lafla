...
export const workExpansionLesson_1: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      example: "My boss is in the meeting room.",
      example_tr: "Patronum toplantı odasında.",
    },
    {
      id: "ex.we1.14",
      type: "vocab_tile",
      ...
      cefr_band: "A1",
      word_or_phrase: "work",
      tr_translation: "İş / çalışmak",
      example: "I work at a tech company.",
      example_tr: "Bir teknoloji şirketinde çalışıyorum.",
    },
    {
      id: "ex.we1.15",
      type: "vocab_tile",
      ...
      example_tr: "Takvimime bir bakayım.",
    },
    {
      id: "ex.we1.16",
      type: "vocab_tile",
      ...
      example: "I'll send it before lunch.",
      example_tr: "Öğle yemeğinden önce göndereceğim.",
    },
    {
      id: "ex.we1.17",
      type: "vocab_tile",
    ...
    },
    {
      ...
      example: "No problem — happy to reschedule.",
      example_tr: "Sorun değil — tekrar planlamaktan memnuniyet duyarım.",
    },
    {
      id: "ex.we1.19",
      type: "vocab_tile",
      ...
      example: "I'd like to follow up on what we discussed.",
      example_tr: "Konuştuğumuz konuyu takip etmek istiyorum.",
    },
    {
      id: "ex.we1.20",
      type: "vocab_tile",
      ...
      tr_translation: "İnceliyorum",
      example: "I'm looking into it — will update you by EOD.",
      example_tr: "İnceliyorum — gün sonuna kadar dönerim.",
    },
    {
      id: "ex.we1.21",
      type: "vocab_tile",
      ...
      example: "Given the timeline, can we de-scope the Q3 part?",
      example_tr: "Zaman çizelgesi göz önüne alındığında, Q3 kısmını kapsam dışı bırakabilir miyiz?",
    },
    {
      id: "ex.we1.22",
      type: "vocab_tile",
      ...
      example: "I tend to push back when timelines slip without scope cuts.",
      example_tr: "Kapsam azaltılmadan zaman çizelgeleri kaydığında karşı çıkma eğilimindeyim.",
    },
    {
      id: "ex.we1.23",
      type: "vocab_tile",
      ...
      example: "Walk me through how you're thinking about prioritization.",
      example_tr: "Önceliklendirmeyi nasıl düşündüğünü adım adım anlat.",
    },
    {
      id: "ex.we1.24",
      type: "vocab_tile",
      ...
      example: "To that end, I've drafted a 30-60-90 plan.",
      example_tr: "Bu doğrultuda, 30-60-90 günlük bir plan hazırladım.",
    },
    {
      id: "ex.we1.25",
      type: "vocab_tile",
      ...
      example: "Let's table that for now and pick it up next 1:1.",
      example_tr: "Şimdilik askıya alalım, gelecek 1:1'de devam edelim.",
    },
  ],
};
