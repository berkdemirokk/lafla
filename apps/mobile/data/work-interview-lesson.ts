  ...
  exercises: [
    {
      ...
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Took incident command",
      tr_translation: "Olay komutunu aldım",
      example: "When prod went down, I took incident command.",
      example_tr: "Prod düştüğünde olay komutunu ben aldım.",
    },
    {
      id: "ex.wi14.2.v3",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "War room",
      tr_translation: "Savaş odası (incident response toplantısı)",
      example: "Opened a war room and assigned roles within 5 minutes.",
      example_tr: "5 dakikada savaş odası açtım ve rolleri dağıttım.",
    },
    {
      id: "ex.wi14.2.v4",
      type: "vocab_tile",
      ...
      tr_translation: "Geriye dönüp baktığımda",
      example: "In hindsight, I should've looped in product earlier.",
      example_tr: "Geriye dönüp baktığımda, product'ı daha erken dahil etmeliydim.",
    },
    {
      id: "ex.wi14.2.v5",
      type: "vocab_tile",
      difficulty: 5,
      cefr_band: "C1",
      word_or_phrase: "Prevented recurrence",
      tr_translation: "Tekrar etmesini engelledi",
      example: "The post-mortem actions prevented recurrence.",
      example_tr: "Post-mortem aksiyonları tekrar etmesini engelledi.",
    },
    {
      id: "ex.wi14.2.1",
      type: "vocab_tile",
  ...
  exercises: [
    {
      ...
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "What keeps you up at night",
      tr_translation: "Seni geceleri uyutmayan ne?",
      example: "Honestly — what keeps you up at night about this team?",
      example_tr: "Açıkça sor — bu takım hakkında seni geceleri uyutmayan ne?",
    },
    {
      id: "ex.wi14.3.v3",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Biggest unknown",
      tr_translation: "En büyük bilinmeyen",
      example: "What's the biggest unknown for the team this quarter?",
      example_tr: "Bu çeyrek takım için en büyük bilinmeyen ne?",
    },
    {
      id: "ex.wi14.3.v4",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "At the 6-month mark",
      tr_translation: "6 aylık dönüm noktasında",
      example: "What does success look like at the 6-month mark?",
      example_tr: "6 aylık dönüm noktasında başarı nasıl görünüyor?",
    },
    {
      id: "ex.wi14.3.v5",
      type: "vocab_tile",
      difficulty: 5,
      cefr_band: "C1",
      word_or_phrase: "Fighting against",
      tr_translation: "Karşı savaştığımız",
      example: "What's the team fighting against right now?",
      example_tr: "Takım şu an neye karşı savaşıyor?",
    },
    {
      id: "ex.wi14.3.1",
      type: "vocab_tile",
  ...
  exercises: [
    {
      ...
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Sit with it overnight",
      tr_translation: "Bir gece üzerinde düşünmek",
      example: "Could I sit with it overnight and come back tomorrow?",
      example_tr: "Bir gece üzerinde düşünüp yarın dönebilir miyim?",
    },
    {
      id: "ex.wi14.4.v3",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Align on comp",
      tr_translation: "Maaş üzerinde hizalanmak",
      example: "Excited about the role — want to align on comp.",
      example_tr: "Rol için heyecanlıyım — maaş üzerinde hizalanmak istiyorum.",
    },
    {
      id: "ex.wi14.4.v4",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Walk-away point",
      tr_translation: "Çekilme noktası (alt sınır)",
      example: "Knowing your walk-away point keeps the negotiation calm.",
      example_tr: "Çekilme noktanı bilmek pazarlığı sakin tutar.",
    },
    {
      id: "ex.wi14.4.v5",
      type: "vocab_tile",
      difficulty: 5,
      cefr_band: "C1",
      word_or_phrase: "Refreshed offer",
      tr_translation: "Yenilenmiş teklif",
      example: "Recruiter will come back with a refreshed offer by EOD.",
      example_tr: "Recruiter EOD'a kadar yenilenmiş bir teklifle dönecek.",
    },
    {
      id: "ex.wi14.4.1",
      type: "vocab_tile",
  ...
  exercises: [
    {
      ...
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Influence without authority",
      tr_translation: "Otorite olmadan etkilemek",
      example: "Tell me about a time you influenced without authority.",
      example_tr: "Otorite olmadan birini etkilediğin bir anı anlat.",
    },
    {
      id: "ex.wi14.5.v3",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Got their buy-in",
      tr_translation: "Onların onayını / desteğini aldım",
      example: "Walked them through the data and got their buy-in.",
      example_tr: "Veriyi adım adım anlattım ve onayını aldım.",
    },
    {
      id: "ex.wi14.5.v4",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "End result",
      tr_translation: "Sonuç olarak",
      example: "End result — we shipped two weeks early.",
      example_tr: "Sonuç olarak — iki hafta erken yayınladık.",
    },
    {
      id: "ex.wi14.5.v5",
      type: "vocab_tile",
      difficulty: 5,
      cefr_band: "C1",
      word_or_phrase: "Tough call",
      tr_translation: "Zor karar",
      example: "Tell me about a tough call you made under pressure.",
      example_tr: "Baskı altında verdiğin zor bir kararı anlat.",
    },
    {
      id: "ex.wi14.5.1",
      type: "vocab_tile",
  ...
  exercises: [
    {
      ...
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Total package",
      tr_translation: "Toplam paket (base + equity + bonus)",
      example: "I'm flexible depending on the total package.",
      example_tr: "Toplam pakete bağlı olarak esneğim.",
    },
    {
      id: "ex.wi14.6.v3",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Factor in",
      tr_translation: "Hesaba katmak",
      example: "Equity and signing factor in too.",
      example_tr: "Equity ve signing'i de hesaba katıyorum.",
    },
    {
      id: "ex.wi14.6.v4",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Level placement",
      tr_translation: "Seviye yerleşimi (junior/senior/staff)",
      example: "Open to level placement discussion if it helps the number.",
      example_tr: "Rakam çözecekse seviye yerleşimi konuşmaya açığım.",
    },
    {
      id: "ex.wi14.6.v5",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Want to make this work",
      tr_translation: "Bunu yürütmek istiyorum",
      example: "Want to make this work — open to creative options.",
      example_tr: "Bunu yürütmek istiyorum — yaratıcı seçeneklere açığım.",
    },
    {
      id: "ex.wi14.6.1",
      type: "vocab_tile",
  ...
  exercises: [
    {
      ...
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Good enough to ship",
      tr_translation: "Göndermeye yetecek kadar iyi",
      example: "I work on a 'good enough to ship' mindset.",
      example_tr: "'Göndermeye yetecek kadar iyi' zihniyeti üzerinde çalışıyorum.",
    },
    {
      id: "ex.wi14.7.v3",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Over-polish",
      tr_translation: "Aşırı cilalamak (mükemmeliyetçilik)",
      example: "I used to over-polish before shipping.",
      example_tr: "Eskiden göndermeden önce aşırı cilalardım.",
    },
    {
      id: "ex.wi14.7.v4",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Actively addressing it",
      tr_translation: "Aktif olarak üzerine gidiyorum",
      example: "Actively addressing it with a weekly retro.",
      example_tr: "Haftalık retro ile aktif olarak üzerine gidiyorum.",
    },
    {
      id: "ex.wi14.7.v5",
      type: "vocab_tile",
      difficulty: 5,
      cefr_band: "C1",
      word_or_phrase: "Keep me honest",
      tr_translation: "Beni dürüst tutmak / kontrol etmek",
      example: "Weekly retros keep me honest on the perfectionism.",
      example_tr: "Haftalık retro'lar mükemmeliyetçilik konusunda beni kontrol ediyor.",
    },
    {
      id: "ex.wi14.7.1",
      type: "vocab_tile",
  ...
  exercises: [
    {
      ...
      difficulty: 3,
      cefr_band: "B2",
      word_or_phrase: "How would my first 30 days look",
      tr_translation: "İlk 30 günüm nasıl görünür?",
      example: "How would my first 30 days look in this role?",
      example_tr: "Bu rolde ilk 30 günüm nasıl görünür?",
    },
    {
      id: "ex.wi14.8.v3",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Biggest challenge facing the team",
      tr_translation: "Takımın karşılaştığı en büyük zorluk",
      example: "What's the biggest challenge facing the team right now?",
      example_tr: "Takımın şu an karşılaştığı en büyük zorluk ne?",
    },
    {
      id: "ex.wi14.8.v4",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Feedback norms",
      tr_translation: "Feedback normları",
      example: "Tell me about the team's feedback norms.",
      example_tr: "Takımın feedback normlarından bahset.",
    },
    {
      id: "ex.wi14.8.v5",
      type: "vocab_tile",
      difficulty: 5,
      cefr_band: "C1",
      word_or_phrase: "Conflict resolution",
      tr_translation: "Anlaşmazlık çözümü",
      example: "How does the team handle conflict resolution?",
      example_tr: "Takım anlaşmazlık çözümünü nasıl ele alıyor?",
    },
    {
      id: "ex.wi14.8.1",
      type: "vocab_tile",
