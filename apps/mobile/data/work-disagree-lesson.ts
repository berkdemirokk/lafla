...
export const workDisagreeLesson_34_1: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      example: "No, I'm not sure about that.",
      example_tr: "Hayır, bundan emin değilim.",
    },
    {
      id: "ex.wd34.1.14",
      type: "vocab_tile",
      ...
      word_or_phrase: "yes",
      tr_translation: "Evet",
      example: "Yes — but with one concern.",
      example_tr: "Evet — ama bir endişem var.",
    },
    {
      id: "ex.wd34.1.15",
      type: "vocab_tile",
      ...
      example: "Let me check the data before I push back.",
      example_tr: "Karşı çıkmadan önce veriye bir bakayım.",
    },
    {
      id: "ex.wd34.1.16",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "I'll think about it",
      tr_translation: "Bunu düşüneceğim",
      example: "I'll think about it and get back to you tomorrow.",
      example_tr: "Bunu düşünüp yarın sana döneceğim.",
    },
    {
      id: "ex.wd34.1.17",
      type: "vocab_tile",
      ...
      example: "I'm not sure that's the right call here.",
      example_tr: "Bu kararın burada doğru olduğundan emin değilim.",
    },
    {
      id: "ex.wd34.1.18",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "make sense",
      tr_translation: "Mantıklı (gelmek)",
      example: "Does that make sense, or did I miss something?",
      example_tr: "Mantıklı geldi mi, yoksa bir şeyi mi atladım?",
    },
    {
      id: "ex.wd34.1.19",
      type: "vocab_tile",
      ...
      example: "I'd like to follow up on the trade-offs you mentioned.",
      example_tr: "Bahsettiğin trade-off'ları takip etmek istiyorum.",
    },
    {
      id: "ex.wd34.1.20",
      type: "vocab_tile",
      ...
      tr_translation: "Yardım etmekten memnuniyet duyarım",
      example: "Happy to help model the alternative if useful.",
      example_tr: "Alternatifi modellemek faydalıysa yardım etmekten memnuniyet duyarım.",
    },
    {
      id: "ex.wd34.1.21",
      type: "vocab_tile",
      ...
      example: "I tend to push back when we conflate cost and value.",
      example_tr: "Maliyet ve değeri birbirine karıştırdığımızda karşı çıkma eğilimindeyim.",
    },
    {
      id: "ex.wd34.1.22",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "given the constraints",
      tr_translation: "Kısıtlar göz önüne alındığında",
      example: "Given the constraints, I'd argue for a phased rollout.",
      example_tr: "Kısıtlar göz önüne alındığında, aşamalı bir yayılımı savunurum.",
    },
    {
      id: "ex.wd34.1.23",
      type: "vocab_tile",
      ...
      tr_translation: "Şunu savunurum / iddia ederim",
      example: "I'd argue that we're optimizing for the wrong metric.",
      example_tr: "Yanlış metriği optimize ettiğimizi savunurum.",
    },
    {
      id: "ex.wd34.1.24",
      type: "vocab_tile",
      difficulty: 5,
      cefr_band: "C1",
      word_or_phrase: "presumably we're aligned",
      tr_translation: "Sanırım hemfikiriz",
      example: "Presumably we're aligned on the goal — the disagreement is on the path.",
      example_tr: "Sanırım hedef konusunda hemfikiriz — anlaşmazlık yolda.",
    },
    {
      id: "ex.wd34.1.25",
      type: "vocab_tile",
      ...
      example: "Let's table that for now and revisit after the spike.",
      example_tr: "Şimdilik askıya alalım, spike sonrası tekrar bakarız.",
    },
  ],
};
...
export const workDisagreeLesson_34_2: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      tr_translation: "Şunu düşündün mü?",
      example: "Have you considered batched fetch instead — open to it?",
      example_tr: "Yerine batched fetch'i düşündün mü — buna açık mısın?",
    },
    {
      id: "ex.wd34.2.v3",
      type: "vocab_tile",
      ...
      tr_translation: "Ödün / değiş tokuş",
      example: "The trade-off here is testability vs. simplicity.",
      example_tr: "Buradaki ödün test edilebilirlik ile sadelik arasında.",
    },
    {
      id: "ex.wd34.2.v4",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Consistency win",
      tr_translation: "Tutarlılık kazanımı",
      example: "Going with the context pattern is a consistency win across the codebase.",
      example_tr: "Context pattern'a gitmek kod tabanı genelinde bir tutarlılık kazanımı.",
    },
    {
      id: "ex.wd34.2.v5",
      type: "vocab_tile",
      difficulty: 5,
      cefr_band: "C1",
      word_or_phrase: "Break test isolation",
      tr_translation: "Test izolasyonunu bozmak",
      example: "Singleton breaks test isolation — that's the main concern.",
      example_tr: "Singleton test izolasyonunu bozar — ana endişe bu.",
    },
  ],
};
...
export const workDisagreeLesson_34_3: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      tr_translation: "Şeytanın avukatlığını yapmak",
      example: "Let me play devil's advocate for a sec — what if we're wrong?",
      example_tr: "Bir saniye şeytanın avukatlığını yapayım — ya yanılıyorsak?",
    },
    {
      id: "ex.wd34.3.v3",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Stress test the assumption",
      tr_translation: "Varsayımı stres testine sokmak",
      example: "Let's stress test the assumption that price drives churn.",
      example_tr: "Fiyatın churn'u yarattığı varsayımını stres testine sokalım.",
    },
    {
      id: "ex.wd34.3.v4",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "What's our blind spot",
      tr_translation: "Kör noktamız ne?",
      example: "Before we vote — what's our blind spot here?",
      example_tr: "Oylamadan önce — burada kör noktamız ne?",
    },
    {
      id: "ex.wd34.3.v5",
      type: "vocab_tile",
      difficulty: 5,
      cefr_band: "C1",
      word_or_phrase: "Let the data decide",
      tr_translation: "Veriyle karar verelim",
      example: "Let's pull the numbers and let the data decide.",
      example_tr: "Rakamları çıkaralım, veriyle karar verelim.",
    },
  ],
};
...
export const workDisagreeLesson_34_4: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      tr_translation: "Anlaşamayalım üzerinde anlaşalım",
      example: "Let's agree to disagree on this one — open to revisiting later.",
      example_tr: "Bunda anlaşamayalım üzerinde anlaşalım — sonra tekrar bakmaya açığım.",
    },
    {
      id: "ex.wd34.4.v3",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Sleep on it",
      tr_translation: "Üzerinde uyumak / bir gece düşünmek",
      example: "Let me sleep on it and get back to you tomorrow.",
      example_tr: "Bir gece düşüneyim, yarın sana döneyim.",
    },
    {
      id: "ex.wd34.4.v4",
      type: "vocab_tile",
      ...
      tr_translation: "Hiç kırgınlık yok",
      example: "Good debate — no hard feelings either way.",
      example_tr: "İyi bir tartışmaydı — her iki türlü de hiç kırgınlık yok.",
    },
    {
      id: "ex.wd34.4.v5",
      type: "vocab_tile",
      difficulty: 5,
      cefr_band: "C1",
      word_or_phrase: "At an impasse",
      tr_translation: "Çıkmazda / kilitlenmiş",
      example: "Looks like we're at an impasse — let's park it.",
      example_tr: "Görünüşe göre çıkmazdayız — şimdilik park edelim.",
    },
  ],
};
...
export const workDisagreeLesson_34_5: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Offer a different angle",
      tr_translation: "Farklı bir açı sunmak",
      example: "Let me offer a different angle on the priority call.",
      example_tr: "Öncelik kararına farklı bir açı sunayım.",
    },
    {
      id: "ex.wd34.5.v3",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Silent churn",
      tr_translation: "Sessiz churn (vocal olmayan kayıp)",
      example: "Vocal users complain — but silent churn is the real cost.",
      example_tr: "Sesli kullanıcılar şikayet eder — ama gerçek maliyet sessiz churn.",
    },
    {
      id: "ex.wd34.5.v4",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Appreciate you hearing me out",
      tr_translation: "Beni dinlediğin için teşekkürler",
      example: "Appreciate you hearing me out — dark mode goes next sprint.",
      example_tr: "Beni dinlediğin için teşekkürler — dark mode bir sonraki sprint.",
    },
    {
      id: "ex.wd34.5.v5",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Loud user voice",
      tr_translation: "Sesli kullanıcı sesi (vocal minority)",
      example: "Loud user voice on Twitter isn't always the silent majority.",
      example_tr: "Twitter'da sesli kullanıcı sesi her zaman sessiz çoğunluğu yansıtmaz.",
    },
  ],
};
...
export const workDisagreeLesson_34_6: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "I might be missing context",
      tr_translation: "Bağlam eksikim olabilir",
      example: "I might be missing context, but I'm worried about the scale story.",
      example_tr: "Bağlam eksikim olabilir, ama ölçek hikayesinden endişeliyim.",
    },
    {
      id: "ex.wd34.6.v3",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Run a spike",
      tr_translation: "Bir spike çalıştırmak (kısa araştırma)",
      example: "Let me run a 2-week spike on read replicas before we commit.",
      example_tr: "Karar vermeden önce 2 haftalık bir read replica spike'ı çalıştırayım.",
    },
    {
      id: "ex.wd34.6.v4",
      type: "vocab_tile",
      difficulty: 5,
      cefr_band: "C1",
      word_or_phrase: "Final call is yours",
      tr_translation: "Son karar senin",
      example: "I flagged my concern — final call is yours.",
      example_tr: "Endişemi belirttim — son karar senin.",
    },
    {
      id: "ex.wd34.6.v5",
      type: "vocab_tile",
      difficulty: 5,
      cefr_band: "C1",
      word_or_phrase: "Paper trail",
      tr_translation: "Yazılı kayıt / iz",
      example: "Drop the concern in email — leave a paper trail.",
      example_tr: "Endişeyi maile yaz — yazılı kayıt bırak.",
    },
  ],
};
...
export const workDisagreeLesson_34_7: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Less sure on",
      tr_translation: "Şu konuda emin değilim",
      example: "Hard agree on timing, less sure on scope.",
      example_tr: "Zamanlamaya kesin katılıyorum, kapsam konusunda emin değilim.",
    },
    {
      id: "ex.wd34.7.v3",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "What if we tried",
      tr_translation: "Şunu denesek nasıl olur?",
      example: "What if we tried a staggered rollout instead?",
      example_tr: "Yerine aşamalı bir yayılım denesek nasıl olur?",
    },
    {
      id: "ex.wd34.7.v4",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Notification fatigue",
      tr_translation: "Bildirim yorgunluğu",
      example: "Stacking emails causes notification fatigue — unsubscribes spike.",
      example_tr: "Mailleri üst üste yığmak bildirim yorgunluğuna yol açar — unsubscribe'lar fırlar.",
    },
    {
      id: "ex.wd34.7.v5",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Stagger across",
      tr_translation: "Birkaç güne / haftaya yaymak",
      example: "Let's stagger the campaigns across two weeks.",
      example_tr: "Kampanyaları iki haftaya yayalım.",
    },
  ],
};
...
export const workDisagreeLesson_34_8: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      example: "Let's find common ground — what do we both want?",
      example_tr: "Ortak zemin bulalım — ikimiz ne istiyoruz?",
    },
    {
      id: "ex.wd34.8.v3",
      type: "vocab_tile",
      ...
      tr_translation: "Orta yol",
      example: "What's the middle path here — feature flag to 10%?",
      example_tr: "Buradaki orta yol ne — yüzde 10'a feature flag mı?",
    },
    {
      id: "ex.wd34.8.v4",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Fresh eyes",
      tr_translation: "Taze gözlerle",
      example: "Let's circle back tomorrow with fresh eyes.",
      example_tr: "Yarın taze gözlerle geri dönelim.",
    },
    {
      id: "ex.wd34.8.v5",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "Walk away aligned",
      tr_translation: "Hizalı şekilde ayrılmak",
      example: "Want to make sure we walk away aligned, not just done.",
      example_tr: "Sadece bitirmiş değil — hizalı şekilde ayrıldığımızdan emin olalım.",
    },
  ],
};
