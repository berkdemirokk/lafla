...
export const deliveryLesson_8_1: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      tr_translation: "Teslimat",
      example: "Is delivery available?",
      example_tr: "Teslimat var mı?",
    },
    {
      id: "ex.8.1.v2",
      type: "vocab_tile",
      difficulty: 1,
      cefr_band: "A1",
      word_or_phrase: "order",
      tr_translation: "Sipariş",
      example: "I'd like to place an order.",
      example_tr: "Sipariş vermek istiyorum.",
    },
    {
      id: "ex.8.1.v3",
      type: "vocab_tile",
      ...
      example: "Here's my address.",
      example_tr: "İşte adresim.",
    },
    {
      id: "ex.8.1.v4",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "utensils",
      tr_translation: "Çatal-bıçak takımı",
      example: "No utensils, please — I have my own.",
      example_tr: "Çatal-bıçak istemiyorum — kendim var.",
    },
    {
      id: "ex.8.1.v5",
      type: "vocab_tile",
    ...
    },
    {
      ...
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "estimated time",
      tr_translation: "Tahmini süre",
      example: "What's the estimated time?",
      example_tr: "Tahmini süre nedir?",
    },
    {
      id: "ex.8.1.v7",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "instructions for the driver",
      tr_translation: "Sürücüye notlar",
      example: "Adding instructions for the driver now.",
      example_tr: "Sürücüye notları şimdi ekliyorum.",
    },
    {
      id: "ex.8.1.v8",
      type: "vocab_tile",
      ...
      tr_translation: "Temassız (teslimat)",
      example: "Contactless delivery, please.",
      example_tr: "Temassız teslimat, lütfen.",
    },
    {
      id: "ex.8.1.v9",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "could you double-bag",
      tr_translation: "Çift poşet yapabilir misiniz",
      example: "Could you double-bag the soup?",
      example_tr: "Çorbayı çift poşet yapabilir misiniz?",
    },
    {
      id: "ex.8.1.v10",
      type: "vocab_tile",
      ...
      tr_translation: "Fındık alerjim var",
      example: "Heads up — I'm allergic to nuts.",
      example_tr: "Bilginiz olsun — fındık alerjim var.",
    },
    {
      id: "ex.8.1.v11",
      type: "vocab_tile",
      ...
      example: "Could you hold the cheese on the burger?",
      example_tr: "Burger'in peynirini eklemez misiniz?",
    },
    {
      id: "ex.8.1.v12",
      type: "vocab_tile",
      ...
      example: "I have a dietary restriction — can you accommodate?",
      example_tr: "Diyet kısıtlamam var — uyabilir misiniz?",
    },
    {
      id: "ex.8.1.v13",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "C2",
      word_or_phrase: "I'll defer to the chef's discretion",
      tr_translation: "Şefin tercihine bırakırım (rafine)",
      example: "On spice level, I'll defer to the chef's discretion.",
      example_tr: "Acılık seviyesinde şefin tercihine bırakırım.",
    },
    {
      id: "ex.8.1.rq1",
      type: "recall_quiz",
...
export const deliveryLesson_8_2: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 1,
      cefr_band: "A1",
      word_or_phrase: "floor",
      tr_translation: "Kat",
      example: "I'm on the third floor.",
      example_tr: "Üçüncü kattayım.",
    },
    {
      id: "ex.8.2.v3",
      type: "vocab_tile",
      difficulty: 1,
      cefr_band: "A1",
      word_or_phrase: "apartment",
      tr_translation: "Daire",
      example: "Apartment 5B.",
      example_tr: "5B dairesi.",
    },
    {
      id: "ex.8.2.v4",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "no need to knock",
      tr_translation: "Çalmana gerek yok",
      example: "No need to knock — just leave it.",
      example_tr: "Çalmana gerek yok — sadece bırak.",
    },
    {
      id: "ex.8.2.v5",
      type: "vocab_tile",
    ...
    },
    {
      ...
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "ring the bell",
      tr_translation: "Zili çal",
      example: "Please ring the bell when you arrive.",
      example_tr: "Geldiğinde lütfen zili çal.",
    },
    {
      id: "ex.8.2.v7",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "buzzer code",
      tr_translation: "Kapı kodu (apartman girişi)",
      example: "Buzzer code is 1234.",
      example_tr: "Kapı kodu 1234.",
    },
    {
      id: "ex.8.2.v8",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "the lobby",
      tr_translation: "Lobi / giriş holü",
      example: "Drop it at the lobby desk.",
      example_tr: "Lobide görevliye bırakın.",
    },
    {
      id: "ex.8.2.v9",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "front desk",
      tr_translation: "Resepsiyon / giriş danışma",
      example: "Hand it to the front desk.",
      example_tr: "Resepsiyona verin.",
    },
    {
      id: "ex.8.2.v10",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "the gate code is",
      tr_translation: "Kapı kodu (şu)",
      example: "The gate code is 0420.",
      example_tr: "Kapı kodu 0420.",
    },
    {
      id: "ex.8.2.v11",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "could you call when you're close",
      tr_translation: "Yaklaştığında arar mısın",
      example: "Could you call when you're close?",
      example_tr: "Yaklaştığında arar mısın?",
    },
    {
      id: "ex.8.2.v12",
      type: "vocab_tile",
      ...
      example: "If it's not too much trouble, use the side gate.",
      example_tr: "Çok zahmetli değilse yan kapıyı kullan.",
    },
    {
      id: "ex.8.2.v13",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "C1",
      word_or_phrase: "I appreciate your patience",
      tr_translation: "Sabrına teşekkürler",
      example: "Tricky address — I appreciate your patience.",
      example_tr: "Karışık adres — sabrına teşekkürler.",
    },
    {
      id: "ex.8.2.rq1",
      type: "recall_quiz",
...
export const deliveryLesson_8_5: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      word_or_phrase: "salt",
      tr_translation: "Tuz",
      example: "A bit of salt, please.",
      example_tr: "Biraz tuz, lütfen.",
    },
    {
      id: "ex.8.5.v2",
      type: "vocab_tile",
      difficulty: 1,
      cefr_band: "A1",
      word_or_phrase: "pepper",
      tr_translation: "Biber / karabiber",
      example: "Pepper packets, please.",
      example_tr: "Biber paketleri, lütfen.",
    },
    {
      id: "ex.8.5.v3",
      type: "vocab_tile",
      difficulty: 1,
      cefr_band: "A1",
      word_or_phrase: "spicy",
      tr_translation: "Acılı",
      example: "Not too spicy, please.",
      example_tr: "Çok acılı olmasın, lütfen.",
    },
    {
      id: "ex.8.5.v4",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "container",
      tr_translation: "Kap (paket)",
      example: "In a separate container.",
      example_tr: "Ayrı bir kapta.",
    },
    {
      id: "ex.8.5.v5",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "sauce packet",
      tr_translation: "Sos paketi",
      example: "Extra sauce packets, please.",
      example_tr: "Ekstra sos paketi, lütfen.",
    },
    {
      id: "ex.8.5.v6",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "no spice",
      tr_translation: "Acısız",
      example: "No spice, please.",
      example_tr: "Acısız, lütfen.",
    },
    {
      id: "ex.8.5.v7",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "include condiments",
      tr_translation: "Sos/baharat ekleyin",
      example: "Please include condiments.",
      example_tr: "Lütfen sos/baharat ekleyin.",
    },
    {
      id: "ex.8.5.v8",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "no plastic cutlery",
      tr_translation: "Plastik çatal-bıçak istemiyorum",
      example: "No plastic cutlery, thanks.",
      example_tr: "Plastik çatal-bıçak istemiyorum, sağ olun.",
    },
    {
      id: "ex.8.5.v9",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "pack separately",
      tr_translation: "Ayrı paketleyin",
      example: "Please pack the salad separately.",
      example_tr: "Salatayı ayrı paketleyin, lütfen.",
    },
    {
      id: "ex.8.5.v10",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "could you hold the cilantro",
      tr_translation: "Kişnişi eklemez misiniz",
      example: "Could you hold the cilantro, please?",
      example_tr: "Kişnişi eklemez misiniz, lütfen?",
    },
    {
      id: "ex.8.5.v11",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "easy on the dressing",
      tr_translation: "Sos az olsun",
      example: "Easy on the dressing — dry-ish salad.",
      example_tr: "Sos az olsun — kuruya yakın salata.",
    },
    {
      id: "ex.8.5.v12",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "C1",
      word_or_phrase: "could you accommodate a substitution",
      tr_translation: "Yerine geçirme yapabilir misiniz",
      example: "Could you accommodate a substitution on the side?",
      example_tr: "Yan üründe yerine geçirme yapabilir misiniz?",
    },
    {
      id: "ex.8.5.v13",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "C1",
      word_or_phrase: "any way you'd prepare it best",
      tr_translation: "En iyi nasıl yaparsanız",
      example: "Any way you'd prepare it best.",
      example_tr: "En iyi nasıl yaparsanız öyle olsun.",
    },
    {
      id: "ex.8.5.rq1",
      type: "recall_quiz",
...
export const deliveryLesson_8_6: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      cefr_band: "A1",
      word_or_phrase: "item",
      tr_translation: "Ürün / öğe",
      example: "One item is missing.",
      example_tr: "Bir ürün eksik.",
    },
    {
      id: "ex.8.6.v2",
      type: "vocab_tile",
      ...
      example: "Something's wrong with the order.",
      example_tr: "Siparişte bir şey yanlış.",
    },
    {
      id: "ex.8.6.v3",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "missing",
      tr_translation: "Eksik",
      example: "Fries are missing.",
      example_tr: "Patatesler eksik.",
    },
    {
      id: "ex.8.6.v4",
      type: "vocab_tile",
      ...
      tr_translation: "Kontrol eder misiniz",
      example: "Could you check my order?",
      example_tr: "Siparişimi kontrol eder misiniz?",
    },
    {
      id: "ex.8.6.v5",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "I didn't receive",
      tr_translation: "Almadım",
      example: "I didn't receive the drinks.",
      example_tr: "İçecekleri almadım.",
    },
    {
      id: "ex.8.6.v6",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "refund",
      tr_translation: "İade (para)",
      example: "Could I get a refund?",
      example_tr: "İade alabilir miyim?",
    },
    {
      id: "ex.8.6.v7",
      type: "vocab_tile",
      ...
      tr_translation: "Mağaza kredisi (iade yerine)",
      example: "Store credit works too.",
      example_tr: "Mağaza kredisi de olur.",
    },
    {
      id: "ex.8.6.v8",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "re-send",
      tr_translation: "Tekrar göndermek",
      example: "Could you re-send the missing items?",
      example_tr: "Eksik ürünleri tekrar gönderebilir misiniz?",
    },
    {
      id: "ex.8.6.v9",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "report the issue",
      tr_translation: "Sorunu bildirmek",
      example: "How do I report the issue?",
      example_tr: "Sorunu nasıl bildiririm?",
    },
    {
      id: "ex.8.6.v10",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "I'd appreciate a quick resolution",
      tr_translation: "Hızlı çözüm rica ederim",
      example: "I'd appreciate a quick resolution if possible.",
      example_tr: "Mümkünse hızlı çözüm rica ederim.",
    },
    {
      id: "ex.8.6.v11",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "the order doesn't match the receipt",
      tr_translation: "Sipariş fişe uymuyor",
      example: "The order doesn't match the receipt.",
      example_tr: "Sipariş fişe uymuyor.",
    },
    {
      id: "ex.8.6.v12",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "C1",
      word_or_phrase: "I'm reaching out about a missing item",
      tr_translation: "Eksik bir ürünle ilgili yazıyorum",
      example: "Hi — I'm reaching out about a missing item.",
      example_tr: "Selam — eksik bir ürünle ilgili yazıyorum.",
    },
    {
      id: "ex.8.6.v13",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "C1",
      word_or_phrase: "thanks for your understanding",
      tr_translation: "Anlayışınız için teşekkürler",
      example: "Thanks for your understanding.",
      example_tr: "Anlayışınız için teşekkürler.",
    },
    {
      id: "ex.8.6.rq1",
      type: "recall_quiz",
...
export const deliveryLesson_8_7: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      example: "It's a different meal.",
      example_tr: "Farklı bir yemek.",
    },
    {
      id: "ex.8.7.v2",
      type: "vocab_tile",
      difficulty: 1,
      cefr_band: "A1",
      word_or_phrase: "mistake",
      tr_translation: "Hata",
      example: "There's a mistake.",
      example_tr: "Bir hata var.",
    },
    {
      id: "ex.8.7.v3",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "replacement",
      tr_translation: "Yenisi / yerine konulan",
      example: "Could I get a replacement?",
      example_tr: "Yerine yenisini alabilir miyim?",
    },
    {
      id: "ex.8.7.v4",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "send me the right one",
      tr_translation: "Doğrusunu gönder",
      example: "Could you send me the right one?",
      example_tr: "Doğrusunu gönderebilir misiniz?",
    },
    {
      id: "ex.8.7.v5",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "fix the order",
      tr_translation: "Siparişi düzelt",
      example: "Could you fix the order?",
      example_tr: "Siparişi düzeltebilir misiniz?",
    },
    {
      id: "ex.8.7.v6",
      type: "vocab_tile",
      ...
      tr_translation: "Karışıklık",
      example: "Looks like a mix-up.",
      example_tr: "Sanki bir karışıklık olmuş.",
    },
    {
      id: "ex.8.7.v7",
      type: "vocab_tile",
    ...
    },
    {
      ...
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "received the wrong item",
      tr_translation: "Yanlış ürün aldım",
      example: "I received the wrong item.",
      example_tr: "Yanlış ürün aldım.",
    },
    {
      id: "ex.8.7.v9",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "no charge",
      tr_translation: "Ücretsiz (düzeltme)",
      example: "Send a replacement at no charge.",
      example_tr: "Ücretsiz yenisini gönderin.",
    },
    {
      id: "ex.8.7.v10",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "could you resend the correct order",
      tr_translation: "Doğru siparişi tekrar gönderebilir misiniz",
      example: "Could you resend the correct order?",
      example_tr: "Doğru siparişi tekrar gönderebilir misiniz?",
    },
    {
      id: "ex.8.7.v11",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "what do you suggest",
      tr_translation: "Ne öneriyorsunuz",
      example: "What do you suggest in this case?",
      example_tr: "Bu durumda ne öneriyorsunuz?",
    },
    {
      id: "ex.8.7.v12",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "C1",
      word_or_phrase: "I'd prefer a quick replacement",
      tr_translation: "Hızlı yenisini tercih ederim",
      example: "I'd prefer a quick replacement over a refund.",
      example_tr: "İade yerine hızlı yenisini tercih ederim.",
    },
    {
      id: "ex.8.7.v13",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "C1",
      word_or_phrase: "thank you for sorting this out",
      tr_translation: "Bu konuyu çözdüğünüz için teşekkürler",
      example: "Thank you for sorting this out quickly.",
      example_tr: "Bu konuyu hızlıca çözdüğünüz için teşekkürler.",
    },
    {
      id: "ex.8.7.rq1",
      type: "recall_quiz",
...
export const deliveryLesson_8_8: BundledLesson = {
  ...
  exercises: [
    ...
    },
    {
      ...
      difficulty: 1,
      cefr_band: "A1",
      word_or_phrase: "right",
      tr_translation: "Sağ",
      example: "Take a right after the bridge.",
      example_tr: "Köprüden sonra sağa.",
    },
    {
      id: "ex.8.8.v3",
      type: "vocab_tile",
      ...
      tr_translation: "Köşeyi dönünce",
      example: "It's just around the corner.",
      example_tr: "Sadece köşeyi dönünce.",
    },
    {
      id: "ex.8.8.v4",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "front entrance",
      tr_translation: "Ön giriş",
      example: "Use the front entrance.",
      example_tr: "Ön girişi kullan.",
    },
    {
      id: "ex.8.8.v5",
      type: "vocab_tile",
      difficulty: 2,
      cefr_band: "A2",
      word_or_phrase: "next to",
      tr_translation: "Yanında",
      example: "Next to the pharmacy.",
      example_tr: "Eczanenin yanında.",
    },
    {
      id: "ex.8.8.v6",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "landmark",
      tr_translation: "Tanınmış nokta / işaret",
      example: "Use the bakery as a landmark.",
      example_tr: "Fırını işaret olarak kullan.",
    },
    {
      id: "ex.8.8.v7",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "blue building",
      tr_translation: "Mavi bina",
      example: "Look for the blue building on the left.",
      example_tr: "Solda mavi binaya bak.",
    },
    {
      id: "ex.8.8.v8",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "I'll come down",
      tr_translation: "İniyorum (aşağı)",
      example: "I'll come down — give me a sec.",
      example_tr: "Aşağı iniyorum — bir saniye ver.",
    },
    {
      id: "ex.8.8.v9",
      type: "vocab_tile",
      difficulty: 3,
      cefr_band: "B1",
      word_or_phrase: "drop a pin",
      tr_translation: "Konum at (pin)",
      example: "Could you drop a pin?",
      example_tr: "Konum atar mısın?",
    },
    {
      id: "ex.8.8.v10",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "the third house on the left",
      tr_translation: "Soldaki üçüncü ev",
      example: "It's the third house on the left.",
      example_tr: "Soldaki üçüncü ev.",
    },
    {
      id: "ex.8.8.v11",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "B2",
      word_or_phrase: "I'll wave from the porch",
      tr_translation: "Verandadan el sallayacağım",
      example: "I'll wave from the porch when I see you.",
      example_tr: "Seni görünce verandadan el sallayacağım.",
    },
    {
      id: "ex.8.8.v12",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "C1",
      word_or_phrase: "easy to miss",
      tr_translation: "Gözden kaçabilir",
      example: "Easy to miss — small driveway on the right.",
      example_tr: "Gözden kaçabilir — sağda küçük bir araba yolu.",
    },
    {
      id: "ex.8.8.v13",
      type: "vocab_tile",
      difficulty: 4,
      cefr_band: "C1",
      word_or_phrase: "I'm right by the entrance",
      tr_translation: "Tam girişin yanındayım",
      example: "I'm right by the entrance — see you in a minute.",
      example_tr: "Tam girişin yanındayım — birazdan görüşürüz.",
    },
    {
      id: "ex.8.8.rq1",
      type: "recall_quiz",
